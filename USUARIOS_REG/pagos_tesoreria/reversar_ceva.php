...
//*********************FUNCION PARA CALCULAR LA FECHA CEVA ****************

function fecha_cevas()
{
	
	var pos_url ='consultas/fecha_ceva.php';
	var ids= document.getElementById("id_ceva").value;
	...
	if (req) 
	{
		req.onreadystatechange = function() 
		{
			if (req.readyState == 4 && (req.status == 200 || req.status == 304))
			 {
					document.getElementById("fecha_ceva2").value = req.responseText;
	...
	//document.getElementById("fecha_ceva").value = req.responseText;
...
function validar_conciliado(id)
{
	var pos_url ='consultas/con_conciliado.php';
	//var id=document.getElementById("id_manu_ceva").value;	
	var req = new XMLHttpRequest();
	if (req) 
	{
		req.onreadystatechange = function() 
...
function sumacredito()
{
	var sumato=document.all.tablaf.rows.length;
		...
		if(sumato!=0)
		{
			...
			sumatotal=sumatotal+parseInt(document.getElementById('t'+k+'4').value);
...
function sumadebito()
{
	var sumato=document.all.tablaf.rows.length;
		...
		{
			for (var k=1;k<=sumato;k++)
			sumatotal=sumatotal+parseInt(document.getElementById('t'+k+'3').value);
			//alert(document.getElementById('t'+k+'4').value);
...
function agregar()
 {
	...
	td = tr.insertCell();
	alert(contLin);
	td.innerHTML =  "<input type='text' size='28' readonly  style='text-align:left' id='pgcp"+contLin+"' name='pgcp"+contLin+"' value='' title ='pgcp"+contLin+"' >"  ;
	
	td = tr.insertCell();
	td.innerHTML = "<input type='text' size='40' style='text-align:left' name='resulta"+contLin+"' id='resulta"+contLin+"' value='' readonly >";
	
	td = tr.insertCell();
	td.innerHTML = "<input type='text' size='25' style='text-align:right' name='t"+contLin+"4' id='t" + contLin + "4' value=0  onKeyUp='cuatro();' onkeypress='return validar(event)' readonly >";
	
	td = tr.insertCell();
	td.innerHTML = "<input type='text' size='26' style='text-align:right' name='t" + contLin + "3' id='t" + contLin + "3' value=0  onKeyUp='cuatro();' onkeypress='return validar(event)' readonly >";
	
	td = tr.insertCell();
	td.innerHTML = "<input type='text' size='29' style='text-align:right' name='num_cheque"+contLin+"' id='num_cheque"+contLin+"' value='' readonly >";
	contLin++;
...
//alert(existe);
	...
	{	
		...
		{
			alert("La fecha obcg "+fecha_obcg+" es mas reciente que la fecha ceva "+fecha_ceva+" debe cambiarla");
			existe=1;
		...
		var f1=document.getElementById("fecha_ceva2").value;
		var f2=document.getElementById("fecha_ceva").value;
		
			
		//var aux2=f2.split('/');   
		//var fecha2=parseInt(aux2[0]+aux2[1]+aux2[2]);
		/*if(f2>=f1)
		{
		...
		//return (false);
		*/
		idc=document.getElementById("nceva").value;
		resc=validar_conciliado(idc);
		if(parseInt(resc)>0)
		{
			alert ("No se puede anular el pago porque ya fue conciliado" )
			existe=1
			return (false);
		}
	...
	/*	
		...
		if(document.getElementById("chk_reversar").value=="checked")
		{
			alert("checado");
		}
		else {alert("deschecado");}*/
		var ch=document.getElementById("chk_reversar");
	
		/*if(ch.checked)
		{
			alert ("si cheked");
		}
			else alert ("no cheked");
		*/
		//existe=1;
		//return (false);
...
function neto()
{
	...
	document.getElementById('total_pagado').value=Math.round(net-(rfuente+riva+rica+es1+es2+es3+es4+es5+pen+soli+sindi+cru+sal+libr+empleo+embargo));
	//ceros();
}
function dos()
{
	...
	tabla_inicial();
	fecha_cevas();
	document.getElementById("fecha_ceva2").value=document.getElementById("fecha_ceva").value;
}
</script>
...
while($rowe1=mysql_fetch_array($rese1))
{
 ...
 $ceva=$rowe1["id_manu_ceva"];
 $subceva=substr($ceva,4,10);
...
while($rowxx4 = mysql_fetch_array($resultadoxx4)) 
{
 ...
 <input name="p1" id="p1" type="hidden" value="<?php printf("%s",$p1);?>" /> 
  <input name="p2" id="p2" type="hidden" value="<?php printf("%s",$p2);?>" />
   ...
   <input name="fecha_ceva123" id="fecha_ceva123" type="hidden" value="<?php printf("%s",$fecha_ceva_e);?>" />  
   <input name="d_ceva" id="d_ceva" type="hidden" value="<?php printf("%s",$des_ceva_e);?>" />  
   <input name="nceva" id="nceva" type="hidden" value="<?php printf("%s",$ceva);?>" />
  ...
  <form name="a" method="post" id="commentForm" action="p_reversar2.php">      
	...
	<table width="800" border="1" align="center" class="bordepunteado1">
      ...
      <tr>
        ...
        <td bgcolor="#FFFFFF" width="200"><div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
          <div align="center" class="Estilo4"><?php printf("%s",$crpp_m);?>
...
function algo(this1)
{
	...
	displayCalendar(document.a.fecha_ceva,'yyyy/mm/dd',this1);
	//alert (document.getElementById("fecha_ceva").value);
	//displayCalendar(document.a.fecha_ceva2,'yyyy/mm/dd',this);
}
...
//--------	
	  ...
	  <tr>
	    ...
	    <td width="200" bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
          <div align="center" class="Estilo4"><?php printf("%s",$cobp_e);?>
              <input name="id_manu_cobp"  type="hidden" value="<?php printf("%s",$cobp_e);?>" />
              <input name="id_auto_cobp" type="hidden" id="id_auto_cobp" value="<?php printf("%s",$cobp_auto_e);?>" />
          </div>
	      </div></td>
	    <td width="200" bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
          <div align="center" class="Estilo12">
    ...
    <table id="tabla_e" width="800" border="1" align="center" class="bordepunteado1">
	  <tr>
	    <td colspan="4" bgcolor="#DCE9E5"><div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
...
//--------	
  ...
  <table width="800" border="1" align="center" class="bordepunteado1">
    ...
    <tr>
      ...
      <td colspan="2" bgcolor="#FFFFFF"><div style="padding-left:15px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
        <div align="left">
          <input name="fecha_ceva" type="text" class="Estilo12"  id="fecha_ceva" value="<?php  echo date('Y/m/d'); ?> " size="12"/>
          <input name="fecha_ceva2" type="hidden" class="required Estilo12" id="fecha_ceva2"  size="12"  />
          <span class="Estilo8">:::</span>
          <input name="button2" type="button" class="Estilo12" onclick="algo(this);" value="Seleccione Fecha" />
        </div>
      </div></td>
      ...
      <td bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
          <div align="center" class="Estilo12">
            <div align="center">
			  ...
			  value="<?php printf("%s",$subceva); ?>" onkeyup="chk_ceva();" />
    ...
    <tr>
      ...
      <td colspan="3" bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
        <div align="center" class="Estilo20">
          <input name="des_ceva" type="text"  readonly="readonly" id="des_ceva" onblur="this.value=this.value.toUpperCase();" value="<?php echo $des_ceva_e; ?>" style="width:500px;" />
        </div>
      </div></td>
      </tr>
      ...
      <td colspan="4" bgcolor="#66CCCC"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
        <div align="center" class="Estilo12">
          <div align="center"><strong>Si el pago a realizar no tiene IVA, deje la casilla en BLANCO,<br />
            ...
            <input name="iva" size="5" type="text" class="Estilo12" id="iva" style="text-align:center" onkeyup="cinco();" onkeypress="return validar(event)" value="<?php  printf("%s",$iva_e); ?>" readonly="readonly"  />
...
<td>  <input name='siniva' id='siniva' readonly type='text' style='text-align:right' value=''/>  </td>
</tr>
<tr bgcolor='#F5F5F5'>
<td colspan ='4' align='right'> Valor del IVA &nbsp;</td>
<td> <input name='valoriva' id='valoriva' readonly type='text' style='text-align:right' value=''/> </td>
</tr>
  ...
  <table width="800" border="1" align="center" class="bordepunteado1">
    ...
    <tr>
      ...
      <td><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="center">
              <input name="salud" type="text" class="Estilo12" id="salud" style="text-align:right" onkeypress="return validar(event)" value="<?php printf("%s",$salud_e);?>" onkeyup="tres();" onChange="ceros();" readonly="readonly" />
            </div>
          </div>
      </div></td>
      <td><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
      ...
      <td><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="center">
              <input name="pension" type="text" class="Estilo12" id="pension" style="text-align:right" onkeypress="return validar(event)" value="<?php printf("%s",$pension_e);?>" onkeyup="tres();" onChange="ceros();" readonly="readonly"/>
            </div>
          </div>
      </div></td>
    </tr>
    <tr>
      ...
      <td><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="center">
              <input name="libranza" type="text" class="Estilo12" id="libranza" style="text-align:right" onkeypress="return validar(event)" value="<?php printf("%s",$libranza_e);?>" onkeyup="tres();" onChange="ceros();" readonly="readonly"/>
            </div>
          </div>
      </div></td>
      <td><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
      ...
      <td><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="center">
              <input name="f_solidaridad" type="text" class="Estilo12" id="f_solidaridad" style="text-align:right" onkeypress="return validar(event)" value="<?php printf("%s",$solidaridad_e);?>" onkeyup="tres();" onChange="ceros();" readonly="readonly"/>
            </div>
          </div>
      </div></td>
    </tr>
    <tr>
      ...
      <td width="200"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="center">
              <input name="f_empleados" type="text" class="Estilo12" id="f_empleados" style="text-align:right" onkeypress="return validar(event)" value="<?php printf("%s",$empleados_e);?>" onkeyup="tres();" onChange="ceros();" readonly="readonly"/>
            </div>
          </div>
      </div></td>
      <td width="200"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
      ...
      <td width="200"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="center">
              <input name="sindicato" type="text" class="Estilo12" id="sindicato" style="text-align:right" onkeypress="return validar(event)" value="<?php printf("%s",$sindicato_e);?>" onkeyup="tres();" onChange="ceros();" readonly="readonly"/>
            </div>
          </div>
      </div></td>
    </tr>
    <tr>
      ...
      <td><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="center">
              <input name="embargo" type="text" class="Estilo12" id="embargo" style="text-align:right" onkeypress="return validar(event)" value="<?php printf("%s",$embargo_e);?>" onkeyup="tres();" onChange="ceros();" readonly="readonly"/>
            </div>
          </div>
      </div></td>
      <td><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
      ...
      <td><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="center"><input name="cruce" type="text" class="Estilo12" id="cruce" style="text-align:right" onkeypress="return validar(event)" value="<?php printf("%s",$cruce_e);?>" onkeyup="tres();"  onChange="ceros();" readonly="readonly"/></div>
          </div>
      </div></td>
    </tr>
    <tr>
      ...
      <td><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="center">
              <input name="otros" type="text" class="Estilo12" id="otros" style="text-align:right" onkeypress="return validar(event)" value="<?php printf("%s",$otros_e);?>" onkeyup="tres();" onChange="ceros();" readonly="readonly"/>
            </div>
          </div>
      </div></td>
      <td>&nbsp;</td>
  ...
  <tr>
    ...
    <tr>
      <td><div style="padding-left:5px; padding-top:2px; padding-right:5px; padding-bottom:2px;">
          <div align="center">
            <select name="retefuente" disabled="disabled" class="Estilo12" id="retefuente" style="width: 300px;"   onchange="retefuentef(value);">
...
?>
<!--              <input name="vr_retefuente" type="text" class="Estilo12" id="vr_retefuente" style="text-align:right" onkeypress="return validar(event)" value="" />-->
			  
<input name="vr_retefuente" type="text" class="Estilo12" id="vr_retefuente" style="text-align:right" onChange="ceros();" onkeypress="return validar(event)" readonly="readonly" 
			  value=" " />			  
    ...
    <tr>
      <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:2px; padding-right:5px; padding-bottom:2px;">
          <div align="center">
            <select name="reteiva" class="Estilo12" disabled="disabled" id="reteiva" style="width: 300px;" onchange="ret_iva(value)">
...
?>
			  ...
			  <input name="vr_reteiva" type="text" class="Estilo12" id="vr_reteiva" readonly="readonly" style="text-align:right" onChange="ceros();" onkeypress="return validar(event)" 
			  value="" />	
            </div>
          </div>
      </div></td>
    ...
    <tr>
      <td><div style="padding-left:5px; padding-top:2px; padding-right:5px; padding-bottom:2px;">
          <div align="center"><span class="Estilo4">
            <input name="reteica" readonly="readonly" type="text" class="Estilo4" id="reteica" onkeyup="a.reteica.value=a.reteica.value.toUpperCase();" size="55"
			value=" <?php printf("%s",$reteica_e);?>" />
          </span></div>
      </div></td>
      <td><div style="padding-left:5px; padding-top:2px; padding-right:5px; padding-bottom:2px;">
          <div align="center" class="Estilo12">
            <div align="center">
              <input name="a_partir_reteica" readonly="readonly" type="text" class="Estilo12" id="a_partir_reteica" style="text-align:right" onkeyup="tres();" onkeypress="return validar(event)" 
      ...
      <td><div style="padding-left:5px; padding-top:2px; padding-right:5px; padding-bottom:2px;">
          <div align="center" class="Estilo12">
            <div align="center">
              <input name="tarifa_reteica" type="text" readonly="readonly" class="Estilo12" id="tarifa_reteica" style="text-align:right" onkeyup="otro();" onkeypress="return validar(event)" 
			  value="<?php printf("%.0f",$tarifa_e);?>" />
            </div>
          </div>
      </div></td>
      <td><div style="padding-left:5px; padding-top:2px; padding-right:5px; padding-bottom:2px;">
          <div align="center" class="Estilo12">
            <div align="center">
              <input name="vr_reteica" type="text" readonly="readonly" class="Estilo12" id="vr_reteica" style="text-align:right" onChange="ceros();" onkeypress="return validar(event)" 
			  value="0" />
            </div>
          </div>
      </div></td>
    ...
    <tr>
      <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:2px; padding-right:5px; padding-bottom:2px;">
          <div align="center"><span class="Estilo4">
            <select name="estampilla1" class="Estilo12" disabled="disabled" id="estampilla1" style="width: 300px;" onchange="estamp1(value,id);" >
 ...
 ?>
     ...
     <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:2px; padding-right:5px; padding-bottom:2px;">
      ...
      <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:2px; padding-right:5px; padding-bottom:2px;">
        <div align="center" class="Estilo12">
          <div align="center">
            <input name="vr_estampilla1" type="text" readonly="readonly" class="Estilo12" id="vr_estampilla1" onChange="ceros();" style="text-align:right" onkeypress="return validar(event)" 
    ...
    <tr>
      <td bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:2px; padding-right:5px; padding-bottom:2px;">
          <div align="center"><span class="Estilo4">
            <select name="estampilla2" class="Estilo12" disabled="disabled" id="estampilla2" style="width: 300px;" onchange="estamp1(value,id);" >
...
echo "<OPTION VALUE=\"".$row["concepto"]."\">".$row["concepto"]."</OPTION>";
 ...
 ?>
      ...
      <td bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:2px; padding-right:5px; padding-bottom:2px;">
        <div align="center" class="Estilo12">
          <div align="center">
            <input name="vr_estampilla2" type="text"  readonly="readonly" class="Estilo12" id="vr_estampilla2" onChange="ceros();" style="text-align:right" onkeypress="return validar(event)" 
    ...
    <tr>
      <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:2px; padding-right:5px; padding-bottom:2px;">
        <div align="center"><span class="Estilo20">
          <select name="estampilla3" class="Estilo12" disabled="disabled" id="estampilla3" style="width: 300px;" onchange="estamp1(value,id);">
...
echo "<OPTION VALUE=\"".$row["concepto"]."\">".$row["concepto"]."</OPTION>";
 ...
 ?>
      ...
      <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:2px; padding-right:5px; padding-bottom:2px;">
        <div align="center" class="Estilo12">
          <div align="center">
            <input name="vr_estampilla3" type="text" readonly="readonly" class="Estilo12" id="vr_estampilla3" onChange="ceros();" style="text-align:right" onkeypress="return validar(event)" 
			  value="<?php printf("%.0f",$vestampilla3);?>" />
          </div>
        </div>
      </div></td>
    </tr>
    ...
    <tr>
      <td bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:2px; padding-right:5px; padding-bottom:2px;">
        <div align="center"><span class="Estilo20">
          <select name="estampilla4" class="Estilo12" disabled="disabled" id="estampilla4" style="width: 300px;" onchange="estamp1(value,id);">
...
echo "<OPTION VALUE=\"".$row["concepto"]."\">".$row["concepto"]."</OPTION>";
 ...
 ?>
      ...
      <td bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:2px; padding-right:5px; padding-bottom:2px;">
        <div align="center" class="Estilo12">
          <div align="center">
            <input name="vr_estampilla4" type="text" readonly="readonly" class="Estilo12" id="vr_estampilla4" onChange="ceros();" style="text-align:right" onkeypress="return validar(event)" 
    ...
    <tr>
      <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:2px; padding-right:5px; padding-bottom:2px;">
        <div align="center"><span class="Estilo20">
          <select name="estampilla5" class="Estilo12" disabled="disabled" id="estampilla5" style="width: 300px;" onchange="estamp1(value,id);">
...
echo "<OPTION VALUE=\"".$row["concepto"]."\">".$row["concepto"]."</OPTION>";
 ...
 ?>
      ...
      <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:2px; padding-right:5px; padding-bottom:2px;">
        <div align="center" class="Estilo12">
          <div align="center">
            <input name="vr_estampilla5" readonly="readonly" type="text" class="Estilo12" id="vr_estampilla5" onChange="ceros();" style="text-align:right" onkeypress="return validar(event)" 
			  value="<?php printf("%.0f",$vstampilla5_e);?>" />
          </div>
        </div>
      </div></td>
    </tr>
    ...
    <tr>
      <td bgcolor="#66CCCC"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo4">
            <div align="center"><b>FORMA DE PAGO </b> <span class="Estilo12">
              <select name="forma_pago" disabled="disabled" class="Estilo4" id="forma_pago">
                <?php 
      ...
      <td colspan="3" bgcolor="#990000"><div style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
          <div align="center" class="Estilo12"><span class="Estilo8"><strong> VALOR NETO A PAGAR :          
            = </strong></span>
              <input style="background:#990000 ; color:#FFF; border:hidden; "    name="total_pagado" type="text" class="Estilo12"  id="total_pagado" value="" readonly="readonly"/>
          </div>
      </div></td>
    </tr>
</table>
	  ...
	  <div style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
		  <div align="center" class="Estilo4">
		    <p><strong>MOVIMIENTO CONTABLE
		      ...
		      <input type="button" disabled="disabled" name="generar" id="generar" value="Generar movimiento " onClick="calcular_tabla();">
		      </p>
<p>
  <strong><img src="images/mas.png" alt="" title="Agregar Fila" width="20" height="20" border="0" style='cursor: pointer'; >
    &nbsp;&nbsp;&nbsp;&nbsp;
    <span id='contis' class='Estilo4'><?php printf("%s",$contador1); ?></span>
    &nbsp;&nbsp;&nbsp;&nbsp;
    <img src="images/menos.png" alt="" title="Quitar Fila" width="20" height="20" border="0" style='cursor: pointer'; >
  </strong></p>
		  </div>
      </div></td>
    </tr>
    ...
    <table width="1000" border="1"  align="center" class="bordepunteado1">
     ...
     <tr>
        ...
        <td bgcolor="#FFFFFF"><div class="Estilo8" style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
            <div align="center" class="Estilo12">
              <div align="right">
                <input name="tot_deb_a" type="text" class="Estilo12" readonly="readonly" id="tot_deb_a" style="text-align:right" value="0.00"/>
              </div>
            </div>
        </div></td>
        <td bgcolor="#FFFFFF" class="Estilo4"><div class="Estilo8" style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
            <div align="center" class="Estilo12">
              <div align="right">
                <input name="tot_cre_a" type="text"  readonly="readonly" class="Estilo12" id="tot_cre_a" style="text-align:right" value="0.00"/>
              </div>
            </div>
        </div></td>
        <td bgcolor="#990000">
      ...
      <tr>
        <td colspan="5"><div class="Estilo19" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:5px;">
          <div align="center">
              ...
              <input name="chk_reversar" type="checkbox" id="chk_reversar" checked="checked"  value="1"/>
              Reversar causacion del gasto
		  ...
		  ?>
			...
			onClick="return valida_tabla();" <?php echo $boton; ?> />
             <input name="ver" type="button" id="ver" class="Estilo19"  value="Mostrar" onclick="verCampo();" />
