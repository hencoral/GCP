...
$iva = $_POST['iva'];// printf("num_cheque15 : %s<br>",$iva); 
...
$retefuente_e=$_POST['retefuente']; //printf("<br>retefuente : %s <br>",$retefuente_e);
$vretefuente_e=$_POST['vr_retefuente'];//printf("<br>vretefuente_e : %s <br>",$vretefuente_e);
$retecree_e=$_POST['retecree']; //printf("<br>retefuente : %s <br>",$retefuente_e);
$vretecree_e=$_POST['vr_retecree'];//printf("<br>vretefuente_e : %s <br>",$vretefuente_e);
$reteiva_e=$_POST['reteiva'];//printf("<br>reteiva_e : %s <br>",$reteiva_e);
$vreteiva_e=$_POST['vr_reteiva'];//printf("<br>vreteiva_e : %s <br>",$vreteiva_e);
$reteica_e=$_POST['reteica'];//printf("<br>reteica_e : %s <br>",$reteica_e);
$partir_e=$_POST['a_partir_reteica'];//printf("<br>partir_e : %s <br>",$partir_e);
$tarifa_e=$_POST['tarifa_reteica']/10;//printf("<br>tarifa_e : %s <br>",$tarifa_e);
$vreteica=$_POST['vr_reteica'];//printf("<br>vreteica : %s <br>",$vreteica);
$estampilla1_e=$_POST['estampilla1'];//printf("<br>estampilla1_e : %s <br>",$estampilla1_e);
$vestampilla1_e=$_POST['vr_estampilla1'];//printf("<br>vestampilla1_e : %s <br>",$vestampilla1_e);
$estampilla2_e=$_POST['estampilla2'];//printf("<br>estampilla2_e : %s <br>",$estampilla2_e);
$vestampilla2_e=$_POST['vr_estampilla2'];
$estampilla3_e=$_POST['estampilla3'];
$vestampilla3_e=$_POST['vr_estampilla3'];
$estampilla4_e=$_POST['estampilla4'];
$vestampilla4_e=$_POST['vr_estampilla4'];
$estampilla5_e=$_POST['estampilla5'];
$vestampilla5_e=$_POST['vr_estampilla5'];
$id_manu_ceva=$_POST['id_manu_ceva'];
$id_manu_ceva2="CEVA".$id_manu_ceva;
...
{  $fecha_cobp=$rowp["fecha_cobp"];  //echo "fecha cobp".$fecha_cobp;
   $id_manu_cobp=$rowp["id_manu_cobp"];

}


if( $fecha > $bx || $fecha < $ax )
{
...
$sql = "update ceva set 
		...
		iva ='$iva',
		salud= '$salud', pension='$pension', libranza='$libranza', f_solidaridad='$f_solidaridad',
		f_empleados='$f_empleados', sindicato='$sindicato', embargo='$embargo', cruce='$cruce', otros='$cruce',	
		
		retefuente = '$retefuente_e' , vr_retefuente = '$vretefuente_e' , reteiva = '$reteiva_e' ,vr_reteiva = '$vreteiva_e',
		retecree='$retecree_e',  vr_retecree='$vretecree_e',
		reteica = '$reteica_e' , a_partir_reteica = '$partir_e' , tarifa_reteica = '$tarifa_e' , vr_reteica = '$vreteica' ,
		estampilla1 = '$estampilla1_e' , vr_estampilla1 = '$vestampilla1_e', estampilla2 = '$estampilla2_e' ,
		vr_estampilla2 = '$vestampilla2_e' , estampilla3 = '$estampilla3_e' , vr_estampilla3 = '$vestampilla3_e' ,
		estampilla4 = '$estampilla4_e' , vr_estampilla4 = '$vestampilla4_e' , estampilla5 = '$estampilla5_e' ,
		vr_estampilla5 = '$vestampilla5_e',id_manu_ceva='$id_manu_ceva2',total_pagado='$total_pagado', tot_deb ='$tot_deb', tot_cre ='$tot_cre'
