...
function autoCree()
{
	...
	var ter =document.getElementById('ter_jur2').value;
...
function otro()
{
	...
	if(valxpagar>=partir)
	{
		totica=valxpagar*(tarifaica/1000);
	}
	else totica=0;
...
function cta_obcg()
{
	...
	var obcg=document.getElementById('id_auto_cobp').value;
	var req = new XMLHttpRequest();
	if (req) 
	{
		req.onreadystatechange = function() 
...
function llenartabla()
{
	...
	var libranza=parseFloat(document.getElementById('libranza').value);
	var empleados=parseFloat(document.getElementById('f_empleados').value);
	...
	var solidaridad=parseFloat(document.getElementById('f_solidaridad').value);
	var sindicato=parseFloat(document.getElementById('sindicato').value);
	var cruce=parseFloat(document.getElementById('cruce').value);
	
	var irfuente=parseFloat(document.getElementById('vr_retefuente').value); //identificador ret fuente
	var ircree=parseFloat(document.getElementById('vr_retecree').value); //identificador ret fuente
	var iriva=parseFloat(document.getElementById('vr_reteiva').value); // identificador iva
	var irica=parseFloat(document.getElementById('vr_reteica').value);// identificador ica
	var irest1=parseFloat(document.getElementById('vr_estampilla1').value);//estampilla1
	var irest2=parseFloat(document.getElementById('vr_estampilla2').value);//estampilla2
	var irest3=parseFloat(document.getElementById('vr_estampilla3').value);//estampilla3
	var irest4=parseFloat(document.getElementById('vr_estampilla4').value);//estampilla4
	var irest5=parseFloat(document.getElementById('vr_estampilla5').value);//estampilla5
	
	agregar();
	cta_obcg();
	document.getElementById('t13').value=parseFloat(document.getElementById('valorPagar').value)-acum;
	...
	//alert (irfuente+','+iriva+','+irica+','+irest1+','+irest2+','+irest3+','+irest4+','+irest5);
		...
		if(libranza!=0&&document.getElementById('libranza').value!='')
		{
			...
			else acum=acum+parseFloat(document.getElementById('libranza').value);
		}
		...
		if(empleados!=0&&document.getElementById('f_empleados').value!='')
		{
			...
			else acum=acum+parseFloat(document.getElementById('f_empleados').value);
		}
		...
		if(embargo!=0&&document.getElementById('embargo').value!='')
		{
			...
			else acum=acum+parseFloat(document.getElementById('embargo').value);
		...
		if(pension!=0&&document.getElementById('pension').value!='')
		{
			...
			else acum=acum+parseFloat(document.getElementById('pension').value);
		...
		if(solidaridad!=0&&document.getElementById('f_solidaridad').value!='')
		{
			...
			else acum=acum+parseFloat(document.getElementById('f_solidaridad').value);
		}
		if(sindicato!=0&&document.getElementById('sindicato').value!='')
		{
			...
			else acum=acum+parseFloat(document.getElementById('sindicato').value);
		}
		if(cruce!=0&&document.getElementById('cruce').value!='')
		{
			...
			else acum=acum+parseFloat(document.getElementById('cruce').value);
		}
...
function neto()
{
	...
	document.getElementById('total_pagado').value=(net-(rfuente+riva+rica+es1+es2+es3+es4+es5+pen+soli+sindi+cru+sal+libr+empleo+embargo+otrosd));
	//ceros();
}
function dos()
{
...
$re11 = mysql_db_query($database,$sq11,$connectionxx);
      ...
      <tr>
        ...
        <td colspan="3" bgcolor="#FFFFFF"><div style="padding-left:15px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo4">
			...
			if ($ter_nat)
				{
					echo "<input name='ter_nat' type='text' id='tercero' value='$ter_nat'/>";
				}else{
					echo "<input name='ter_jur' type='hidden' id='tercero' value='$ter_jur'/>";
				}
			?>
              </div>
          </div>
...
echo "<input name='ter_jur2' id='ter_jur2' type='hidden' value='$ter_jur' />";
	  ...
	  <tr>
	    ...
	    <td width="200" bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
          <div align="center" class="Estilo4"><?php printf("%s",$fecha_cobp);?>
              <input name="fecha_cobp" id="fecha_cobp" type="hidden" value="<?php printf("%s",$fecha_cobp);?>"  />
          </div>
	      </div></td>
	    </tr>
	  <tr>
    ...
    <tr>
      ...
      <td colspan="3" bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
        <div align="center" class="Estilo20">
          <input name="des_ceva" type="text"   id="des_ceva" onblur="this.value=this.value.toUpperCase();" value="<?php echo $desseva; ?>" style="width:500px;" />
        </div>
      </div></td>
      </tr>
      ...
      <td colspan="4" bgcolor="#66CCCC"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
        <div align="center" class="Estilo12">
          <div align="center"><strong>Si el pago a realizar no tiene IVA, deje la casilla en BLANCO,<br />
            ...
            <input name="iva" size="5" type="text" class="Estilo12" id="iva" style="text-align:center" onkeyup="cinco();"  onkeypress="return validar(event)" value="<?php $iva=$_POST['iva']; printf("%s",$iva); ?>" />
...
<td>  <input name='siniva' id='siniva'  type='text' style='text-align:right' value=''/>  </td>
</tr>
<tr bgcolor='#F5F5F5'>
<td colspan ='4' align='right'> Valor del IVA &nbsp;</td>
<td> <input name='valoriva' id='valoriva'  type='text' style='text-align:right' value=''/> </td>
</tr>
...
<!-- rete cree -->
    ...
    <tr>
      <td><div style="padding-left:5px; padding-top:2px; padding-right:5px; padding-bottom:2px;">
          <div align="center">
            <select name="retecree" class="Estilo12" id="retecree" style="width: 300px;"  >
              <option value=""></option>
              <?php 
			   $retefuente = $_POST['retefuente'];		  
			   include('../config.php');
      ...
      <td><div style="padding-left:5px; padding-top:2px; padding-right:5px; padding-bottom:2px;">
          <div align="center" class="Estilo12">
			...
			<input name="vr_retecree" type="text" class="Estilo12" id="vr_retecree" style="text-align:right" onChange="ceros();" onkeypress="return validar(event)" 
			  value="<?php $vr_retecree=$_POST['vr_retecree']; printf("%s",$vr_retecree); ?>" onkeyup="tres();"  />			  
...
echo "<OPTION VALUE=\"".$row["concepto"]."\">".$row["concepto"]."</OPTION>";
 ...
 ?>
      ...
      <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:2px; padding-right:5px; padding-bottom:2px;"><div align="center" class="Estilo12">
