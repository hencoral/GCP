			...
			<tr>
				<td colspan="3">
					<div style="padding-left:10px; padding-top:30px; padding-right:10px; padding-bottom:10px;">
						<div align="center" class="Estilo4"><strong>PAGOS TESORERIA </strong></div>
					</div>
				</td>
			</tr>
			<tr>
										...
										<div style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
											<div align="center"><span class="Estilo4"><strong>Seleccione el Documento Fuente </strong>: </span>
												<select name="nn" class="Estilo4" style="width: 350px;">
													...
													$strSQL = "SELECT * FROM dctos_fuente_comprobantes  WHERE id_emp = '$idxx' AND tes_cxp = 'SI' ";
													$rs = $db->query($strSQL);
						...
						<div align="center">
							...
							?>
								...
								<div class="Estilo4" style='padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:5px;'>
									<div align="center"><strong>DOCUMENTO FUENTE ...::: CECP :::...<br />
											COMPROBANTES DE EGRESO CUENTAS X PAGAR <BR />
											<br />
										</strong></div>
								</div>
								<div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:400px'>
									<div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
										<a href="nuevo_cecp.php?siauto=AUT&riva=AUTIVA&autestun=AUTESTUN&autestdo=AUTESTDO&autesttr=AUTESTTR&autestcu=AUTESTCU&autestci=AUTESTCI" target="_parent">...::: CREAR NUEVO CECP :::... </a>
									</div>
								</div>
								<br />
								<br />
								<div class="Estilo4" style='padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:5px;'>
									<div align="center"><strong><span class="Estilo9">COMPROBANTES DE EGRESO CUENTAS X PAGAR<br />GENERADOS EN <?php echo $mesh[$me + 0] . " DE " . $an; ?></span><span class="Estilo9">
											</span></strong></div>
								</div>
								<br />
								<?php
								...
								$sqlz1 = "select * from cecp where id_emp = '$id_emp' and fecha_cecp between '$f1' and '$f2' order by id_manu_cecp asc ";
								$resz1 = $cx->query($sqlz1);


								if (isset($_POST["buscar"])) {
									$filtro = "and (id_manu_cecp LIKE  '%$buscar%' OR nt LIKE  '%$buscar%')";
								} else {
									$filtro = '';
								}

								$a = "select * from cecp where id_emp='$id_emp'";
								if (empty($tercero)) {
									$c = "";
								} else {
								...
								if ($fecha2 == "MES") {
									$f = "and fecha_cecp between '$f1' and '$f2'";
								}
								if ($fecha2 == "DIA") {
									$f = "and fecha_cecp ='$fechafil'";
								}
								if ($fecha2 == "A�O") {
									$f = "and fecha_cecp between '$a1' and '$a2'";
								}
								$gby = "group by id_auto_cecp";
								$orden = "order by fecha_cecp desc, id desc";
...
");
								while ($rowz1 = $resz1->fetch_assoc()) {
									...
									$tot_pag  = $rowz1["vr_obli_para_pago_mas_iva"];

									$tot_cheques = "";
									if (trim($rowz1["num_cheque"]) != "") {
										$tot_cheques = $tot_cheques . trim($rowz1["num_cheque"]);
									}
...
<span class='Estilo4'>
<a $ver_boton href=\"confirma_borra_cecp.php?id1=%s&fechac=%s\" onclick=\"if(!confirm('�Esta seguro de borrar el comprobante seleccionado?'))return false\">
...
<div style='padding-left:1px; padding-top:3px; padding-right:1px; padding-bottom:3px;'>
<span class='Estilo4'>
<a $ver_boton href=\"modi_cecp_2.php?id2=%s&mod=$modi&siauto=AUT&riva=AUTIVA&autestun=AUTESTUN&autestdo=AUTESTDO&autesttr=AUTESTTR&autestcu=AUTESTCU&autestci=AUTESTCI\" target='_parent' style='color:#0033FF'><img src='../simbolos/fuentes/modificar.png' width='20' height='20' border='0' title='Modificar'></a>
</span>
</div>
</td>
<td align='center' bgcolor='#DCE9E5'>
<div style='padding-left:1px; padding-top:3px; padding-right:1px; padding-bottom:3px;'>
<span class='Estilo4'>
<a href=\"imp_cecp2.php?id_cecp=%s\" style='color:#0033FF' target='_blank'><img src='../simbolos/fuentes/imprimir.png' width='20' height='20' border='0' title='Imprimir'></a>
</span>
</div>
</td>


</tr>", $rowz1["id_manu_cecp"], $rowz1["fecha_cecp"], $rowz1["nt"], number_format($tot_pag, 2, ',', '.'), $tot_cheques, $rowz1["id_auto_cecp"], $rowz1["fecha_cecp"], $rowz1["id_auto_cecp"], $rowz1["id_auto_cecp"]);
								}
