...
?>
    ...
    <head>
        ...
        <style type="text/css">
            ...
            @media print {
            ...
            </style><script>function validar(e) {
                ...
                return patron.test(te);
                        ...
                        ?><script type="text/javascript"language="javascript"src="../jquery.js"></script><script type="text/javascript">$(function() {
    ...
    <body>
        ...
        while ($rowxx = $resultadoxx->fetch_assoc()) {
            ...
            $id_auto_cobp = isset($rowxx["id_auto_cobp"]) ? $rowxx["id_auto_cobp"] : '';
                ...
                <tr>
                    ...
                    <td width="217" bgcolor="#FFFFFF">
                        <div class="Estilo4" style="padding-left:5px; padding-top:20px; padding-right:5px; padding-bottom:20px;">
                            <div align="center">
                                <span class="Estilo9">
                                    <h3>No. <?php printf("%s", $id_manu_cecp); ?> </h3>
                                </span>
                            </div>
                        </div>
                    </td>
            ...
            <table width="800" border="1" align="center" class="bordepunteado1">
                ...
                ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="Estilo21" style="padding-left:3px; padding-top:3x; padding-right:3px; padding-bottom:3px;"><span class="Estilo21" style="padding-left:3px; padding-top:3x; padding-right:3px; padding-bottom:3px;"><?php printf("%s", $no_banco); ?></span></div>
                                    </td>
                                    <td>
                                        <div class="Estilo21" style="padding-left:3px; padding-top:3x; padding-right:3px; padding-bottom:3px;"> <?php printf("%s", $no_cuenta); ?> </div>
                                    </td>
                                    <td>
                                        <div class="Estilo21" style="padding-left:3px; padding-top:3x; padding-right:3px; padding-bottom:3px;"> <?php printf("%s", $no_cheque); ?></div>
                                    </td>
                                    <td align="right">
                                        <div class="Estilo21" style="padding-left:3px; padding-top:3x; padding-right:3px; padding-bottom:3px;"> <?php printf("%s", number_format($valor_cr, 2, ',', '.')); ?></div>
                                    </td>
