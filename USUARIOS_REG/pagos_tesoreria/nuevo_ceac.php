...
?>
	...
	<head>
		...
		<script>
			...
			function rubroDuplicado(id) {
				var cont = 0;
				for (i = 1; i <= 20; i++) {
					var cobp = document.getElementById('cuenta_cxp' + i).value;
					if (cobp) {
						for (j = 1; j <= 20; j++) {
							...
							if (cobp == existe) {
								...
								if (cont > 1) {
									...
									document.getElementById('valor_pto' + j).value = '';
								}
							}
						}
						var cont = 0;
			...
			function ValorCuenta(id) {
				var n = id.substring(12, 10);
				var rubro = document.getElementById(id).value;
				var pos_url2 = 'consultas/valor_cta.php';
				var req = new XMLHttpRequest();
				if (req) {
					req.onreadystatechange = function() {
						if (req.readyState == 4) {
							var valor = req.responseText;
							document.getElementById('valor_pto' + n).value = valor;
							rubroDuplicado();
							valor_a_pagar();
						}
					}
					req.open('POST', pos_url2 + '?cod=' + rubro, false);
					req.send(null);
				}
			}
		...
		<script>
			...
			function neto() {
				...
				document.getElementById('total_pagado').value = Math.round(net - (rfuente + riva + rica + es1 + es2 + es3 + es4 + es5 + pen + soli + sindi + cru + sal + libr + empleo + embargo + otrosd));
				//ceros();
			}
		...
		<script>
			...
			function llenartabla() {
				...
				for (var y = 1; y <= u; y++) {
					acum2 = acum2 + parseInt(document.getElementById('vr_cre_' + y).value);
				}

				agregar();
				var s = parseInt(document.all.tablaf.rows.length);
				document.getElementById('pgcp' + s).value = "1110";
				document.getElementById('vr_cre_' + s).value = parseInt(document.getElementById('vr_obli_para_pago_mas_iva').value) - (acum + acum2);
		...
		<script>
			...
			function sumacredito() {
				...
				if (sumato != 0) {
					for (var k = 1; k <= sumato; k++)
						sumatotal = sumatotal + parseInt(document.getElementById('vr_cre_' + k).value);
			...
			function sumadebito() {
				...
				if (sumato != 0) {
					for (var k = 1; k <= sumato; k++)
						sumatotal = sumatotal + parseInt(document.getElementById('vr_deb_' + k + '').value);
					//alert(document.getElementById('t'+k+'4').value);
			...
			function cta_cecp(n) //  n2 => impar, n3 => par
			{
				...
				//alert(n+' '+n2+' '+n3)
				var pos_url = 'consultas/con_ceac.php';
						...
						if (req.readyState == 4) {
							...
							if (document.getElementById('iva').value == '') {
								document.getElementById('vr_deb_' + n).value =
									parseInt(document.getElementById('valor_pto' + n).value);
							} else {
								//var iva=1+(parseInt(document.getElementById('iva').value)/100);	
								var valor = parseInt(document.getElementById('valor_pto' + n).value); //iva;					
								document.getElementById('vr_deb_' + n).value = Math.round(valor);
	...
	<body onload="ceros(); consecutivo2();">
		<?php
		...
		?>
		<form name="a" method="post" id="commentForm" action="p_ceac.php" />
		<table width="800" border="0" align="center">
			...
			<tr>
					...
					<table width="800" border="1" align="center" class="bordepunteado1">
							...
							<td colspan="4" bgcolor="#DCE9E5">
								<div style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;"><?php echo "$ultimo"; ?>
									<div align="center" class="Estilo12"><strong>
											...
											?>
											COMPROBANTE DE EGRESO ACUMULADO</strong></div>
								</div>
							</td>
						</tr>
						<tr>
							<td bgcolor="#F5F5F5">
								<div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
									<div align="center" class="Estilo4">
										<div align="right"><strong><a name="ver_ter" id="ver_ter"></a>Fecha CEAC : </strong></div>
									</div>
								</div>
							</td>
							<td colspan="2" bgcolor="#FFFFFF">
								<div style="padding-left:15px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
									<div align="left">
										<?php
										$fecha_cecp = date('Y/m/d'); //printf("%s",$fecha_cecp); echo "entra else";
										?>
										<input name="fecha_ceva" type="text" class="required Estilo12" id="fecha_ceva" value="<?php printf($fecha_cecp); ?>" size="12" />
						...
						<tr>
							<td bgcolor="#F5F5F5" width="185">
								...
								$resulta = $cxquery("SHOW TABLE STATUS FROM $database LIKE 'ceva'");
                     ...
                     3px solid; background-color: #FAFAFA; color: #000000; display:none;">
											...
											<div style="padding-left:5px; padding-top:0px; padding-right:5px; padding-bottom:0px;">
												<div align="left">
													<select name="ter_jur" class="Estilo4" id="ter_jur" style="width: 350px;" <?php print $enaterjur; ?>>
														...
														$rs = $db->query($strSQL);
														while ($r = $rs->fetch_assoc()) {
															if ($r['id'] == $_POST['ter_jur'] or $r['id'] == '$terjuridaut' or $r['id'] == '$terjuridman') {
							...
							<td colspan="3" bgcolor="#FFFFFF">
								<div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
									<div align="left" class="Estilo4">
										<input name="des_ceva" type="text" class="required Estilo4" id="des_ceva" onkeyup="a.des_ceva.value=a.des_ceva.value.toUpperCase();" style="width: 520px;" value="<?php $conce = $_POST['concepto_pago'];
																																																			printf("%s", $conce); ?>" />
									</div>
								</div>
							</td>
						...
						<tr>
							<td bgcolor="#F5F5F5" colspan="3">
								<div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
									<div align="center" class="Estilo4">
										<div align="center"><strong>Seleccione la Obligaci&oacute;n que desea cancelar: </strong></div>
									</div>
								</div>
							</td>
						...
						<?php
						include('../config.php');
						$query = "SELECT * FROM obcg WHERE pagado = 'NO' group by id_auto_cobp ORDER BY id_manu_cobp";
			  ...
			  <td colspan='3' bgcolor='#FFFFFF'>
					<div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
					<div align='center'>
							<select name='cuenta_cxp$k' class='Estilo4' id='cuenta_cxp$k' style='width: 500px;' onblur='ValorCuenta(id);'>
								<option value=''</option>
			";
							$result = $link->query($query);
							while ($row = $result->fetch_assoc()) {
								if ($row['id_manu_cobp'] == $cuenta_cxp) {
									echo "<OPTION VALUE='$row[id_auto_cobp]' selected><b>$row[id_manu_cobp] - $row[des_cobp]</b></OPTION>";
								} else {
									echo "<OPTION VALUE='$row[id_auto_cobp]'>$row[id_manu_cobp] - $row[des_cobp] </OPTION>";
								}
							}
							echo "
			  </select>
			  ...
			  <td align='center'> <input type='text'  name='valor_pto$k' style='text-align:right' id='valor_pto$k' value='$valor_pto'   onkeypress='return validar(event)' /> </td>
			  </tr>
			";
						...
						<tr>
							...
							<td>
								<div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
									<div align="center" class="Estilo12">
										<div align="center">
											<input name="salud" type="text" class="Estilo12" id="salud" style="text-align:right" onkeypress="return validar(event)" value="<?php $salud = $_POST['salud'];
																																											printf("%.0f", $salud);	 ?>" />
											<?php
											if ($autom[0] == 'SI')
								...
								<div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
									<div align="center" class="Estilo12">
										<div align="center">
											...
											<input name="pension" id="pension" type="text" class="Estilo12" style="text-align:right" onkeypress="return validar(event)" value="<?php $pension = $_POST['pension'];
																																												printf("%.0f", $pension);	 ?>" />
											<?php
											if ($autom[1] == 'SI')
						...
						<tr>
							...
							<td>
								<div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
									<div align="center" class="Estilo12">
										<div align="center">
											<input name="libranza" type="text" class="Estilo12" id="libranza" style="text-align:right" onkeypress="return validar(event)" value="<?php $libranza = $_POST['libranza'];
																																													printf("%.0f", $libranza);	 ?>" />
											<?php
											if ($autom[2] == 'SI')
							...
							<td>
								<div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
									<div align="center" class="Estilo12">
										<div align="center">
											<input name="f_solidaridad" type="text" class="Estilo12" id="f_solidaridad" style="text-align:right" onkeypress="return validar(event)" value="<?php $f_solidaridad = $_POST['f_solidaridad'];
						...
						<tr>
							...
							<td width="200">
								<div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
									<div align="center" class="Estilo12">
										<div align="center">
											<input name="f_empleados" type="text" class="Estilo12" id="f_empleados" style="text-align:right" onkeypress="return validar(event)" value="<?php $f_empleados = $_POST['f_empleados'];
							...
							<td width="200">
								<div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
									<div align="center" class="Estilo12">
										<div align="center">
											<input name="sindicato" type="text" class="Estilo12" id="sindicato" style="text-align:right" onkeypress="return validar(event)" value="<?php $sindicato = $_POST['sindicato'];
																																													printf("%.0f", $sindicato);	 ?>" />
											<?php
											if ($autom[5] == 'SI')
						...
						<tr>
							...
							<td>
								<div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
									<div align="center" class="Estilo12">
										<div align="center">
											<input name="embargo" type="text" class="Estilo12" id="embargo" style="text-align:right" onkeypress="return validar(event)" value="<?php $embargo = $_POST['embargo'];
																																												printf("%.0f", $embargo);	 ?>" />
											<?php
											if ($autom[6] == 'SI')
							...
							<td>
								<div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
									<div align="center" class="Estilo12">
										<div align="center">
											<input name="cruce" type="text" class="Estilo12" id="cruce" style="text-align:right" onkeypress="return validar(event)" value="<?php $cruce = $_POST['cruce'];
																																											printf("%.0f", $cruce);	 ?>" />
											<?php
											if ($autom[7] == 'SI')
						...
						<tr>
							...
							<td>
								<div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
									<div align="center" class="Estilo12">
										<div align="center">
											<input name="otros" type="text" class="Estilo12" id="otros" style="text-align:right" onkeypress="return validar(event)" value="<?php $otros = $_POST['otros'];
																																											printf("%.0f", $otros);	 ?>" />
											<?php
											if ($autom[8] == 'SI')
