                ...
                <td colspan="3">
                    <div style="padding-left:10px; padding-top:30px; padding-right:10px; padding-bottom:10px;">
                        <div align="center" class="Estilo4"><strong>
                                ...
                                $sq = "select * from reteiva where id = '$id' ";
            ...
            <tr>
                <td colspan="3">
                    <div style="padding-left:0px; padding-top:5px; padding-right:0px; padding-bottom:5px;">
                        <div align="left">
                            <form name="a" method="post" onsubmit="return confirm('Verifique que todos los datos estan correctos')" action="p_mod_reteiva.php">
                                <table align="center" width="700" border="1" class="bordepunteado1">
                                    <tr>
                                        <td colspan="4" bgcolor="#DCE9E5">
                                            <div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                                                <div align="center" class="Estilo4"><strong>RETEIVA </strong></div>
                                            </div>
                                        </td>
                                    </tr>
      ...
      <td><div style='padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;'>
          <div align='center' class='Estilo4'>
            <div>
			  ...
			  <input name='id5$i' type='hidden' value='" . $idc . "'>
            </div>
          </div>
      </div></td>
	  <td><a href='eliminar_rango.php?id=" . $idc . "&id1=$id&pag=mod_reteiva.php'><img src='../images/error.png' width='20' border='0' /></a></td>
    </tr>";
                                        if ($i == $maxi) {
                                            $acc = 'none';
                                        }
