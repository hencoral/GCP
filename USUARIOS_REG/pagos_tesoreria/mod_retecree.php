    ...
    <body>
                ...
                <td colspan="3">
                    <div style="padding-left:10px; padding-top:30px; padding-right:10px; padding-bottom:10px;">
                        <div align="center" class="Estilo4"><strong>
                                ...
                                $sq = "select * from retecree where id = '$id' ";
            ...
            <tr>
                <td colspan="3">
                    <div style="padding-left:0px; padding-top:5px; padding-right:0px; padding-bottom:5px;">
                        <div align="left">
                            <form name="a" method="post" onsubmit="return confirm('Verifique que todos los datos estan correctos')" action="p_mod_retecree.php">
                                <table align="center" width="700" border="1" class="bordepunteado1">
                                    <tr>
                                        <td colspan="4" bgcolor="#DCE9E5">
                                            <div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                                                <div align="center" class="Estilo4"><strong>RETECREE </strong></div>
                                            </div>
                                        </td>
                                    </tr>
					 ...
					 <td><div aling='left' class='Estilo4' style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'><strong>CUENTA P.G.C.P RETENCION </strong></div></td>
					  <td colspan='3' ><div aling='left' style='padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;'> <span aling='left' class='Estilo4'>
						  <input name='cuenta' type='text' class='Estilo4' id='pgcp$i' style='width:70px;' value='$cuenta' onkeyup='lookup(this.value,$i);'>
					  </div><div style='float:rigth;display:none' id='resulta1'></div>
      ...
      <td><div style='padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;'>
          <div align='center' class='Estilo4'>
            <div>
		  		<input name='base$i' type='text' class='Estilo4' id='base$i' style='width:180px; style='text-align:right' value='$base[$j]' onkeypress='return validar(event)'>
		  	</div>
          </div>
     </div>
      </td>
      <td><div style='padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;'>
          <div align='center' class='Estilo4'>
            <div>
              <input name='tope$i' type='text' class='Estilo4' id='tope$i' style='width:180px; style='text-align:right' value='$tope[$j]' onkeypress='return validar(event)'>
            </div>
          </div>
      </div></td>
      <td><div style='padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;'>
          <div align='center' class='Estilo4'>
            <div>
              <input name='tarifa$i' type='text' class='Estilo4' id='tarifa$i' style='width:80px; style='text-align:center' value='$tarifa[$j]' onkeypress='return validar(event)'>
			  <input name='id5$i' type='hidden' value='$id5[$j]'>
            </div>
          </div>
      </div></td>
	  <td><a href='eliminar_rango.php?id=$id5[$j]&id1=$id&pag=mod_reteiva.php'><img src='../simbolos/eliminarblanco.png' width='20' border='0' /></a></td>
    </tr>";
                                        if ($i == $maxi) {
                                            $acc = 'none';
                                        }
