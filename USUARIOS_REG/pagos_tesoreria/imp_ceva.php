...
?>
  ...
  <body>
    ...
    while ($rowxx = $resultadoxx->fetch_assoc()) {
      ...
      $retecree = $rowxx["retecree"];
      $vr_retecree = $rowxx["vr_retecree"];
    ...
    $sq5 = "SELECT n_contrato from crpp where id_auto_crpp='$id_auto_crpp'";
    $re5 = $connectionxx->query($sq5);
    $rw5 = $re5->fetch_assoc();
    ...
    <form name="a">
      <table width="798" border="0" align="center">
        <tr>
          <td width="209" bgcolor="#FFFFFF">
            <div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
              <div align="center" class="Estilo4"><img src="../images/PLANTILLA PNG PARA LOGO EMPRESA.png" width="180"></div>
            </div>
          </td>
          <td colspan="2" bgcolor="#FFFFFF">
            <div style="padding-left:5px; padding-top:20px; padding-right:5px; padding-bottom:20px;">
              <div align="center" class="Estilo16">
                <h4>COMPROBANTE DE EGRESO VIGENCIA ACTUAL
                  <?php if ($logo == '2')
                    echo "No. $id_manu_ceva";
                  ?>
                </h4>
              </div>
            </div>
        ...
        <tr>
          ...
          <td bgcolor="#FFFFFF">
            <div class="Estilo21" style="padding-left:15px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
        ...
        <tr>
          ...
          <td colspan="3" bgcolor="#FFFFFF">
            <div class="Estilo22" style="padding-left:15px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <?php
        ...
        <tr>
          <td bgcolor="#F5F5F5">
            <div class="Estilo16" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <div align="right" class="Estilo22">No Contrato : </div>
            </div>
          </td>
          <td colspan="3" bgcolor="#FFFFFF">
            <div class="Estilo22" style="padding-left:15px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              <?php
              echo "$rw5[n_contrato]"; //concatenar propiedades entre comilla doble
              ?></div>
          </td>
        </tr>
      </table>
      ...
      <div align="center">
        ...
        $sq = "SELECT * from cobp where id_emp = '$id_emp' and id_auto_cobp ='$id_auto_cobp' and vr_digitado > 0 order by id asc ";
        $re = $cx->query($sq);
...
<td align='right'><span class='Estilo4'> %s&nbsp;</span></td>
      ...
      <table width="800" border="1" align="center" class="bordepunteado1">
        ...
        for ($j = 0; $j <= 15; $j++) {
          ...
          while ($rowe = $rese->fetch_assoc()) {
            $nom_e = isset($rowe['pgcp' . $j]) ? $rowe['pgcp' . $j] : '';
            ...
            if ($subcadena == "1110") {
              ...
              $respgcp = $connectionxx->query($sqpgcp);
        ...
        ?>
                <tr>
                  ...
                  <td>
                    <div class="Estilo4" style="padding-left:3px; padding-top:3x; padding-right:3px; padding-bottom:3px;"><span class="Estilo21" style="padding-left:3px; padding-top:3x; padding-right:3px; padding-bottom:3px;"><?php printf("%s", $no_banco); ?></span></div>
                  </td>
                  <td>
                    <div class="Estilo4" style="padding-left:3px; padding-top:3x; padding-right:3px; padding-bottom:3px;"> <?php printf("%s", $no_cuenta); ?> </div>
                  </td>
                  <td>
                    <div class="Estilo4" style="padding-left:3px; padding-top:3x; padding-right:3px; padding-bottom:3px;"> <?php printf("%s", $no_cheque); ?></div>
                  </td>
                  <td align="right">
                    <div class="Estilo4" style="padding-left:3px; padding-top:3x; padding-right:3px; padding-bottom:3px;"> <?php printf("%s", number_format($valor_cr, 2, ',', '.')); ?></div>
                  </td>
        ...
        <tr>
          <td colspan="4">
            <table width="800" border="0" align="center">
              ...
              <tr>
                <?php if ($reteiva == '' and $vr_reteiva <= 0.00) {
                } else {
                ?>
                  <td>
                    <div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
              ...
              <tr>
                <?php if ($retecree == '' and $vr_retecree == '') {
                } else {
                ?>
                  <td>
                    <div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
                      <div align="center" class="Estilo21">
                        <div align="right"><strong>RETECREE</strong> : </div>
                      </div>
                    </div>
                  </td>
                  <td colspan="2">
                    <div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
                      <div align="center" class="Estilo21">
                        <div align="left"><?php printf("%s", $retecree); ?> </div>
                      </div>
                    </div>
                  </td>
                  <td>
                    <div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
                      <div align="center" class="Estilo21">
                        <div align="right"><?php printf("%s", number_format($vr_retecree, 2, ',', '.')); ?> </div>
                      </div>
                    </div>
                  </td>
                <?php } ?>
              ...
              <tr>
                ...
                ?>
                  <td>
                    <div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
                      <div align="center" class="Estilo21">
                        <div align="right"><strong>DESCUENTO 1</strong>: </div>
                      </div>
                    </div>
                  </td>
                  <td colspan="2">
              ...
              <tr>
                ...
                ?>
                  <td>
                    <div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
                      <div align="center" class="Estilo21">
                        <div align="right"><strong>DESCUENTO 2</strong>: </div>
                      </div>
                    </div>
                  </td>
                  <td colspan="2">
              ...
              <tr>
                ...
                ?>
                  <td>
                    <div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
                      <div align="center" class="Estilo21">
                        <div align="right"><strong>DESCUENTO 3</strong>: </div>
                      </div>
                    </div>
                  </td>
                  <td colspan="2">
              ...
              <tr>
                ...
                ?>
                  <td>
                    <div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
                      <div align="center" class="Estilo21">
                        <div align="right"><strong>DESCUENTO 4</strong>: </div>
                      </div>
                    </div>
                  </td>
                  <td colspan="2">
              ...
              <tr>
                ...
                ?>
                  <td>
                    <div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
                      <div align="center" class="Estilo21">
                        <div align="right"><strong>DESCUENTO 5</strong>: </div>
                      </div>
                    </div>
                  </td>
                  <td colspan="2">
                  ...
                  <div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
                    <div align="center" class="Estilo21">
                      <div align="right"><strong>
                          <?php
                          $tot_rete = $vr_retefuente + $vr_reteica + $vr_reteiva + $vr_estampilla1 + $vr_estampilla2 + $vr_estampilla3 + $vr_estampilla4 + $vr_estampilla5 + $tot_desc + $vr_retecree;
      ...
      <table width="800" border="0" align="center">
        <tr>
          <td colspan="4" bgcolor="#CCCCCC">
            <div class="Estilo9" style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
      ...
      <span class="Estilo4">
        ...
        $reslogin = $connectionxx->query($sqlogin);
      ...
      <table width="800" border="1" align="center" class="bordepunteado1">
        ...
        <tr>
          <td width="200">
            <div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
              <div align="center" class="Estilo4">PREPAR&Oacute;</div>
            </div>
          </td>
          <td width="200">
            <div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
