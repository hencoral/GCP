...
{	
	...
	var req1 = new XMLHttpRequest();	if (req1)
	{																	
...
<?php
$id_auto_ceva = $_GET["id2"];
$sql ="select * from ceva where id_auto_ceva = '$id_auto_ceva'";
$rs = mysql_db_query($database, $sql, $connectionxx);
$rw = $rs->fetch_assoc();
$fecha_ceva = $rw['fecha_ceva'];
$id_manu_ceva = substr($rw['id_manu_ceva'],4,50);
$tercero = $rw["tercero"];
$ccnit = $rw["ccnit"];
...
?> 
      <tr>
        ...
        <td colspan="2" bgcolor="#FFFFFF"><div style="padding-left:15px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
		  ...
		  <?php
			...
			?>
            <input name="fecha_ceva" type="text" class="required Estilo12"  id="fecha_ceva" value="<?php printf($fecha_ceva);?>" size="12" />
      ...
      <tr>
        <td bgcolor="#F5F5F5" width="185"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;"></div></td>
        <td bgcolor="#FFFFFF" width="175"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;"></div></td>
        <td bgcolor="#F5F5F5" width="213"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
        ...
        <td bgcolor="#FFFFFF" width="197"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
            <div align="center" class="Estilo12">
			  ...
			  <?php
				...
				echo $ultimo2;
	          ?>
                <input name="id_manu_ceva" type="text" class="required Estilo4" id="id_manu_ceva" style="text-align:center" onkeypress="return validar(event)" value="<?php  printf("%s",$id_manu_ceva); ?>"  onkeyup="chk_ceva();"/>
               ...
               <div id="miVentana" style="position: fixed; width: 210px; height: 340px; top: 0; left: 0; font-family:Verdana,
                    ...
                    <iframe id="datamain" src="cecpconsecutivo.php"  width="200" height="290" marginwidth="0" 
...
<div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
      ...
      <tr>
        ...
        <td colspan="3"><table border="0" align="left">
		  ...
		  <?php
			//echo "$_POST[ter_nat] ** $_POST[ter_jur] ** $_POST[chkretefte]";
				...
				$sql2 = "SELECT * from terceros_naturales  WHERE num_id = 'ccnit'";
		...
		?>
            <td id="tercerosn"><div class="Estilo4" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                <div align="left"><span onmouseover="this.style.textDecoration='underline';this.style.cursor='hand'" onmouseout="this.style.textDecoration='none'" onclick="JavaScript:MostrarOcultar('naturales');"><font color="#0000FF"> NATURAL</font></span> - <span onmouseover="this.style.textDecoration='underline';this.style.cursor='hand'" onmouseout="this.style.textDecoration='none'" onclick="JavaScript:MostrarOcultar2('juridicos');"><font color="#0000FF"> JURIDICO</font></span> - <a href="../terceros/terceros.php" target="_parent">&iquest; NUEVO ?</a> </div>
            </div></td>
          </tr>
          <tr>
      ...
      <tr>
        ...
        <td colspan="3" bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="left" class="Estilo4">
            <input name="des_ceva" type="text" class="required Estilo4" id="des_ceva" onkeyup="a.des_ceva.value=a.des_ceva.value.toUpperCase();" style="width: 520px;" value="<?php $conce=$_POST['concepto_pago']; printf("%s",$conce); ?>"/>
          </div>
        </div></td>
        </tr>
      <tr>
        <td bgcolor="#F5F5F5" colspan="3"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo4">
...
$link=mysql_connect($server,$dbuser,$dbpass);
    ...
    ?>																																<!-- A�adir rubro presupuestal -->
      <tr>
       	<td  bgcolor="#990000" colspan="2" onclick="ejecucion_pto();" onmouseout="ocultar();" style="cursor:pointer"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
        <center style='color:#FFFFFF'><b>VER EJECUCION PRESUPUESTAL RUBROS SELECCIONADOS</b></center> </div></td>
       
        <td colspan="2" bgcolor="#CC9900" onclick="RelcionPagos();" onmouseout="ocultar();"  style="cursor:pointer"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
        <center style='color:#FFFFFF'><b>VER HISTORIAL DE PAGOS POR TERCERO</b></center> </div></td>
        </tr>
     <tr style='display:none' id='muestra_informe'>
        <td bgcolor="#F5F5F5" colspan="4" id="informe"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo4">
	...
	<br />																															<!-- Datos del tercero e informe de ejecucion -->
	  	<table width="800" border="1" align="center" class="bordepunteado1">
      <tr>
        <td colspan="2" bgcolor="#DCE9E5"><div style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
	  ...
	  <td colspan="2" bgcolor="#66CCCC"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
            <div align="center" class="Estilo12">
              <div align="center"><strong>Si el pago a realizar no tiene IVA, deje la casilla en BLANCO,<br />
				...
				if($_POST['iva']){	$iva=$_POST['iva']; printf("%s",$iva);} else{	$iva=0; printf("%s",$iva);}  ?>" />
        ...
        <td><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
            <div align="center" class="Estilo12">
              <div align="center">
                ...
                <input name="pension"  id="pension" type="text" class="Estilo12"  style="text-align:right" onkeypress="return validar(event)" value="<?php $pension = $_POST['pension'];  printf("%.0f",$pension);	 ?>" />
				<?php
				if ($autom[1]=='SI')
	...
	<tr>
    <td colspan="5"><div style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;"></div>
      <table width="800" border="1" align="center" class="bordepunteado1">
        <tr>
          <td colspan="4" bgcolor="#DCE9E5"><div style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
     ...
     <tr>
      ...
      <tr>
        <td colspan="5"><div class="Estilo19" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:5px;">
          <div align="center">
            <input name="Submit322" type="submit" class="Estilo19"  value="Grabar Comprobante de Egreso Cuentas x Pagar" 
