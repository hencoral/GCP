...
while($rowxx4 = mysql_fetch_array($resultadoxx4)) 
{
 ...
 <input name="p1" id="p1" type="hidden" value="<?php printf("%s",$p1);?>" /> 
  ...
  <form name="a" method="post" id="commentForm" action=""> 
...
<div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
    ...
    <tr>
      ...
      <td colspan="3" bgcolor="#FFFFFF"><div style="padding-left:15px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
