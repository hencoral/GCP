...
<table width="798" border="0" align="center">
  <tr>
	...
	<div align="center" class="Estilo4"><img src="../images/PLANTILLA PNG PARA LOGO EMPRESA.png" width="120" ></div>
	</div>	</td>
...
$sq = "select cuenta,sum(vr_digitado) from cobp where id_emp = '$id_emp' and ceva ='$id_ceva' group by cuenta order by id asc ";
$re = $cx->query($sq);
...
$nuevo_total=$nuevo_total + $rw["sum(vr_digitado)"];
   }
  ...
  <tr>
    <td colspan="4" bgcolor="#CCCCCC"><div class="Estilo9" style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
      <div align="center" class="Estilo9">
		...
		<b>VALOR NETO PAGADO&nbsp;&nbsp;&nbsp;&nbsp; = $<?php printf("%s",number_format($valor_cr,2,',','.'));?>        </b>
