...
?>
    ...
    <body>
                ...
                <td colspan="3">
                    <div style="padding-left:10px; padding-top:30px; padding-right:10px; padding-bottom:10px;">
                        <div align="center" class="Estilo4"><strong>
                                ...
                                $sq = "SELECT * from estampillas where id = '$id' ";
                                $re = $connectionxx->query($sq);
                                while ($rw = $re->fetch_assoc()) {
                                    $concepto = $rw["concepto"];

                                    $cuenta = $rw["cuenta"];
                                    $codigo_ret = isset($rw["codigo_ret"]) ? $rw["codigo_ret"] : '';
                                }
            ...
            <tr>
                <td colspan="3">
                    <div style="padding-left:0px; padding-top:5px; padding-right:0px; padding-bottom:5px;">
                        <div align="left">
                            <form name="a" method="post" onsubmit="return confirm('Verifique que todos los datos estan correctos')" action="p_mod_estampillas.php">
                                <table align="center" width="700" border="1" class="bordepunteado1">
                                    <tr>
                                        <td colspan="4" bgcolor="#DCE9E5">
                                            <div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                                                <div align="center" class="Estilo4"><strong>ESTAMPILLAS </strong></div>
                                            </div>
                                        </td>
                                    </tr>
					 ...
					 <div aling='left' class='suggestionsBox' id='sugges$i' style='display: none; position:absolute; left: 536px;'>
								...
								<div aling='left' class='suggestionList' id='autoSug$i'>
                                    ...
                                    //$acc='block';
                                    for ($i = 1; $i < 6; $i++) {
                                        $bs = isset($base[$i]) ? $base[$i] : '';
                                        $tp = isset($tope[$i]) ? $tope[$i] : '';
                                        $tf = isset($tarifa[$i]) ? $tarifa[$i] : '';
                                        $idc = isset($id5[$i]) ? $id5[$i] : '';
                                        $j = $i - 1;
	  ...
	  <td><a href='eliminar_rango.php?id=" . $idc . "&id1=$id&pag=mod_estampillas.php'><img src='../images/error.png' width='20' border='0' /></a></td>
    </tr>";
                                        if ($i == $maxi) {
                                            $acc = 'none';
                                        }
