...
<?php
	...
	$concepto_pago = isset($_POST['concepto_pago']) ? $_POST['concepto_pago'] : '';
	...
	if ($fecha_cecp > $bx or $fecha_cecp < $ax) {
		...
		$id_auto_cecp = isset($_POST['id_cp']) ? $_POST['id_cp'] : '';
		$id_manu_cecp = 'CECP' . $_POST['id_manu_cecp']; //ok
		$fecha_cecp = isset($_POST['fecha_cecpp']) ? $_POST['fecha_cecpp'] : '';
		...
		$libranza = isset($_POST['libranza']) ? $_POST['libranza'] : '';
		$f_solidaridad = isset($_POST['f_solidaridad']) ? $_POST['f_solidaridad'] : '';
		$f_empleados = isset($_POST['f_empleados']) ? $_POST['f_empleados'] : '';
		$sindicato = isset($_POST['sindicato']) ? $_POST['sindicato'] : '';
		$embargo = isset($_POST['embargo']) ? $_POST['embargo'] : '';
		$cruce = isset($_POST['cruce']) ? $_POST['cruce'] : '';
		$otros = isset($_POST['otros']) ? $_POST['otros'] : '';
		$retefuente = isset($_POST['retefuente']) ? $_POST['retefuente'] : '';
		$vr_retefuente = isset($_POST['vr_retefuente']) ? $_POST['vr_retefuente'] : '';
		$reteiva = isset($_POST['reteiva']) ? $_POST['reteiva'] : '';
		$vr_reteiva = isset($_POST['vr_reteiva']) ? $_POST['vr_reteiva'] : '';
		$reteica = isset($_POST['reteica']) ? $_POST['reteica'] : '';
		$a_partir_reteica = isset($_POST['a_partir_reteica']) ? $_POST['a_partir_reteica'] : '';
		$tarifa_reteica = isset($_POST['tarifa_reteica']) ? $_POST['tarifa_reteica'] : '';
		$vr_reteica = isset($_POST['vr_reteica']) ? $_POST['vr_reteica'] : '';
		$estampilla1 = isset($_POST['estampilla1']) ? $_POST['estampilla1'] : '';
		$vr_estampilla1 = isset($_POST['vr_estampilla1']) ? $_POST['vr_estampilla1'] : '';
		$estampilla2 = isset($_POST['estampilla2']) ? $_POST['estampilla2'] : '';
		$vr_estampilla2 = isset($_POST['vr_estampilla2']) ? $_POST['vr_estampilla2'] : '';
		$estampilla3 = isset($_POST['estampilla3']) ? $_POST['estampilla3'] : '';
		$vr_estampilla3 = isset($_POST['vr_estampilla3']) ? $_POST['vr_estampilla3'] : '';
		$estampilla4 = isset($_POST['estampilla4']) ? $_POST['estampilla4'] : '';
		$vr_estampilla4 = isset($_POST['vr_estampilla4']) ? $_POST['vr_estampilla4'] : '';
		$estampilla5 = isset($_POST['estampilla5']) ? $_POST['estampilla5'] : '';
		$vr_estampilla5 = isset($_POST['vr_estampilla5']) ? $_POST['vr_estampilla5'] : '';


		$forma_pago = isset($_POST['forma_pago']) ? $_POST['forma_pago'] : 0;
		$concepto_dian = isset($_POST['codigo_dian']) ? $_POST['codigo_dian'] : 0;
		$num_cheque = isset($_POST['num_cheque1']) ? $_POST['num_cheque1'] : 0; //printf("<br>num_cheque : %s <br>",$num_cheque);
		$banco_cheque = isset($_POST['banco_cheque1']) ? $_POST['banco_cheque1'] : 0; //printf("<br>banco_cheque : %s <br>",$banco_cheque);
		$cta_cheque = isset($_POST['cta_cheque1']) ? $_POST['cta_cheque1'] : 0; //printf("<br>cta_cheque : %s <br>",$cta_cheque);

		$num_cheque2 = isset($_POST['num_cheque2']) ? $_POST['num_cheque2'] : 0;  //printf("<br>num_cheque2 : %s <br>",$num_cheque2);
		$banco_cheque2 = isset($_POST['banco_cheque2']) ? $_POST['banco_cheque2'] : 0;  //printf("<br>banco_cheque2 : %s <br>",$banco_cheque2);
		$cta_cheque2 = isset($_POST['cta_cheque2']) ? $_POST['cta_cheque2'] : 0;  //printf("<br>cta_cheque2 : %s <br>",$cta_cheque2);

		$num_cheque3 = isset($_POST['num_cheque3']) ? $_POST['num_cheque3'] : 0;  //printf("<br>num_cheque3 : %s <br>",$num_cheque3);
		$banco_cheque3 = isset($_POST['banco_cheque3']) ? $_POST['banco_cheque3'] : 0;  //printf("<br>banco_cheque3 : %s <br>",$banco_cheque3);
		$cta_cheque3 = isset($_POST['cta_cheque3']) ? $_POST['cta_cheque3'] : 0;  //printf("<br>cta_cheque3 : %s <br>",$cta_cheque3);

		$num_cheque4 = isset($_POST['num_cheque4']) ? $_POST['num_cheque4'] : 0;  //printf("<br>num_cheque : %s <br>",$num_cheque);
		$banco_cheque4 = isset($_POST['banco_cheque4']) ? $_POST['banco_cheque4'] : 0;  //printf("<br>banco_cheque : %s <br>",$banco_cheque);
		$cta_cheque4 = isset($_POST['cta_cheque4']) ? $_POST['cta_cheque4'] : 0;  //printf("<br>cta_cheque : %s <br>",$cta_cheque);

		$num_cheque5 = isset($_POST['num_cheque5']) ? $_POST['num_cheque5'] : 0;  //printf("<br>num_cheque : %s <br>",$num_cheque);
		$banco_cheque5 = isset($_POST['banco_cheque5']) ? $_POST['banco_cheque5'] : 0;  //printf("<br>banco_cheque : %s <br>",$banco_cheque);
		$cta_cheque5 = isset($_POST['cta_cheque5']) ? $_POST['cta_cheque5'] : 0;  //printf("<br>cta_cheque : %s <br>",$cta_cheque);

		$num_cheque6 = isset($_POST['num_cheque6']) ? $_POST['num_cheque6'] : 0;  //printf("<br>num_cheque : %s <br>",$num_cheque);
		$banco_cheque6 = isset($_POST['banco_cheque6']) ? $_POST['banco_cheque6'] : 0;  //printf("<br>banco_cheque : %s <br>",$banco_cheque);
		$cta_cheque6 = isset($_POST['cta_cheque6']) ? $_POST['cta_cheque6'] : 0;  //printf("<br>cta_cheque : %s <br>",$cta_cheque);

		$num_cheque7 = isset($_POST['num_cheque7']) ? $_POST['num_cheque7'] : 0;  //printf("<br>num_cheque : %s <br>",$num_cheque);
		$banco_cheque7 = isset($_POST['banco_cheque7']) ? $_POST['banco_cheque7'] : 0;  //printf("<br>banco_cheque : %s <br>",$banco_cheque);
		$cta_cheque7 = isset($_POST['cta_cheque7']) ? $_POST['cta_cheque7'] : 0;  //printf("<br>cta_cheque : %s <br>",$cta_cheque);
...
tot_deb='$tot_deb', tot_cre ='$tot_cre' where id_auto_cecp ='$id_auto_cecp'";
		...
		$result = $connectionxx->query($consulta);
		// vuelvo a guardar los registros de acuerdo a las modificaciones realizadas por el usuario
		$filas = $_POST["filas"];
		$i = 0;
		for ($i = 1; $i <= $filas; $i++) {
			$cuenta = isset($_POST['cuenta_cxp' . $i]) ? $_POST['cuenta_cxp' . $i] : '';
			$valor = isset($_POST['valor_pto' . $i]) ? $_POST['valor_pto' . $i] : '';
			$idc = isset($_POST['idc' . $i]) ? $_POST['idc' . $i] : '';
