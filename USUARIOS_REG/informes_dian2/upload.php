...
// ******************* Creo la tabla
  ...
  `valor_deduc` decimal(15,2) NOT NULL, 
  `valor_nodeduc` decimal(15,2) NOT NULL,
  `retefuente` decimal(10,2) NOT NULL,
  `reteiva` decimal(10,2) NOT NULL,
  `ivateorico` decimal(10,2) NOT NULL, 
  PRIMARY KEY  (`id`)
...
<table width="60%" border="1" align="center" class="bordepunteado1">
  ...
  <tr>
   ...
   <div align="center">
     ...
     <br>
     <span class="Estilo2"><em>Nombre del archivo: Dian_1001.csv<br />
