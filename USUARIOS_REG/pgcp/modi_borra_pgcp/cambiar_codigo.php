	...
	<form name="empresa" method="post" action="cambiar_codigo_2.php" onsubmit="return confirm('Verifique si todos los datos estan correctos')">
      ...
      <tr>
		...
		<div id="div7" style="padding-left:3px; padding-top:15px; padding-right:3px; padding-bottom:15px;">
          	  <div align="center"><strong>MODIFICAR CUENTA DEL PLAN GENERAL DE CONTABILIDAD PUBLICA<BR />
          	  P.G.C.P </strong><br />
          	    <br />
          	    <strong>Descripcion</strong>: Este proceso consiste en CAMBIAR una cuenta  DETALLE a MAYOR, que NO haya sido AFECTADA por ningun usuario del Sistema, con el objetivo de corregir errores en la <strong>Carga  del P.G.C.P </strong></div>
		</div></td>
        </tr>
      <tr>
        <td colspan="2" class="Estilo4"><div id="div5" style="padding-left:3px; padding-top:10px; padding-right:3px; padding-bottom:10px;">
          <div align="center"><strong>PASO 1. </strong><br />
            SELECCIONE la cuenta DETALLE que desea convertir a MAYOR          </div>
        </div></td>
        </tr>
      <tr>
        <td colspan="2" bgcolor="#F5F5F5" class="Estilo4"><div id="div6" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:15px;">
              <div align="center">(Puede modificar cuentas que <strong>NO</strong> tengan AFECTACION O MOVIMIENTO ALGUNO)<br /> 
                <br />
...
?>
      ...
      <tr>
        <td width="350" class="Estilo4"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center"><strong>PASO 2. </strong><BR />
            Digite el codigo contable de la NUEVA CUENTA que dependera de la seleccionada en el paso 1 </div>
        </div></td>
        <td width="350" class="Estilo4"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
...
var options = this.form.nn.options;for(var i = 0; i < options.length; i++){var match = options[i].value == this.value;if(match)break;}this.form.nn.selectedIndex = i;cambia();"/>
      ...
      <tr>
        <td bgcolor="#F5F5F5" class="Estilo4"><div id="div3" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:5px;">
          <div align="center"><strong>PASO 3.</strong><BR />
            Verifique si el codigo ingresado es correcto   </div>
        </div></td>
        <td bgcolor="#F5F5F5" class="Estilo4"><div id="div4" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:5px;">
