...
function chk_rcgt(){
var pos_url = '../comprobadores/comprueba_ncsf.php';
...
function agregar()
 {
	...
	td = tr.insertCell();
	td.innerHTML = "<input type='text' size='15' style='text-align:left' name='cheque"+contLin+"' id='cheque"+contLin+"' value='' onkeydown='displaycode(event,id);'>";
	td = tr.insertCell();
    ...
    <tr>
        <td colspan="4"><div class="Estilo12" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
          <div align="center">
            ...
            <span class="Estilo8">:::</span>
            Buscar Tercero :&nbsp;<input type='text' name='course_' class='Estilo4' id='course_' size='35' value="" />
	  ...
	  <div align="center">
        ...
        <div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:150px'>
          <div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
            <div align="center"><a href='../mvto_contable/menu_cont.php?a=NCSF&nn=NCSF' target='_parent'>VOLVER </a> </div>
          </div>
        </div>
	    </div>
	</div>	</td>
