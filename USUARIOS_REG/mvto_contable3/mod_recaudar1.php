...
$sq2= "select * from lib_aux4 where id_auto ='$id'";
$rs2= mysql_query($sq2);
	...
	<table width="1000" border="1" align="center" class="bordepunteado1">
      ...
      <tr>
        ...
        <td colspan="2"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
            ...
            <div align="center">
              <input name="fecha_recaudo" type="text" class="required Estilo4" id="fecha_recaudo" value="<? printf("%s",$rw2['fecha']);?>" size="12" alt="1" />
	  ...
	  <div align="center">
        ...
        <div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:150px'>
          <div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
            <div align="center"><a href='../mvto_contable/menu_cont.php?a=NCSFON&nn=NCSF' target='_parent'>VOLVER </a> </div>
          </div>
        </div>
	    </div>
	</div>	</td>
