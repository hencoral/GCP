                                ...
                                <tr>
                                    <td>
                                        <div id="div2" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                                            <div align="center">
                                                <input name="fecha_ini" type="text" readonly="readonly" class="Estilo4" id="fecha_ini" value="<?php printf($desde); ?>" size="12" />
                                    ...
                                    <td>
                                        <div id="div" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                                            <div align="center">
                                                <input name="fecha_fin" type="text" readonly="readonly" class="Estilo4" id="fecha_fin" value="<?php printf($fecha_fin); ?>" size="12" />
                                                <input name="button" type="button" class="Estilo4" id="button" onclick="displayCalendar(document.a.fecha_fin,'yyyy/mm/dd',this)" value="Seleccionar Fecha" />
                                ...
                                <tr>
                                    <td colspan="2">
                                        <div class="Estilo4" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
                                            <div align="center">
                                                <div align="center">
                                                    <input name="Submit321" type="submit" class="Estilo4" value="CDP Abiertos" onclick="this.form.action = 'cdpp_crpp.php'" />

                                                    <input name="Submit322" type="submit" class="Estilo4" value="Cuentas Por Pagar" onclick="this.form.action = 'cxp.php'" />
                                                    <!--    nuevo boton -->
                                                    <input name="Submit323" type="submit" class="Estilo4" value="Reservas" onclick="this.form.action = 'reserva.php'" />
                                                </div>
                                            </div>
                                        </div>
                                    </td>
