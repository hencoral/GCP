	...
	<head>
		...
		<script language="javascript">
			...
			function validar2() {
				...
				if (!numero) {
					alert("Falta determinar el n�mero de consecutivo del CDPP..");
				...
				if (req) {
					req.onreadystatechange = function() {
						if (req.readyState == 4) {
							...
							if (req.responseText != 1) document.getElementById('res').innerHTML = req.responseText;
	...
	<body onload="consecutivo2()">
		...
		<form name="a" method="post" id="commentForm" action="p_mvto13.php">
			...
			<table width="60%" border="0" align="center" class="bordepunteado1" cellspacing="2" cellpadding="7">
				...
				<tr>
					<td class="Titulofor" align="left">
						<div style="padding-left:30px;">Rubro:</div>
					</td>
					<td class="Titulofor" align="center" colspan="2">
						<div style="padding-left:168px;">Valor:</div>
					</td>
				</tr>
				<tr>
					<td colspan="3">
						<table width="100%" border="1" align="center">
                            ...
                            <td align='center' width='75%'><i class='search'></i> &nbsp;<input type='text' name='course_$k' class='Estilo4' id='course_$k' size='95' />
                                <input type='hidden' name='cuenta_$k' id='valcourse_$k' /></td>
                            <td align='left' width='25%'><input name='valor_$k' type='text' class='Estilo4' id='valor_$k' size='20' onkeypress='return validar(event)' onkeyup='saldo_cuenta(id);' onFocus='tipo_cuenta(id);' style='text-align:right' />&nbsp;<label class='Estilo4' id='disponible_$k' align='left'></label></td>
                           </tr>";
				...
				<tr>
					<td class="Titulofor" colspan="3" height="20" align="center"><input name="Submit322" type="submit" class="Estilo4" value="Guardar" onclick="return validar2()" /></td>
				</tr>
			</table>
		</form>
		<script>
