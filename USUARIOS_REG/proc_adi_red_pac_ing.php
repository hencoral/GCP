...
if (!isset($_SESSION["login"])) {
  ...
  $sql2 = "SELECT * from pac_ingresos where cod_pptal ='$cod_pptal' and id_emp ='$id_emp' ";
              ...
              <td>
                <form name="b" method="post" action="proc_adi_red_pac_ing_2.php" onsubmit="return confirm('Desea Grabar Cambios?')">
                  ...
                  <div style="padding-left:5px; padding-top:15px; padding-right:5px; padding-bottom:5px;">
                    <div align="center" class="Estilo4">
                      <input name="Submit" type="submit" class="Estilo4" id="Submit" value="Grabar Cambios P.A.C" />
                    </div>
                  </div>
                </form>
              </td>
