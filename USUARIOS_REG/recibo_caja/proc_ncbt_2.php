...
$id_unico_reip='';
$vr_orig_reip='';
$id_manu_rcgt = 'RCGT'.$_POST['id_manu_ncbt']; //printf("<br>id_recau %s<br>",$id_recau);
$id_recau = 'RCGT'.$_POST['consec_ncbt']; //printf("<br>id_recau %s<br>",$id_recau);
...
else
{
	...
	{ 
										...
										'$vr_cre_10' , '$vr_cre_11' , '$vr_cre_12' , '$vr_cre_13' , '$vr_cre_14' , '$vr_cre_15' , 
										'$tot_deb' , '$tot_cre' ,
										'$id' , '$cuenta' , '$nombre' , '$vr_orig_reip' , '$vr_digitado', '$ter_nat', '$ter_jur', '$id_manu_rcgt'
...
{ 
	...
	if(valor==''||cuenta=='')
	{
		if(cuenta=='')
		{
			alert("No ha seleccionado cuenta 2");
...
function suma_tab()
{
	...
	document.getElementById("total").value=ath.round(total*100)/100;
...
function sum()
{
	...
	for(var i=1;i<=filas;i++)
	{
		sumacre=sumacre+parseInt(document.getElementById('vr_cre_'+i).value);
		sumadeb=sumadeb+parseInt(document.getElementById('vr_deb_'+i).value);
	}
	document.getElementById('tot_deb_a').value=sumadeb;
	document.getElementById('tot_cre_a').value=sumacre;
...
<body >
<br><br><br>
<div align="center"><span class="Estilo15">RECIBO DE CAJA GENERAL </span><BR>
</div>
  ...
  <tr>
    <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
      <div align="center" class="Estilo12">
        <div align="center" class="Estilo4"><strong>DESCRIPCION DEL RECIBO DE CAJA </strong> </div>
      </div>
    </div></td>
    <td colspan="2" bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
      <div align="center" class="Estilo13">
...
$sq = "select * from recaudo_rcgt where id_emp = '$id_emp' and id_recau ='$id_recau' order by id_recau asc ";
...
?>
    ...
    <td bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
      <div align="center">
        <input name="valor" type="text" class="required Estilo4" id="valor" size="20" onKeyPress="return validar(event)" style="text-align:right" onKeyUp="valida_form();"/>
      </div>
    </div></td>
  </tr>
</table>
<br />
<center>
  <span class="Estilo4"><font color="#990000"><span id="txt"><b><U>ATENCION</U></b><BR />
  <BR />
  </span> Ajuste el Movimiento Contable segun sus Requerimientos <BR />
  </font>
  <script>
function muestraURL(){
var miPopup
    ...
    <tr>
        <td colspan="4"><div class="Estilo12" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
          <div align="center">
            ...
            <input name="submit" id="btn2" type="submit" class="Estilo12"  value="Guardar Nota Credito Bancaria y Terminar" 
