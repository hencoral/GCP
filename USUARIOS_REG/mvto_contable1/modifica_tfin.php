...
<table width="800" border="0" align="center">
  ...
  <tr>
    ...
    <div style="padding-left:10px; padding-top:30px; padding-right:10px; padding-bottom:10px;">
      <div align="center" class="Estilo4"><strong>MODIFICA TRANSFERENCIA DE DATOS INTERNOS </strong></div>
    </div>  </td>
  </tr>
  
  <form name="a" method="post" id="commentForm" action='p_modifica_tfin.php'>
  <tr>
  <td colspan="3">
...
$sqlxxa = "select * from conta_tfin where id_emp = '$id_emp' and id_auto_ncon ='$id_ncon_1'";
...
<td bgcolor="#990000"><div class="Estilo8" style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
    ...
    <tr>
      <td colspan="5"><div class="Estilo12" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
        <div align="center">
          <input name="Submit" type="submit" class="Estilo4" value="Modifica TRANSFERENCIA DE DATOS INTERNOS" onclick="return noVacio3(this.form,this.form.contador.value);" >
        </div>
      </div></td>
    </tr>
    <!--secciones de fila -->
