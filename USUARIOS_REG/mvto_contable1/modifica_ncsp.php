...
<table width="800" border="0" align="center">
  ...
  <tr>
    ...
    <div style="padding-left:10px; padding-top:30px; padding-right:10px; padding-bottom:10px;">
      <div align="center" class="Estilo4"><strong>MODIFICA NOTA CREDITO SIN AFECTACION PRESUPUESTAL </strong></div>
    </div>  </td>
  </tr>
  
  <form name="a" method="post" id="commentForm" action='p_modifica_ncsp.php'>
  <tr>
  <td colspan="3">
...
$sqlxxa = "select * from conta_ncsp where id_emp = '$id_emp' and id_auto_ncon ='$id_ncon_1'";
...
while($rowxxa = mysql_fetch_array($resultadoxxa)) 
   {
    ...
    $difere = $tot_deb - $tot_cre;
            ...
            ?>
            <strong>DATOS NOTA CREDITO SIN AFECTACION PRESUPUESTAL </strong>            </div>
        </div></td>
      </tr>
      <tr>
...
//     $acc='block';
    ...
    <tr>
      <td colspan="4"><div class="Estilo12" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
        <div align="center">
          <input name="Submit" type="submit" class="Estilo4" value="Modifica NOTA CREDITO SIN AFECTACION PRESUPUESTAL" onclick="return noVacio3(this.form,this.form.contador.value);" >
        </div>
      </div></td>
    </tr>
    <!--secciones de fila -->
