...
$sqlxxa = "select * from obcg where id_emp = '$id_emp' and id_auto_obcg ='$id_obcg_1'";
$resultadoxxa = mysql_db_query($database, $sqlxxa, $connectionxx);

while($rowxxa = mysql_fetch_array($resultadoxxa)) 
   {
   
    $id_manu_ncon = substr($rowxxa["id_manu_obcg"],4,100);
    $fecha_ncon = $rowxxa["fecha_obcg"];
    $tercero = $rowxxa["tercero"];
    $des_ncon = $rowxxa["concepto_obcg"];
	$id_auto_cobp=$rowxxa["id_auto_cobp"];
    ...
    $vr_deb[1] = $rowxxa['vr_cre_1'];
    $vr_deb[2] = $rowxxa['vr_cre_2'];
    $vr_deb[3]= $rowxxa['vr_cre_3'];
    $vr_deb[4] = $rowxxa['vr_cre_4'];
    $vr_deb[5] = $rowxxa['vr_cre_5'];
    $vr_deb[6] = $rowxxa['vr_cre_6'];
    $vr_deb[7] = $rowxxa['vr_cre_7'];
    $vr_deb[8] = $rowxxa['vr_cre_8'];
    $vr_deb[9] = $rowxxa['vr_cre_9'];
    $vr_deb[10] = $rowxxa['vr_cre_10'];
    $vr_deb[11] = $rowxxa['vr_cre_11'];
    $vr_deb[12] = $rowxxa['vr_cre_12'];
    $vr_deb[13] = $rowxxa['vr_cre_13'];
    $vr_deb[14] = $rowxxa['vr_cre_14'];
    $vr_deb[15] = $rowxxa['vr_cre_15'];

    $vr_cre[1] = $rowxxa['vr_deb_1'];
    $vr_cre[2] = $rowxxa['vr_deb_2'];
    $vr_cre[3] = $rowxxa['vr_deb_3'];
    $vr_cre[4] = $rowxxa['vr_deb_4'];
    $vr_cre[5] = $rowxxa['vr_deb_5'];
    $vr_cre[6] = $rowxxa['vr_deb_6'];
    $vr_cre[7] = $rowxxa['vr_deb_7'];
    $vr_cre[8] = $rowxxa['vr_deb_8'];
    $vr_cre[9] = $rowxxa['vr_deb_9'];
    $vr_cre[10] = $rowxxa['vr_deb_10'];
    $vr_cre[11] = $rowxxa['vr_deb_11'];
    $vr_cre[12] = $rowxxa['vr_deb_12'];
    $vr_cre[13] = $rowxxa['vr_deb_13'];
    $vr_cre[14] = $rowxxa['vr_deb_14'];
    $vr_cre[15] = $rowxxa['vr_deb_15'];
    ...
    {
    $id_auto_ncon = $array["Auto_increment"];
    }
        
   
   include('../objetos/incrementar_fecha.php');  
   $fecha_ncon = incrementa_mes($fecha_ncon);
  
 $sql_pago = "select * from ceva where id_auto_cobp = '$id_auto_cobp'";
 $res_pago = mysql_db_query($database,$sql_pago,$connectionxx);
 $filas_pago = mysql_num_rows($res_pago);
 //echo "numero de filas = $filas_pago";  
if ($filas_pago > 0)
{
printf("
<tr>
...
<font color =red>El documento tiene pagos relacionados. No se pude anular...</font>
<br>
<br>
...
");
  ...
  <form name="a" method="post" id="commentForm" action='proc_anula_obcg.php'>
  <input type="hidden" name="obcg" value="<?php echo $id_obcg_1; ?>" />
  <input type="hidden" name="cobp" value="<?php echo $id_auto_cobp; ?>" />
  <tr>
  <td colspan="3">
    <table width="915" border="1" align="center" class="bordepunteado1">
      <tr>
        ...
        <div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
            ...
            <strong>DATOS NOTA DE CONTABILIDAD </strong>            </div>
        </div></td>
      </tr>
      <tr>
        <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="right"><strong>Fecha  NCON : </strong></div>
          </div>
        </div></td>
      ...
      <tr>
        <td bgcolor="#F5F5F5" width="200"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo4">
            <div align="right"><strong>
              No. Automatico de NCON   : </strong></div>
          </div>
        </div></td>
        ...
        <td bgcolor="#F5F5F5" width="200"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="right"><strong>Digite Numero  de NCON : </strong></div>
          </div>
        </div></td>
        <td bgcolor="#FFFFFF" width="200"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="center">
              <input name="id_manu_ncon" type="text" class="required Estilo4" id="id_manu_ncon" style="text-align:center" onkeypress="return validar(event)" value="" onkeyup="chk_ncon();"/>
              <br />
<div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
      ...
      <tr>
        <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="right"><strong>Concepto / Detalle NCON : </strong></div>
          </div>
        </div></td>
        <td colspan="3" bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="left">
              <input name="des_ncon" type="text" class="required Estilo12" id="des_ncon" size="130" onkeyup="a.des_ncon.value=a.des_ncon.value.toUpperCase();" value="<? printf("%s",$des_ncon);?>" />
            </div>
          </div>
        </div></td>
        </tr>
  ...
  <table width="915" border="1" align="center" class="bordepunteado1">
    ...
    <tr>
      <td colspan="4"><div class="Estilo12" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
        <div align="center">
          <input name="Submit" type="submit" class="Estilo4" value="Anular OBLIGACION CONTABLE" onclick="return noVacio3(this.form,this.form.contador.value);" >
        </div>
      </div></td>
    </tr>
    <!--secciones de fila -->
