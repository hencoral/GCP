...
<table width="800" border="0" align="center">
  ...
  <form name="a" method="post" id="commentForm" action='p_modifica_ncon.php'>
  <tr>
  <td colspan="3">
  ...
  <table width="915" border="1" align="center" class="bordepunteado1">
    ...
    <tr>
      <td colspan="4"><div class="Estilo12" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
        <div align="center">
          <input name="Submit" type="submit" class="Estilo4" value="Modifica NOTA DE CONTABILIDAD" onclick="return noVacio3(this.form,this.form.contador.value);" >
        </div>
      </div></td>
    </tr>
    <!--secciones de fila -->
