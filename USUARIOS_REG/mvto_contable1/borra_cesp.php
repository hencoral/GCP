...
<form  method="POST" action="confirma_borra_cesp.php" onSubmit="return confirm('Esta Accion eliminara la Informacion PERMANENTEMENTE, Desea Proceder?')">
<div align="center">
<div align="center"><br>
    <br>
    <span class="Estilo1">¿ Desea <b>Eliminar </b>el Comp. de Egreso sin Afec. Pptal  ?  </span>
  <br>
