...
$sqlxx = "select * from conta_cesp where id_auto_ncon ='$id' and id_emp='$id_emp'";
...
<table width="796" border="1" align="center" class="bordepunteado1">
  <tr>
	...
	<div align="center" class="Estilo16">
	  <h3>COMPROBANTE DE EGRESO SIN AFECTACION PRESUPUESTAL  </h3> 
	</div>
	</div>	</td>
...
<div align="center"><br>
    <?
$sqlxx2 = "select * from conta_cesp where id_auto_ncon ='$id' and id_emp='$id_emp'";
...
while($rowxx2 = mysql_fetch_array($resultadoxx2)) 
{
	...
	for($i=1;$i<16;$i++)
	{
		...
		{	 
			...
			<td style='text-align:right;' class='Estilo20'>".number_format($rowxx2["vr_deb_".$i],2,',','.')."&nbsp;</td>
			<td style='text-align:right;' class='Estilo20'>".number_format($rowxx2["vr_cre_".$i],2,',','.')."&nbsp;</td>
			</tr>");	
		}
	}
}
printf("
			...
			<td style='text-align:right;' class='Estilo20'><b>".number_format($tot_deb,2,',','.')."</b>&nbsp;</td>
			<td style='text-align:right;' class='Estilo20'><b>".number_format($tot_cre,2,',','.')."</b>&nbsp;</td>
			</tr>
</table>");
?>
...
<table width="800" border="1" align="center" class="bordepunteado1">
  <tr>
    <td colspan="4" bgcolor="#DCE9E5"><div class="Estilo16" style="padding-left:20px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
      <div align="left">Forma de Pago : <span class="Estilo21" style="padding-left:3px; padding-top:3x; padding-right:3px; padding-bottom:3px;"><? printf("%s",$forma_pago); ?></span></div>
    </div>      <div class="Estilo4" style="padding-left:3px; padding-top:3x; padding-right:3px; padding-bottom:3px;"></div></td>
    </tr>
  ...
  <tr>
	...
	for ($i= 1; $i<16;$i++)
	{
		$sql = "select * from conta_cesp where id_auto_ncon ='$id' and pgcp$i like '1110%'";
		$res5 = mysql_db_query($database,$sql,$connectionxx);
		$fil = mysql_num_rows($res5);
		...
		if ($fil > 0)
		{
			...
			$cuenta2 = $row[$cuenta];
			//
			$sq2 = "select * from pgcp where cod_pptal = '$cuenta2'";
			$re2 = mysql_db_query($database,$sq2,$connectionxx);
			$rw2 = mysql_fetch_array($re2);
			// inserto la tabla 
			?>
			<tr>
			<td><div class="Estilo21" style="padding-left:3px; padding-top:3x; padding-right:3px; padding-bottom:3px;"> <? printf("%s",$rw2['nom_banco1']); ?> </div></td>
    		<td><div class="Estilo21" style="padding-left:3px; padding-top:3x; padding-right:3px; padding-bottom:3px;"> <? printf("%s",$rw2['num_cta']); ?> </div></td>
    		<td><div class="Estilo21" style="padding-left:3px; padding-top:3x; padding-right:3px; padding-bottom:3px;"> <? printf("%s",$row['cheque'.$i]); ?> </div></td>
			<td align="right"><div class="Estilo21" style="padding-left:3px; padding-top:3x; padding-right:3px; padding-bottom:3px;"><? printf("".number_format($row['vr_cre_'.$i],2,',','.').""); ?>&nbsp;</div></td>
		    </tr>
			<?php
		}
	}
