...
<table width="800" border="0" align="center">
  ...
  <tr>
    ...
    <div style="padding-left:10px; padding-top:30px; padding-right:10px; padding-bottom:10px;">
      <div align="center" class="Estilo4"><strong>MODIFICA  NOTA DE CONTABILIDAD </strong></div>
    </div>  </td>
  </tr>
  
  <form name="a" method="post" id="commentForm" action='proc_duplica_ncon.php'>
  <tr>
  <td colspan="3">
...
$sqlxxa = "select * from conta_ncon where id_emp = '$id_emp' and id_auto_ncon ='$id_ncon_1'";
  ...
  <table width="915" border="1" align="center" class="bordepunteado1">
    ...
    <tr>
      <td colspan="4"><div class="Estilo12" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
        <div align="center">
          <input name="Submit" type="submit" class="Estilo4" value="Duplicar NOTA DE CONTABILIDAD" onclick="return noVacio3(this.form,this.form.contador.value);" >
        </div>
      </div></td>
    </tr>
    <!--secciones de fila -->
