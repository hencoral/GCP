...
$sqlxx = "select * from cartera_cont where consec_cartera ='$id'";
...
while($rowxx = mysql_fetch_array($resultadoxx)) 
{
  ...
  $id_manu_obcg=$rowxx["consec_cartera"];
  $fecha_obcg=$rowxx["fecha_causa"];
  $tercero=$rowxx["tercero"];
  $concepto_obcg=$rowxx["ref"];
  $total=$rowxx["tot_deb"]; 
  $id_auto_cobp=$rowxx["id_reip"];
  $sq4 ="select * from reip_ing where consecutivo ='$id_auto_cobp'";
...
<? printf("%s",$rw4['des']) ?>
 ...
 echo "<font class='Estilo1'>". $V->ValorEnLetras($num,"PESOS") ."</font>";//concatenar propiedades entre comilla doble
  ...
  <tr>
    <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
      <div align="right" class="Estilo16">No. de Reconocimiento Afectado : </div>
    </div></td>
    <td colspan="2" bgcolor="#FFFFFF"><div class="Estilo4" style="padding-left:15px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
<? printf("%s",$rw4['id_manu_reip']); ?>
    </div></td>
  </tr>
</table>
<br>
...
$sq2 = "select * from cartera_cont where consec_cartera ='$id' order by id asc ";
...
<table width="800" border="1" align="center" class="bordepunteado1">
  <tr>
    ...
    <td width="200" bgcolor="#F5F5F5"><div class="Estilo4" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
      <div align="right"><? echo number_format($total3,2,',','.'); // printf("%.2f",$total); ?> </div>
    </div></td>
    <td width="200" bgcolor="#F5F5F5"><div class="Estilo4" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
      <div align="right"><? echo number_format($total3,2,',','.'); // printf("%.2f",$total); ?> </div>
    </div></td>
