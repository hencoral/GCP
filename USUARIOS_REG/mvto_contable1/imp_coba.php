...
$sqlxx = "select * from conta_coba where id_auto_ncon ='$id' and id_emp='$id_emp'";
...
<div align="center"><br>
    <?
$sqlxx2 = "select * from conta_coba where id_auto_ncon ='$id' and id_emp='$id_emp'";
...
?>
    ...
    <table width="800" border="1" align="center" class="bordepunteado1">
      ...
      <tr>
        ...
        <? } else {
			$sqlxx1a = "select * from conta_coba where id_emp ='$id_emp' and banco1 = '$banco1' and cta1 = '$cta1' and cheque1 = '$cheque1'";
	...
	?>
      ...
      <tr bgcolor="#F5F5F5">
        ...
        <? } else {
			$sqlxx2a = "select * from conta_coba where id_emp ='$id_emp' and banco2 = '$banco2' and cta2 = '$cta2' and cheque2 = '$cheque2'";
	...
	?>
      ...
      <tr>
        ...
        <? } else {
			$sqlxx3a = "select * from conta_coba where id_emp ='$id_emp' and banco3 = '$banco3' and cta3 = '$cta3' and cheque3 = '$cheque3'";
	...
	?>
      ...
      <tr bgcolor="#F5F5F5">
        ...
        <? } else {
			$sqlxx4a = "select * from conta_coba where id_emp ='$id_emp' and banco4 = '$banco4' and cta4 = '$cta4' and cheque4 = '$cheque4'";
	...
	?>
      ...
      <tr bgcolor="#F5F5F5">
        ...
        <? } else {
			$sqlxx5a = "select * from conta_coba where id_emp ='$id_emp' and banco5 = '$banco5' and cta5 = '$cta5' and cheque5 = '$cheque5'";
	...
	?>
      ...
      <tr bgcolor="#F5F5F5">
        ...
        <? } else {
			$sqlxx6a = "select * from conta_coba where id_emp ='$id_emp' and banco6 = '$banco6' and cta6 = '$cta6' and cheque6 = '$cheque6'";
	...
	?>
      ...
      <tr bgcolor="#F5F5F5">
        ...
        <? } else {
			$sqlxx7a = "select * from conta_coba where id_emp ='$id_emp' and banco7 = '$banco7' and cta7 = '$cta7' and cheque7 = '$cheque7'";
	...
	?>
      ...
      <tr bgcolor="#F5F5F5">
        ...
        <? } else {
			$sqlxx8a = "select * from conta_coba where id_emp ='$id_emp' and banco8 = '$banco8' and cta8 = '$cta8' and cheque8 = '$cheque8'";
	...
	?>
      ...
      <tr bgcolor="#F5F5F5">
        ...
        <? } else {
			$sqlxx9a = "select * from conta_coba where id_emp ='$id_emp' and banco9 = '$banco9' and cta9 = '$cta9' and cheque9 = '$cheque9'";
	...
	?>
      ...
      <tr bgcolor="#F5F5F5">
        ...
        <? } else {
			$sqlxx10a = "select * from conta_coba where id_emp ='$id_emp' and banco10 = '$banco10' and cta10 = '$cta10' and cheque10 = '$cheque10'";
	...
	?>
      ...
      <tr bgcolor="#F5F5F5">
        ...
        <? } else {
			$sqlxx11a = "select * from conta_coba where id_emp ='$id_emp' and banco11 = '$banco11' and cta11 = '$cta11' and cheque11 = '$cheque11'";
	...
	?>
      ...
      <tr bgcolor="#F5F5F5">
        ...
        <? } else {
			$sqlxx12a = "select * from conta_coba where id_emp ='$id_emp' and banco12 = '$banco12' and cta12 = '$cta12' and cheque12 = '$cheque12'";
	...
	?>
      ...
      <tr bgcolor="#F5F5F5">
        ...
        <? } else {
			$sqlxx13a = "select * from conta_coba where id_emp ='$id_emp' and banco13 = '$banco13' and cta13 = '$cta13' and cheque13 = '$cheque13'";
	...
	?>
      ...
      <tr bgcolor="#F5F5F5">
        ...
        <? } else {
			$sqlxx14a = "select * from conta_coba where id_emp ='$id_emp' and banco14 = '$banco14' and cta14 = '$cta14' and cheque14 = '$cheque14'";
	...
	?>
      ...
      <tr bgcolor="#F5F5F5">
        ...
        <? } else {
			$sqlxx15a = "select * from conta_coba where id_emp ='$id_emp' and banco15 = '$banco15' and cta15 = '$cta15' and cheque15 = '$cheque15'";
