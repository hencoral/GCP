...
<form  method="POST" action="confirma_borra_ndsp.php" onSubmit="return confirm('Esta Accion eliminara la Informacion PERMANENTEMENTE, Desea Proceder?')">
<div align="center">
<div align="center"><br>
    <br>
    <span class="Estilo1">¿ Desea <b>Eliminar </b>la Nota Debito  sin Afec. Pptal  ?  </span>
  <br>
