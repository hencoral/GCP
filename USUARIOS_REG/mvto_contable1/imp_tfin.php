...
$sqlxx = "select * from conta_tfin where id_auto_ncon ='$id' and id_emp='$id_emp'";
...
<table width="796" border="1" align="center" class="bordepunteado1">
  <tr>
	...
	<div align="center" class="Estilo16">
	  <h3>TRANSFERENCIA DE FONDOS INTERNOS </h3> 
	</div>
	</div>	</td>
...
<div align="center"><br>
    <?
$sqlxx2 = "select * from conta_tfin where id_auto_ncon ='$id' and id_emp='$id_emp'";
...
?>
 ...
 for($j=0;$j<=15;$j++)
 {
            $sqle = "select * from conta_tfin where id_auto_ncon = '$id'";
			  ...
			  $nom_e=$rowe[pgcp."$j"];
						...
						if($subcadena=="1110")
						{
							...
							while($rowpgcp=mysql_fetch_array($respgcp))
							{
								...
								$valor_cr=$rowe[vr_cre_."$j"] + $rowe[vr_deb_."$j"];
