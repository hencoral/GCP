...
var pos_url = '../comprobadores/comprueba_ndsp.php';
...
var pos_url2 = 'consultas/concec_ndsp.php';	
...
<table width="800" border="0" align="center">
  ...
  <tr>
    ...
    <div style="padding-left:10px; padding-top:30px; padding-right:10px; padding-bottom:10px;">
      <div align="center" class="Estilo4"><strong>NUEVA NOTA DE AJUSTE POR CONVERGENCIA </strong></div>
    </div>  </td>
  </tr>
  
  <form name="a" method="post" class="Form" id="commentForm" action='proc_ndsp.php'>
  <tr>
  <td colspan="3">
...
$nit = mysql_fetch_array($res);
         ...
         ?>
            <strong>DATOS NOTA DE AJUSTE POR CONVERGENCIA </strong>            </div>
        </div></td>
      </tr>
      <tr>
        <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="right"><strong>Fecha  NDSP : </strong></div>
          </div>
        </div></td>
      ...
      <tr>
        <td bgcolor="#F5F5F5" width="200"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo4">
            <div align="right"><strong>
              <?
        $resulta = mysql_query("SHOW TABLE STATUS FROM $database LIKE 'conta_ndsp'");
        while($array = mysql_fetch_array($resulta)) 
        {
        $xa = $array["Auto_increment"];
        }
        ?>
              No. Automatico de NDSP   : </strong></div>
          </div>
        </div></td>
        ...
        <td bgcolor="#F5F5F5" width="200"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="right"><strong>Digite Numero  de NDSP : </strong></div>
          </div>
        </div></td>
        <td bgcolor="#FFFFFF" width="200"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
         ...
         <a href="javascript:mostrarVentana();">Mas</a>
               <div id="miVentana" style="position: fixed; width: 210px; height: 330px; top: 0; left: 0; font-family:Verdana,
                    ...
                    <div style="font-weight: bold; text-align: center; color: #FFFFFF; padding: 5px; background-color:#006394">
                      ...
                      <iframe id="datamain" src="ndspconsecutivo.php"  width="200" height="290" marginwidth="0" 
...
?>
      ...
      <tr>
        <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="right"><strong>Concepto / Detalle NDSP : </strong></div>
          </div>
        </div></td>
  ...
  <table width="900" border="1" align="center" class="bordepunteado1">
    ...
    <tr>
      <td colspan="5"><div class="Estilo12" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
        <div align="center">
          <input name="Submit" type="submit" class="Estilo4" value="Grabar NOTA DEBITO SIN AFEC. PPTAL" onclick="return noVacio5(this.form,this.form.contador.value)" />
        </div>
      </div></td>
    </tr>
    <!--secciones de fila -->
...
<input type='hidden' name='nn' value='NDSP'>
