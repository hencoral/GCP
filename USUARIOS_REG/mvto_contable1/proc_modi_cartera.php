...
$consec_cartera=$_POST['id_auto_ncon'];
$fecha_causa = $_POST['fecha_ncon'];// echo $fecha_causa;
$ref = $_POST['des_ncon'];
$fecha_ven = $_POST['fecha_ncon'];// echo $fecha_ven;
...
$pgcp8 = $_POST['pgcp8']+0;
$pgcp9 = $_POST['pgcp9']+0;
$pgcp10 = $_POST['pgcp10']+0;
$pgcp11 = $_POST['pgcp11']+0;
$pgcp12 = $_POST['pgcp12']+0;
$pgcp13 = $_POST['pgcp13']+0;
$pgcp14 = $_POST['pgcp14']+0;
$pgcp15 = $_POST['pgcp15']+0;
$pgcp16 = $_POST['pgcp16']+0;
$pgcp17 = $_POST['pgcp17']+0;
$pgcp18 = $_POST['pgcp18']+0;
$pgcp19 = $_POST['pgcp19']+0;
$pgcp20 = $_POST['pgcp20']+0;
$pgcp21 = $_POST['pgcp21']+0;
$pgcp22 = $_POST['pgcp22']+0;
$pgcp23 = $_POST['pgcp23']+0;
$pgcp24 = $_POST['pgcp24']+0;
$pgcp25 = $_POST['pgcp25']+0;
$pgcp26 = $_POST['pgcp26']+0;
$pgcp27 = $_POST['pgcp27']+0;
$pgcp28 = $_POST['pgcp28']+0;
$pgcp29 = $_POST['pgcp29']+0;
$pgcp30 = $_POST['pgcp30']+0;
$pgcp31 = $_POST['pgcp31']+0;
$pgcp32 = $_POST['pgcp32']+0;
$pgcp33 = $_POST['pgcp33']+0;
$pgcp34 = $_POST['pgcp34']+0;
$pgcp35 = $_POST['pgcp35']+0;
$pgcp36 = $_POST['pgcp36']+0;
$pgcp37 = $_POST['pgcp37']+0;
$pgcp38 = $_POST['pgcp38']+0;
$pgcp39 = $_POST['pgcp39']+0;
$pgcp40 = $_POST['pgcp40']+0;
$pgcp41 = $_POST['pgcp41']+0;
$pgcp42 = $_POST['pgcp42']+0;
$pgcp43 = $_POST['pgcp43']+0;
$pgcp44 = $_POST['pgcp44']+0;
$pgcp45 = $_POST['pgcp45']+0;
$pgcp46 = $_POST['pgcp46']+0;
$pgcp47 = $_POST['pgcp47']+0;
$pgcp48 = $_POST['pgcp48']+0;
$pgcp49 = $_POST['pgcp49']+0;
$pgcp50 = $_POST['pgcp50']+0;
...
/*		if(($valor_rec != $tot_deb) or ($valor_rec != $tot_cre))
		{
		printf("<br><br><center class='Estilo4'>Los <b>TOTALES</b> Debito (...::: ".$tot_deb." :::...) y Credito (...::: ".$tot_cre." :::...) de la causacion <br><br>
		<b>NO COINCIDEN</b> con el valor del <b>RECONOCIMIENTO</b><BR><BR>Debe volver a realizar la Modificacion <b>VERIFICANDO</b> previamente su informacion<br><br><br></center>");
		...
		{*/
			...
			{ 
				...
				{
				printf("<br><br><center class='Estilo4'>la Fecha de causacion <b>NO</b> debe ser <B>MENOR</B> a la fecha de <B>VENCIMIENTO</B><BR><BR>Debe volver a 
				realizar la 
				...
				$sqlx = "update cartera_cont set ref='$ref' , fecha_ven ='$fecha_ven' , 
				...
				tot_deb = '$tot_deb'  , tot_cre = '$tot_cre' 
				
				where id_emp= '$id_emp' and consec_cartera ='$consec_cartera' ";
				
				
				$resultado = mysql_db_query($database, $sqlx, $connectionxx);

	
				printf("<br><br><center class='Estilo4'>EL REGISTRO HA SIDO MODIFICADO<BR><BR></center>");
