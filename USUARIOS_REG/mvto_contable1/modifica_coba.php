...
<table width="800" border="0" align="center">
  ...
  <tr>
    ...
    <div style="padding-left:10px; padding-top:30px; padding-right:10px; padding-bottom:10px;">
      <div align="center" class="Estilo4"><strong>MODIFICA CONSIGNACION BANCARIA </strong></div>
    </div>  </td>
  </tr>
  
  <form name="a" method="post" id="commentForm" action='p_modifica_coba.php'>
  <tr>
  <td colspan="3">
...
$sqlxxa = "select * from conta_coba where id_emp = '$id_emp' and id_auto_ncon ='$id_ncon_1'";
...
while($rowxxa = mysql_fetch_array($resultadoxxa)) 
   {
    ...
    $difere = $tot_deb - $tot_cre;
            ...
            ?>
            <strong>DATOS CONSIGNACION BANCARIA </strong>            </div>
        </div></td>
      </tr>
      <tr>
        <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="right"><strong>Fecha  COBA : </strong></div>
          </div>
        </div></td>
      ...
      <tr>
        <td bgcolor="#F5F5F5" width="200"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo4">
            <div align="right"><strong>
              No. Automatico de COBA   : </strong></div>
          </div>
        </div></td>
        ...
        <td bgcolor="#F5F5F5" width="200"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="right"><strong>Digite Numero  de COBA : </strong></div>
          </div>
        </div></td>
        <td bgcolor="#FFFFFF" width="200"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
      ...
      <tr>
        ...
        <td colspan="3" bgcolor="#FFFFFF">
            <div style="padding-left:10px; padding-top:5px; padding-right:0px; padding-bottom:5px;">
          		<input type='text' name='tercero' class='Estilo4' id='tercero' size='70' value='<?php echo $ter. '-' . $tercero; ?>' /> &nbsp;<a href="../terceros/terceros.php" target="_new">Nuevo</a>
                <input type='hidden' name='valtercero' id='valtercero' value="<?php echo $ter; ?>" /></div> </td>
      </tr>
      <tr>
        <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="right"><strong>Concepto / Detalle COBA : </strong></div>
          </div>
        </div></td>
        <td colspan="3" bgcolor="#FFFFFF"><div style="padding-left:10px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="left">
              <input name="des_ncon" type="text" class="required Estilo12" id="des_ncon" size="100" onkeyup="a.des_ncon.value=a.des_ncon.value.toUpperCase();" value="<? printf("%s",$des_ncon);?>" />
            </div>
          </div>
        </div></td>
        </tr>
  ...
  <table width="915" border="1" align="center" class="bordepunteado1">
    ...
    <tr>
      <td colspan="4"><div class="Estilo12" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
        <div align="center">
          <input name="Submit" type="submit" class="Estilo4" value="Modifica CONSIGNACION BANCARIA" onclick="return noVacio3(this.form,this.form.contador.value);" >
        </div>
      </div></td>
    </tr>
    <!--secciones de fila -->
