...
var pos_url2 = 'consultas/concec_ncon.php';	
...
<table width="800" border="0" align="center">
  ...
  <tr>
    ...
    <div style="padding-left:10px; padding-top:30px; padding-right:10px; padding-bottom:10px;">
      <div align="center" class="Estilo4"><strong>NUEVA NOTA DE CONTABILIDAD </strong></div>
    </div>  </td>
  </tr>
  
  <form name="a" method="post" class="Form" id="commentForm" action='proc_ncon.php'>
  <tr>
  <td colspan="3">
...
?>
      ...
      <tr>
        ...
        <td colspan="2" bgcolor="#FFFFFF"><div style="padding-left:15px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="left">
            <input name="fecha_ncon" type="text" class="required Estilo12" id="fecha_ncon" value="<? printf("%s",$ano);?>" size="12" />
      ...
      <tr>
        <td bgcolor="#F5F5F5" width="200"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo4">
            <div align="right"><strong>
              <?
        $resulta = mysql_query("SHOW TABLE STATUS FROM $database LIKE 'conta_ncon'");
        ...
        <td bgcolor="#FFFFFF" width="200"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="center">
              <input name="id_manu_ncon" type="text" class="required Estilo4" id="id_manu_ncon" style="text-align:center" onkeypress="return validar(event)" onkeyup="chk_ncon();" />
         ...
         <a href="javascript:mostrarVentana();">Mas</a>
               <div id="miVentana" style="position: fixed; width: 210px; height: 330px; top: 0; left: 0; font-family:Verdana,
                    ...
                    <div style="font-weight: bold; text-align: center; color: #FFFFFF; padding: 5px; background-color:#006394">
                      ...
                      <iframe id="datamain" src="nconconsecutivo.php"  width="200" height="290" marginwidth="0" 
      ...
      <tr>
        ...
        <td colspan="3" bgcolor="#FFFFFF"><table border="0" align="center">
          <tr>
...
onclick="JavaScript:MostrarOcultar('naturales');"> NATURAL</span> - <span onmouseover="this.style.textDecoration='underline';this.style.cursor='hand'" 

onmouseout="this.style.textDecoration='none'" onclick="JavaScript:MostrarOcultar2('juridicos');"> JURIDICO</span> - <a href="../terceros/terceros.php" 
...
//onkeyup="a.des_ncon.value=a.des_ncon.value.toUpperCase();"
?>
                  </select>
                </div>
            </div></td>
          ...
          <tr>
            <td><div align="center" class="Estilo4 Estilo10">NO OLVIDE SELECCIONAR EL TERCERO </div></td>
      ...
      <tr>
        ...
        <td colspan="3" bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo12">
            <div align="center">
              <input name="des_ncon" type="text" class="required Estilo12" id="des_ncon" size="100"  />
            </div>
          </div>
        </div></td>
        </tr>
  ...
  <table width="900" border="1" align="center" class="bordepunteado1">
    ...
    <tr>
      ...
      <td width="134" bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; position:static">
    ...
    <?
     //$acc='block';
     for($i=1;$i<51;$i++){
     echo "<tr style='position:static; display:$acc;' id='fil$i'>
     ...
     <div class='suggestionsBox' id='sugges$i' style='display: none; position:absolute; left: 200px;'>
      ...
      <td><div style='padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;'>
          <div align='center' class='Estilo4'>
            <div align='right'>
              <input name='vr_deb_$i' type='text' class='Estilo4' id='vr_deb_$i' style='text-align:right' onkeypress='return validar(event)' onKeyUp='Calcular();' onfocus='siespgcp($i);'>
            </div>
          </div>
      </div></td>
      <td><div style='padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;'>
          <div align='center' class='Estilo4'>
            <div align='right'>
              <input name='vr_cre_$i' type='text' class='Estilo4' id='vr_cre_$i' style='text-align:right' onkeypress='return validar(event)' onKeyUp='Calcular();' onfocus='siespgcp($i);'>
            </div>
          </div>
      </div></td>
    </tr>";
    ...
    <tr>
      <td colspan="4"><div class="Estilo12" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
        <div align="center">
          <input name="Submit" type="submit" class="Estilo4" value="Grabar NOTA DE CONTABILIDAD" onclick="return noVacio2(this.form,this.form.contador.value)" />
        </div>
      </div></td>
    </tr>
    <!--secciones de fila -->
