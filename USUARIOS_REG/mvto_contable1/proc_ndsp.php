...
$id_manu_ncon = 'NDSP'.$_POST['id_manu_ncon']; //printf("%s<br>",$id_manu_ncon);
...
{
if ($fecha_ncon == '' or $id_manu_ncon == 'NDSP')
{
	
	printf("<br><br><center class='Estilo4'><b>NO</b> debe dejar casillas del Documento sin diligenciar<BR><BR>Verifique Fecha y/o No. NDSP<br><br></center> ");
...
else
{
	...
	{ 
		...
		$sql = "INSERT INTO conta_ndsp ( 
				...
				'$cta14' , '$cta15' ,
				'$cheque_1' , '$cheque_2' , '$cheque_3' , '$cheque_4' , '$cheque_5' , '$cheque_6' , '$cheque_7' , '$cheque_8' , '$cheque_9' , '$cheque_10' , '$cheque_11' , 
				'$cheque_12' , '$cheque_13' , '$cheque_14' , '$cheque_15',
				'$ips'
