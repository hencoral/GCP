...
$fechac=$_POST['fecha_c'];// echo $fechac;
//printf("%s",$id_obcg);
...
$sqf="select * from vf";
$resf=mysql_db_query($database,$sqf,$connectionxx);
$rowf=mysql_fetch_array($resf);
$fechav=$rowf['fecha_ini'];// echo $fechav;  
if($fechac<=$fechav)	
{
	printf("

	<center class='Estilo9'>
	<br><br>La Fecha de registro <b>NO</b> se encuentra dentro de la Vigencia Fiscal Actual<BR><BR>
...
else
{
	...
	$sSQL="Delete From conta_cesp Where id_emp='$id_emp' and id_auto_ncon ='$id_ncon'";
	mysql_query($sSQL);
	printf("
	<center class='Estilo9'>
