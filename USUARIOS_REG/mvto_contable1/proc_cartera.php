...
$conera = $_POST['consec_cartera'];
$consec_cartera = 'CAIC'.$_POST['consec_cartera'];
...
$sq3 = "Select nom_rubro from pgcp where cod_pptal = '$pgcp1';";
$re3 = @mysql_db_query($database, $sq3, $connectionxx);
$des1=@mysql_result($re3,0,0);
$sq3 = "Select nom_rubro from pgcp where cod_pptal = '$pgcp2';";
$re3 = @mysql_db_query($database, $sq3, $connectionxx);
$des2=@mysql_result($re3,0,0);
$sq3 = "Select nom_rubro from pgcp where cod_pptal = '$pgcp3';";
$re3 = @mysql_db_query($database, $sq3, $connectionxx);
$des3=@mysql_result($re3,0,0);
$sq3 = "Select nom_rubro from pgcp where cod_pptal = '$pgcp4';";
$re3 = @mysql_db_query($database, $sq3, $connectionxx);
$des4=@mysql_result($re3,0,0);
$sq3 = "Select nom_rubro from pgcp where cod_pptal = '$pgcp5';";
$re3 = @mysql_db_query($database, $sq3, $connectionxx);
$des5=@mysql_result($re3,0,0);
$sq3 = "Select nom_rubro from pgcp where cod_pptal = '$pgcp6';";
$re3 = @mysql_db_query($database, $sq3, $connectionxx);
$des6=@mysql_result($re3,0,0);
$sq3 = "Select nom_rubro from pgcp where cod_pptal = '$pgcp7';";
$re3 = @mysql_db_query($database, $sq3, $connectionxx);
$des7=@mysql_result($re3,0,0);
$sq3 = "Select nom_rubro from pgcp where cod_pptal = '$pgcp8';";
$re3 = @mysql_db_query($database, $sq3, $connectionxx);
$des8=@mysql_result($re3,0,0);
$sq3 = "Select nom_rubro from pgcp where cod_pptal = '$pgcp9';";
$re3 = @mysql_db_query($database, $sq3, $connectionxx);
$des9=@mysql_result($re3,0,0);
$sq3 = "Select nom_rubro from pgcp where cod_pptal = '$pgcp10';";
$re3 = @mysql_db_query($database, $sq3, $connectionxx);
$des10=@mysql_result($re3,0,0);
$sq3 = "Select nom_rubro from pgcp where cod_pptal = '$pgcp11';";
$re3 = @mysql_db_query($database, $sq3, $connectionxx);
$des11=@mysql_result($re3,0,0);
$sq3 = "Select nom_rubro from pgcp where cod_pptal = '$pgcp12';";
$re3 = @mysql_db_query($database, $sq3, $connectionxx);
$des12=@mysql_result($re3,0,0);
$sq3 = "Select nom_rubro from pgcp where cod_pptal = '$pgcp13';";
$re3 = @mysql_db_query($database, $sq3, $connectionxx);
$des13=@mysql_result($re3,0,0);
$sq3 = "Select nom_rubro from pgcp where cod_pptal = '$pgcp14';";
$re3 = @mysql_db_query($database, $sq3, $connectionxx);
$des14=@mysql_result($re3,0,0);
$sq3 = "Select nom_rubro from pgcp where cod_pptal = '$pgcp15';";
$re3 = @mysql_db_query($database, $sq3, $connectionxx);
$des15=@mysql_result($re3,0,0);
...
$tipa='';$tipb='';$tipc='';$tipd='';$tipe='';$tipf='';$tipg='';$tiph='';$tipi='';
$tipj='';$tipk='';$tipl='';$tipm='';$tipn='';$tipo='';
...
{
/*if(($valor_rec != $tot_deb) or ($valor_rec != $tot_cre))
{
printf("<br><br><center class='Estilo4'>Los <b>TOTALES</b> Debito (...::: ".$tot_deb." :::...) y Credito (...::: ".$tot_cre." :::...) de la causacion <br><br><b>NO COINCIDEN</b> con el valor del <b>RECONOCIMIENTO</b><BR><BR>Debe volver a realizar la causacion <b>VERIFICANDO</b> previamente su informacion<br><br><br></center>");
...
{*/
    ...
    if($fecha_causa > $bx or $fecha_causa < $ax)
    {
    ...
    { 
        if($fecha_causa > $fecha_ven)
        {
        printf("<br><br><center class='Estilo4'>la Fecha de causacion <b>NO</b> debe ser <B>MENOR</B> a la fecha de <B>VENCIMIENTO</B><BR><BR>Debe volver a realizar la 
        ...
        $sql = "INSERT INTO cartera_cont ( 
                
                id_emp , id_reip , tercero , valor_rec ,
                consec_cartera , fecha_causa , ref , fecha_ven ,
				...
				vr_deb_1 , vr_deb_2 , vr_deb_3 , vr_deb_4 , vr_deb_5 , vr_deb_6 , vr_deb_7 , vr_deb_8 , vr_deb_9 , vr_deb_10 , vr_deb_11 , vr_deb_12 , vr_deb_13 , vr_deb_14 , vr_deb_15 , vr_deb_16 , vr_deb_17 , vr_deb_18 , vr_deb_19 , vr_deb_20 , vr_deb_21 , vr_deb_22 , vr_deb_23 , vr_deb_24 , vr_deb_25 , vr_deb_26 , vr_deb_27 , vr_deb_28 , vr_deb_29 , vr_deb_30 , vr_deb_31 , vr_deb_32 , vr_deb_33 , vr_deb_34 , vr_deb_35 , vr_deb_36 , vr_deb_37 , vr_deb_38 , vr_deb_39 , vr_deb_40 , vr_deb_41 , vr_deb_42 , vr_deb_43 , vr_deb_44 , vr_deb_45 , vr_deb_46 , vr_deb_47 , vr_deb_48 , vr_deb_49 , vr_deb_50 , 
				vr_cre_1 , vr_cre_2 , vr_cre_3 , vr_cre_4 , vr_cre_5 , vr_cre_6 , vr_cre_7 , vr_cre_8 , vr_cre_9 , vr_cre_10 , vr_cre_11 , vr_cre_12 , vr_cre_13 , vr_cre_14 , vr_cre_15 , vr_cre_16 , vr_cre_17 , vr_cre_18 , vr_cre_19 , vr_cre_20 , vr_cre_21 , vr_cre_22 , vr_cre_23 , vr_cre_24 , vr_cre_25 , vr_cre_26 , vr_cre_27 , vr_cre_28 , vr_cre_29 , vr_cre_30 , vr_cre_31 , vr_cre_32 , vr_cre_33 , vr_cre_34 , vr_cre_35 , vr_cre_36 , vr_cre_37 , vr_cre_38 , vr_cre_39 , vr_cre_40 , vr_cre_41 , vr_cre_42 , vr_cre_43 , vr_cre_44 , vr_cre_45 , vr_cre_46 , vr_cre_47 , vr_cre_48 , vr_cre_49 , vr_cre_50 , 
                tot_deb , tot_cre , recaudado
        ...
        $sqlx = "update reip_ing set contab='SI' where id_emp= '$id_emp' and consecutivo ='$id_reip' ";
        $resultado = mysql_db_query($database, $sqlx, $connectionxx);

    
            printf("<br><br><center class='Estilo4'>EL REGISTRO HA SIDO INGRESADO A:<BR><BR>TESORERIA -> RECAUDOS -> CUENTAS X COBRAR -> CARTERA<BR><BR><BR><BR></center>");
...
<br><br>
<a href=\"../recaudos_tesoreria/recaudar1.php?id=%d\"><img src='../simbolos/fuentes/modificar.png' width='40' height='40' border='0' title='Imprimir CAIC'><br>::.RECAUDAR y/o CONSULTAR.::</a>
</form>
</center>
",$conera);
