...
$id_manu_ncon = 'NCSP'.$_POST['id_manu_ncon']; //printf("%s<br>",$id_manu_ncon);
...
// inicio del bloque
if ($fecha_ncon == '' or $id_manu_ncon == 'NCSP')
{
	
	printf("<br><br><center class='Estilo4'><b>NO</b> debe dejar casillas del Documento sin diligenciar<BR><BR>Verifique Fecha y/o No. NCSP<br><br></center> ");
...
else
{
	...
	{ 
		...
		$sql = "update conta_ncsp set 	
				...
				banco5  ='$banco5', banco6  ='$banco6', banco7  ='$banco7', banco8  ='$banco8', banco9  ='$banco9', banco10  ='$banco10', banco11  ='$banco11', banco12  ='$banco12', banco13  ='$banco13', banco14  ='$banco14', banco15  ='$banco15', cta1  ='$cta1', cta2  ='$cta2', cta3  ='$cta3', cta4  ='$cta4', cta5  ='$cta5', cta6  ='$cta6', cta7  ='$cta7', cta8  ='$cta8', cta9  ='$cta9', cta10  ='$cta10', cta11  ='$cta11', cta12  ='$cta12', cta13  ='$cta13', cta14  ='$cta14', cta15  ='$cta15', cheque1  ='$cheque1', cheque2  ='$cheque2', cheque3  ='$cheque3', cheque4  ='$cheque4', cheque5  ='$cheque5', cheque6  ='$cheque6', cheque7  ='$cheque7', cheque8  ='$cheque8', cheque9  ='$cheque9', cheque10  ='$cheque10', cheque11  ='$cheque11', cheque12  ='$cheque12', cheque13  ='$cheque13', cheque14  ='$cheque14', cheque15  ='$cheque15'
				, ips='$ips'
