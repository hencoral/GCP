...
$cx = new mysqli($server, $dbuser, $dbpass, $database) or die ("Fallo en la Conexion a la Base de Datos");
			$sql2 = "SELECT fecha_ncon , id_manu_ncon FROM conta_ndsp order by fecha_ncon, id_manu_ncon asc;";
		   ...
		   // $row = mysql_fetch_array($res);
			 ...
			 {   
     		 ...
     		 { 
               			echo "<tr><td colspan=$columnes><div align='center'><strong>$rows resultados de NDSP </strong></div></font> </td></tr>"; 
              			echo"<tr>";
              		 	echo "<td ><div align='center'><font size='2'> <strong>FECHA</strong></div></font></td>"; 
            			echo "<td ><div align='center'><font size='2'><strong>NDSP</strong></div></font></td>";                                                  
                        echo"</tr>";
