...
else
{
		...
		if($a == '1110')
		{
			...
			printf("<br>&nbsp;<b>%s</b>
			<br><br>
			&nbsp;Nombre del Banco :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name='banco2' type='text' class='Estilo4' style='width:240px;' value ='ACTUALICE PGCP - DATO NO EXISTE'/> <br><br>
			&nbsp;No. de la Cuenta :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name='cta2' type='text' class='Estilo4' style='width:240px;' value ='ACTUALICE PGCP - DATO NO EXISTE'/> <br><br>",$nom_rubro);
			}
			else
			{
			printf("<br>&nbsp;<b>%s</b>
			<br><br>
			&nbsp;Nombre del Banco :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name='banco2' type='text' class='Estilo4' style='width:240px;' value ='%s'/> <br><br>
			&nbsp;No. de la Cuenta :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name='cta2' type='text' class='Estilo4' style='width:240px;' value ='%s'/> <br><br>
