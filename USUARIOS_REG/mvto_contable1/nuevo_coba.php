...
<script language="JavaScript" type="text/javascript" src="javas2.js"></script>
...
function chk_rcgt(){
var pos_url = '../comprobadores/comprueba_coba.php';
...
var pos_url2 = 'consultas/concec_coba.php';	
...
function agregar()
 {
	...
	tr.id = 'fil_'+contLin; 
	td = tr.insertCell();
	td.innerHTML =" <input type='text' size='20' style='text-align:left;' id='pgcp"+contLin+"' name='pgcp"+contLin+"' value='' onkeyup='lookup(this.value,"+contLin+");' onkeydown='displaycode(event,id);' onkeypress='return validar(event)' alt='2' > <div class='suggestionsBox' id='sugges"+contLin+"' style='display: none; position:absolute; left: 130px;'><img src='images/upArrow.png' style='position: relative; top: -10px; left: 0px;' title='PGCP'> <div class='suggestionList' id='autoSug"+contLin+"' align=left> &nbsp;  </div></div> ";
	
	td = tr.insertCell();
	td.innerHTML = "<input type='text' size='70' style='text-align:left' name='des"+contLin+"' id='des"+contLin+"' value='' readonly >";
 ...
 for (i=1;i<=9;i++)
    {
		...
		if (bomber)
		document.getElementById('press_9').value=formatea(bomber);
		
	}	
		for (var j=1;j<=9;j++)
   		{
		tot_press += parseFloat(document.getElementById('press_'+j).value.replace(/\,/g,''));
		tot_conta += parseFloat(document.getElementById('conta_'+j).value.replace(/\,/g,''));
		}
...
function copied()
{
	var s=0;
	var campos ='';
		var filas = document.getElementById('contis').innerHTML;
		for (s=1;s<=filas;s++)
		{
...
function pegar ()
{
	...
	var filas3= document.getElementById('contis').innerHTML;
	var j=0;
	var n=0;
	for(j=0;j<=filas3;j++)
	{
...
<body onload="consecutivo2();">
 <form name="forma" method="post" id="forma" action="proc_coba.php">
               <?
			   // conexion		
			   include('../config.php');		
	...
	<table width="1000" border="1" align="center" class="bordepunteado1">
      ...
      <tr>
        ...
        <td colspan="2"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
            ...
            <div align="center">
              <input name="fecha_ncon" type="text" class="required Estilo4" id="fecha_recaudo" value="<? printf("%s",$ano);?>" size="12" alt="1" onchange="consecutivo2();" />
        ...
        <td><div style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
          <div align="center">
            ...
            <input name="id_manu_ncon" type="text" class="required Estilo12" id="id_manu_rcgt" size="20" onkeypress="return validar(event)" style="text-align:center" onkeyup="chk_rcgt();" alt="1" />
      ...
      <tr>
        ...
        <td colspan="3" bgcolor="#FFFFFF"><div style="padding-left:10px; padding-top:5px; padding-right:0px; padding-bottom:5px;">
                ...
                <input type='text' name='valtercero' id='valtercero' /></div> </td>
	  ...
	  <div align="center">
        ...
        <div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:150px'>
          <div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
            <div align="center"><a href='menu_cont?nn=COBA' target='_parent'>VOLVER </a> </div>
          </div>
        </div>
	    </div>
	</div>	</td>
