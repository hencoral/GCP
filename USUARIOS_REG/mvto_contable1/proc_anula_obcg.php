...
$des_ncon = $_POST['des_ncon'];
$id_auto_obcg = $_POST['obcg'];
$id_auto_cobp = $_POST['cobp'];
...
else
{
	...
	// marcar como liquidado obcg
	
	  $sql_e2 = "update obcg set pagado='SI', liq='SI' where  id_auto_obcg = '$id_auto_obcg'";
			$res_e2 = mysql_db_query($database, $sql_e2, $connectionxx);
   
   // marcar como contabilizado no COBP
