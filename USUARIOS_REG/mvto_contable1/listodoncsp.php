<?php
  if(isset($_POST["val"])){
    ...
    $sq2 = "select * from conta_ncsp where id_emp = '$id_emp' order by fecha_ncon desc ";
...
<div style='padding-left:1px; padding-top:3px; padding-right:1px; padding-bottom:3px;'>
<span class='Estilo4'>
<a href=\"modifica_ncsp.php?id1=%s\" ><img src='../simbolos/fuentes/modificar.png' width='20' height='20' border='0' title='Modificar'></a>
</span>
</div>
</td>
<td align='center' bgcolor='#DCE9E5'>
