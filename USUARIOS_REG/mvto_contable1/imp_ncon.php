...
$sqlxx = "select * from conta_ncon where id_auto_ncon ='$id' and id_emp='$id_emp'";
...
<div align="center"><br>
    <?
$sqlxx2 = "select * from conta_ncon where id_auto_ncon ='$id' and id_emp='$id_emp'";
...
while($rowxx2 = mysql_fetch_array($resultadoxx2)) 
{
	...
	for($i=1;$i<51;$i++)
	{
		...
		{	 
			...
			$cuenta = $rowxx2['pgcp'.$i];
			$debito = $rowxx2['vr_deb_'.$i];
			$credito = $rowxx2["vr_cre_".$i];
			echo "<tr>
			<td style='text-align:left;' class='Estilo20'>$cuenta</td>
			<td style='text-align:left;' class='Estilo20'>$nom_rubro2</td>
			<td style='text-align:right;' class='Estilo20'>$debito</td>
			<td style='text-align:right;' class='Estilo20'>$credito</td>
			</tr>";
		}
	}
}
