...
<script>
function chk_rcgt(){
var pos_url = '../comprobadores/comprueba_rtic.php';
...
function agregar()
 {
	...
	td = tr.insertCell();
	td.innerHTML = "<input type='text' size='20' style='text-align:right' name='vr_deb_"+contLin+"' id='vr_deb_" + contLin + "' value=0   onKeyUp='suma_tab();' onkeypress='return validar(event)'  onkeydown='displaycode(event,id);' onfocus='siespgcp("+contLin+");' onblur='formato(id,value)'>";
...
$num_filas =1;
$resulta = mysql_query("SHOW TABLE STATUS FROM $database LIKE 'recaudo_rtic'");
	  ...
	  <div align="center">
        ...
        <div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:150px'>
          <div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
            <div align="center"><a href='../recaudos_tesoreria/recaudos_tesoreria.php?a=RTIC&nn=RTIC' target='_parent'>VOLVER </a> </div>
          </div>
        </div>
	    </div>
	</div>	</td>
