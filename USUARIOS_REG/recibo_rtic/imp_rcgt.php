...
$sqlxx = "select * from recaudo_rtic where id_recau ='$id' and id_emp='$id_emp'";
...
<table width="798" border="1" align="center" class="bordepunteado1">
  <tr>
	...
	<div align="center" class="Estilo16">
	  <h3>RECIBO RETENCION DE INDUSTRIA Y COMERCIO  </h3> 
	</div>
	</div>	</td>
...
$resulta=mysql_query("select SUM(vr_digitado) AS TOTAL from recaudo_rtic WHERE id_recau = '$id' AND id_emp='$id_emp'",$link) or die (mysql_error());
...
$sq = "select * from recaudo_rtic where id_emp = '$id_emp' and id_recau ='$id' order by id asc ";
...
$sq2 = "select * from recaudo_rtic where id_emp = '$id_emp' and id_recau ='$id' order by id asc ";
