...
$id_unico_reip='';
$vr_orig_reip='';
$id_manu_rcgt = 'RTIC'.$_POST['id_manu_rcgt']; 
$id_recau = 'RTIC'.$consec_recaudo; 
	...
	{ 
		 ...
		 if($tot_deb_a != $tot_cre_a)
		 ...
		 else
		  {
				...
				$sq2="select id_recau from recaudo_rtic where id_recau ='$id_recau' ";
				$rs2=mysql_query($sq2);
...
<input type='hidden' name='nn' value='RTIC'>
