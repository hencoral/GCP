...
if (!isset($_SESSION["login"])) {
	...
	if ($ano > $bx or $ano < $ax) {
		...
		if ($ingreso == 1) {
			...
			switch ($longitud) {
				...
				case (1):
					...
					$consulta = $connection->query("SELECT tip_dato from cxp where cod_pptal ='$padre' and id_emp ='$idxx'");
		...
		<br><br> Verifique nuevamente su informacion</center>");
						...
						$sql = "SELECT * from cxp where cod_pptal='$codigo' and id_emp='$idxx'";
						$result = $connection->query($sql);
						if ($result->num_rows == 0) {
							//--------- INSERCION DEL NUEVO COD_PPTAL -----

							$sql = "INSERT INTO cxp ( ano , id_emp , padre , cod_pptal , nom_rubro , tip_dato , nivel , ppto_aprob , 
			proc_rec , situacion, afectado, pac, definitivo, inversion ) VALUES ( '$ano', '$id_emp', '', '$cod_pptal', '$nom_rubro', '$tip_dato', '$nivel', 
			'$ppto_aprob', '$proc_rec', '$situacion', '$afectado', 'NO', '$ppto_aprob', '$inversion')";
		...
		<br><br> Verifique nuevamente su informacion</center>");
						...
						//----------------------------------------------------------------------------------
						// ------------------- verificar que el cod pptal no existe en la empresa actual --
						$sql = "SELECT * from cxp where cod_pptal='$cod_pptal' and id_emp='$idxx'";
						$result = $connection->query($sql);

						if ($result->num_rows == 0) {
							//------ verifico que exista el padre ---

							$sql1 = "SELECT * from cxp where cod_pptal= '$padre' and id_emp='$idxx'";
				...
				<a href='consulta_ppto_gas.php'>Consulte el Plan Presupuestal de Ingresos</a> y Verifique su Informacion
								...
								$sql = "INSERT INTO cxp ( ano , id_emp , padre , cod_pptal , nom_rubro , tip_dato , nivel , ppto_aprob , 
			proc_rec , situacion, afectado, pac, definitivo, inversion ) VALUES ( '$ano', '$id_emp', '$padre', '$cod_pptal', '$nom_rubro', '$tip_dato',
			'$nivel', '$ppto_aprob', '$proc_rec', '$situacion', '$afectado', 'NO', '$ppto_aprob', '$inversion')";
								$connection->query($sql);
							}
						} else {
							echo "<br><br><center class='Estilo4'><b>El codigo presupuestal que intenta grabar ya existe en la Base de Datos<br>
			...
			<a href='consulta_ppto_gas.php'>Consulte el Plan Presupuestal de Ingresos</a> y Verifique su Informacion</center>";
						...
						$resulta = $connection->query("SELECT SUM(definitivo) AS TOTAL from cxp WHERE padre = '2' AND nivel = '2' AND 						
			id_emp='$idxx'");
						$row = $resulta->fetch_array();
						$total = $row[0];
						$nuevo_total = $total;
						//--------- ACTUALIZAR PADRE NIVEL 1 CUANDO EMPIEZA CON 1 -----
						$sqlB = "UPDATE cxp SET afectado='1', definitivo='$nuevo_total' WHERE cod_pptal = '2' 
			AND id_emp = '$idxx'";
						$connection->query($sqlB);

						//------------------------------------------------------
						//--------- SUMO TODOS LOS REGISTROS DE NIVEL 2 opcion cuando empiezan en 0 -----

						$resulta = $connection->query("SELECT SUM(definitivo) AS TOTAL from cxp WHERE padre = '0' AND nivel = '2' AND 						
			id_emp='$idxx'");
						$row = $resulta->fetch_array();
						$total = $row[0];
						$nuevo_total = $total;
						//--------- ACTUALIZAR PADRE NIVEL 1 CUANDO EMPIEZA CON 0 -----
						$sqlB = "UPDATE cxp SET afectado='1', definitivo='$nuevo_total' WHERE cod_pptal = '0' AND 
			id_emp = '$idxx'";
						$connection->query($sqlB);
					}
		...
		<br><br> Verifique nuevamente su informacion</center>");
						...
						if ($result->num_rows == 0) {
							...
							//------ verifico que exista el padre ---
							$sql1 = "SELECT * from cxp where cod_pptal = '$c2' and nivel = '2' and id_emp='$idxx'";
							$result1 = $connection->query($sql1);
							if ($result1->num_rows == 0) {
								echo "<br><br>
				<center class='Estilo4'>
				...
				<a href='consulta_ppto_gas.php'>Consulte el Plan Presupuestal de Ingresos</a> y Verifique su Informacion
								...
								$sql = "INSERT INTO cxp ( ano , id_emp, padre , cod_pptal , nom_rubro , tip_dato , nivel , ppto_aprob , proc_rec ,                    situacion, afectado, pac, definitivo, inversion ) 
			...
			<a href='consulta_ppto_gas.php'>Consulte el Plan Presupuestal de Ingresos</a> y Verifique su Informacion</center>";
						...
						$resulta = $connection->query("SELECT SUM(definitivo) AS TOTAL from cxp WHERE padre='$padre' AND nivel=$nivel 
			AND id_emp='$idxx'");
						$row = $resulta->fetch_array();
						$total = $row[0];
						$nuevo_total = $total;
						//--------- ACTUALIZAR PADRE  - NIVEL 2 -  -----
						$sqlB = "UPDATE cxp SET afectado = '1', definitivo='$nuevo_total' WHERE cod_pptal = '$c2' AND 
		...
		<br><br> Verifique nuevamente su informacion</center>");
						...
						if ($result->num_rows == 0) {
							...
							//------ verifico que exista el padre ---
							$sql1 = "SELECT * from cxp where cod_pptal = '$c3' and nivel = '3' and id_emp='$idxx'";
							$result1 = $connection->query($sql1);
			...
			<a href='consulta_ppto_gas.php'>Consulte el Plan Presupuestal de Ingresos</a> y Verifique su Informacion</center>";
						...
						$resulta = $connection->query("SELECT SUM(definitivo) AS TOTAL from cxp WHERE padre='$padre' AND nivel=$nivel AND 
			id_emp='$idxx'");
						$row = $resulta->fetch_array();
						$total = $row[0];
						$nuevo_total = $total;
						//--------- ACTUALIZAR PADRE  - NIVEL 3 -  -----
						$sqlB = "UPDATE cxp SET afectado ='1', definitivo='$nuevo_total' WHERE cod_pptal = '$c3' AND nivel = 
			'$niv3' AND id_emp = '$idxx'";
						...
						$resulta = $connection->query("SELECT SUM(definitivo) AS TOTAL from cxp WHERE 
			padre='$c2' AND nivel=$niv3 AND id_emp='$idxx'");
						$row = $resulta->fetch_array();
						$total = $row[0];
						$nuevo_total = $total;
						//--------- ACTUALIZAR PADRE  - NIVEL 2 -  -----
						$sqlB = "UPDATE cxp SET afectado = '1', definitivo='$nuevo_total' WHERE 
		...
		<br><br> Verifique nuevamente su informacion</center>");
						...
						if ($result->num_rows == 0) {
							...
							//------ verifico que exista el padre ---
							$sql1 = "SELECT * from cxp where cod_pptal = '$c4' and nivel = '4' and id_emp='$idxx'";
							$result1 = $connection->query($sql1);
			...
			id_emp='$idxx'");
						...
						$sqlB = "UPDATE cxp SET afectado ='1', definitivo='$nuevo_total' WHERE cod_pptal = '$c4' AND nivel = 
			'$niv4' AND id_emp = '$idxx'";
						$connection->query($sqlB);
						//---------------------------------------------------	  
						//--------- SUMO TODOS LOS REGISTROS DE NIVEL 4 -----

						$resulta = $connection->query("SELECT SUM(definitivo) AS TOTAL from cxp WHERE padre='$c3' AND nivel=$niv4 AND 
			id_emp='$idxx'");
						$row = $resulta->fetch_array();
						$total = $row[0];
						$nuevo_total = $total;
		...
		<br><br> Verifique nuevamente su informacion</center>");
						...
						if ($result->num_rows == 0) {
							...
							//------ verifico que exista el padre ---
							$sql1 = "SELECT * from cxp where cod_pptal = '$c5' and nivel = '5' and id_emp='$idxx'";
							$result1 = $connection->query($sql1);
			...
			<a href='consulta_ppto_gas.php'>Consulte el Plan Presupuestal de Ingresos</a> y Verifique su Informacion</center>";
						...
						$resulta = $connection->query("SELECT SUM(definitivo) AS TOTAL from cxp 
			WHERE padre='$padre' AND nivel=$nivel AND id_emp='$idxx'");
						$row = $resulta->fetch_array();
						$total = $row[0];
						$nuevo_total = $total;
						//--------- ACTUALIZAR PADRE  - NIVEL 5 -  -----
						$sqlB = "UPDATE cxp SET afectado ='1', definitivo='$nuevo_total' 
		...
		<br><br> Verifique nuevamente su informacion</center>");
						...
						if ($result->num_rows == 0) {
							...
							//------ verifico que exista el padre ---
							$sql1 = "SELECT * from cxp where cod_pptal = '$c6' and nivel = '6' and id_emp='$idxx'";
							$result1 = $connection->query($sql1);
		...
		<br><br> Verifique nuevamente su informacion</center>");
						...
						if ($result->num_rows == 0) {
							...
							//------ verifico que exista el padre ---
							$sql1 = "SELECT * from cxp where cod_pptal = '$c7' and nivel = '7' and id_emp='$idxx'";
							$result1 = $connection->query($sql1);
		...
		<br><br> Verifique nuevamente su informacion</center>");
						...
						if ($result->num_rows == 0) {
							...
							//------ verifico que exista el padre ---
							$sql1 = "SELECT * from cxp where cod_pptal = '$c8' and nivel = '8' and id_emp='$idxx'";
							$result1 = $connection->query($sql1);
		...
		<br><br> Verifique nuevamente su informacion</center>");
						...
						if ($result->num_rows == 0) {
							...
							//------ verifico que exista el padre ---
							$sql1 = "SELECT * from cxp where cod_pptal = '$c9' and nivel = '9' and id_emp='$idxx'";
							$result1 = $connection->query($sql1);
		...
		<br><br> Verifique nuevamente su informacion</center>");
						...
						if ($result->num_rows == 0) {
							...
							//------ verifico que exista el padre ---
							$sql1 = "SELECT * from cxp where cod_pptal = '$c10' and nivel = '10' and id_emp='$idxx'";
							$result1 = $connection->query($sql1);
		...
		<br><br> Verifique nuevamente su informacion</center>");
						...
						if ($result->num_rows == 0) {
							...
							//------ verifico que exista el padre ---
							$sql1 = "SELECT * from cxp where cod_pptal = '$c11' and nivel = '11' and id_emp='$idxx'";
							$result1 = $connection->query($sql1);
		...
		<br><br> Verifique nuevamente su informacion</center>");
						...
						if ($result->num_rows == 0) {
							...
							//------ verifico que exista el padre ---
							$sql1 = "SELECT * from cxp where cod_pptal = '$c12' and nivel = '12' and id_emp='$idxx'";
							$result1 = $connection->query($sql1);
		...
		<br><br> Verifique nuevamente su informacion</center>");
						...
						if ($result->num_rows == 0) {
							...
							//------ verifico que exista el padre ---
							$sql1 = "SELECT * from cxp where cod_pptal = '$c13' and nivel = '13' and id_emp='$idxx'";
							$result1 = $connection->query($sql1);
		...
		<br><br> Verifique nuevamente su informacion</center>");
						...
						if ($result->num_rows == 0) {
							...
							//------ verifico que exista el padre ---
							$sql1 = "SELECT * from cxp where cod_pptal = '$c14' and nivel = '14' and id_emp='$idxx'";
							$result1 = $connection->query($sql1);
		...
		<br><br> Verifique nuevamente su informacion</center>");
						...
						if ($result->num_rows == 0) {
							...
							//------ verifico que exista el padre ---
							$sql1 = "SELECT * from cxp where cod_pptal = '$c15' and nivel = '15' and id_emp='$idxx'";
							$result1 = $connection->query($sql1);
