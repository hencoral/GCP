...
?>
  ...
  <body>
    <table width="800" border="0" align="center">
      ...
      <tr>
        <td colspan="3">
          <form name="a" method="post" action="adi_ppto_ing_2.php" onsubmit="return confirm('Verifique si la cuenta seleccionada es la correcta')">
                ...
                <td width="250">
                  <div id="div5" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:5px;">
                    <div align="center"><span class="Estilo4"><strong>PASO 1. </strong><br />
                        SELECCIONE la cuenta DETALLE a la que desea ADICIONAR VALOR </span><br />
                    </div>
                  </div>
                </td>
          ...
          <table width="750" border="1" align="center" class="bordepunteado1">
            ...
            <tr>
              <td align="left">
                <div style="padding-left:10px; padding-top:5px; padding-right:5px; padding-bottom:5px;"> <span class="Estilo4"> 1. Si desea <strong>MODIFICAR</strong> una <strong>ADICION</strong>, eliminela y creela nuevamente con los datos correctos.
                    <br />
                  </span> </div>
              </td>
            </tr>
          ...
          <table width="750" border="0" align="center">
            <tr>
              <td width="1250" colspan="3" bgcolor="#FFFFFF">
                <div style='padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;'>
                  <div align="center" class="Estilo4"><strong>ADICIONES REALIZADAS A CUENTAS POR PAGAR </strong> </div>
                </div>
              </td>
            </tr>
              ...
              <td colspan="3">
                <div id="div6" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                  <div align="center" class="Estilo4"><?php
                                                      ...
                                                      $sq = "select * from adi_cxp where id_emp = '$idxx' order by cod_pptal asc ";
                                                      $re = $cx->query($sq);
...
<td align='center' width='80'><span class='Estilo1'><b>Fecha Adic.</b></span></td>
...
<td align='center' width='150'><span class='Estilo1'><b>Valor Adicion</b></span></td>
...
<td align='center'><span class='Estilo4'><a href=\"borra_adi_ppto_ing.php?borrar=%s\"> Borrar </a> </span></td>
