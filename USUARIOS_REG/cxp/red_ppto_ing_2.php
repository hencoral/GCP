...
?>
  ...
  <body>
    <table width="800" border="0" align="center">
      ...
      <tr>
        <td colspan="3">
          <form name="a" method="post" action="proc_red_ppto_ing.php" onsubmit="return confirm('Verifique que la Informacion es Correcta')">
              ...
              <tr>
                <td width="178" bgcolor="#F5F5F5">
                  <div id="div" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:5px;">
                    <div align="center"><span class="Estilo4"><strong>Fecha de la Cancelacion </strong></span><br />
                    </div>
                  </div>
                </td>
              ...
              <tr>
                <td>
                  <div id="div3" style="padding-left:3px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                    <div align="center"><span class="Estilo4"><strong>VALOR A CANCELAR </strong></span><br />
                    </div>
                  </div>
                </td>
                <td>
                ...
                <td width="152">
                  <div id="div6" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
                    <div align="center"> <span class="Estilo4"><strong>Presupuesto Cargado </strong><br />
              ...
              <tr>
                <td width="178">
                  <div id="div7" style="padding-left:3px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                    <div align="center"><span class="Estilo4"><strong>CONCEPTO DE LA CANCELACION </strong></span><br />
                    </div>
                  </div>
                </td>
                <td colspan="3">
              ...
              <tr>
                <td colspan="4">
                  <div id="div9" style="padding-left:3px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
                    <div align="center">
                      <input name="Submit" type="submit" class="Estilo4" value="Grabar Cancelacion" />
