              ...
              <tr>
                <td colspan="2" bgcolor="#DCE9E5" class="Estilo4">
                  <div id="div7" style="padding-left:3px; padding-top:15px; padding-right:3px; padding-bottom:15px;">
                    <div align="center"><strong>MODIFICAR CUENTA POR PAGAR </strong><br />
                      <br />
                      <strong>Descripcion</strong>: Este proceso consiste en CAMBIAR una cuenta DETALLE a MAYOR, que NO haya sido AFECTADA por ningun usuario del Sistema, con el objetivo de corregir errores en la <strong>Carga de las Cuentas por Pagar </strong>
                    </div>
                  </div>
                </td>
              </tr>
                ...
                <td colspan="2" class="Estilo4">
                  <div id="div5" style="padding-left:3px; padding-top:10px; padding-right:3px; padding-bottom:10px;">
                    <div align="center"><strong>PASO 1. </strong><br />
                      ...
                      <span class="Estilo4">Si cambia una cuenta creada en la CARGA INICIAL DE CUENTAS POR PAGAR en una fecha diferente a la de INICIO DE OPERACIONES, el valor por defecto de la misma pasara a ser cero (0)
              ...
              <tr>
                <td colspan="2" bgcolor="#F5F5F5" class="Estilo4">
                  <div id="div6" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:15px;">
                    <div align="center">(Puede modificar cuentas que <strong>NO</strong> tengan P.A.C, ADICIONES, CANCELACIONES o AFECTACION ALGUNA)<br /> <br />
                      ...
                      <select name="nn" onchange="cambia()" class="Estilo4" style="width: 400px;">
                        ...
                        $strSQL = "SELECT * FROM cxp WHERE id_emp = '$idxx' AND tip_dato = 'D' AND afectado = '0' 
															 AND afectado_otros = '0' AND pac ='NO' ORDER BY cod_pptal";
                        $rs = $db->query($strSQL);
