              ...
              <tr>
                <td colspan="2" bgcolor="#DCE9E5" class="Estilo4">
                  <div id="div" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:3px;">
                    <div align="center"><strong>ELIMINAR CUENTA POR PAGAR </strong><br />
                      <br />
                      <strong>Descripcion</strong>: Este proceso consiste en ELIMINAR una cuenta existente, sea MAYOR o DETALLE, que NO haya sido AFECTADA por ningun usuario del Sistema, con el objetivo de corregir errores en la <strong>Carga de Cuentas por Pagar </strong> o eliminar la cuenta definitivamente.
                    </div>
                  </div>
                </td>
              </tr>
                ...
                <td colspan="2" class="Estilo4">
                  <div id="div5" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:5px;">
                    <div align="center"><strong>PASO 1. </strong><br />
                      ...
                      (Puede eliminar cuentas que <strong>NO</strong> tengan P.A.C, ADICIONES, CANCELACIONES o AFECTACION ALGUNA) <br />
                      <br />
                      <span class="Estilo8">ATENCION</span><br />
                      Si elimina una cuenta creada en la CARGA INICIAL DE CUENTAS POR PAGAR y decide crearla nuevamente en una fecha diferente a la de INICIO DE OPERACIONES, el valor por defecto de la misma pasara a ser cero (0)
                  ...
                  <div id="div6" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:15px;">
                    <div align="center"><strong>CUENTAS CARGADAS HASTA LA FECHA</strong><br />
                      ...
                      <select name="nn" class="Estilo4" style="width: 400px;">
                        ...
                        $strSQL = "SELECT * FROM cxp WHERE id_emp = '$idxx' AND afectado = '0' AND afectado_otros ='0' AND pac ='NO' ORDER BY cod_pptal";
                        $rs = $db->query($strSQL);
