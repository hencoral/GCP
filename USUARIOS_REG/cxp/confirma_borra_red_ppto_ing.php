...
?>
	...
	$sqlxx = "select * from cancelaciones_cxp where id ='$id' and id_emp ='$idxx'";
...
<div align='center'><a href='red_ppto_ing.php' target='_parent'>VOLVER</a>
	...
	$sSQL = "DELETE from cancelaciones_cxp Where id='$id' and id_emp ='$idxx'";
	$cx->query($sSQL);

	printf("
<center class='Estilo4'><br><br><b>CANCELACION ELIMINADA CON EXITO</B><br><br>
<div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:150px'>
<div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
<div align='center'><a href='red_ppto_ing.php' target='_parent'>VOLVER</a>
</div>
