...
.Estilo19 {font-weight: bold; font-size: 14px; }
-->
</style>
<script> 
function validar(e) { 
...
while($rowxx = $resultadoxx->fetch_assoc()) 
{
  ...
  $id_manu_roit=$rowxx["id_manu_roit"];
  
}
$id_unico_reip2 = $rowxx["id_unico_reip"];
...
<table width="800" border="1" align="center" class="bordepunteado1">
  <tr>
	...
	<div align="center" class="Estilo16"><h3>RECIBO OFICIAL DE INGRESOS</h3> </div>
	</div>	</td>
    <td bgcolor="#FFFFFF" width="200">
  ...
  <tr>
    <td bgcolor="#F5F5F5" class="Estilo4"><div class="Estilo17" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
...
<?php printf("%s",$des_recaudo); ?>	</div>	</td>
  ...
  <tr>
	...
	<div style="padding-left:5px; padding-top:5px; padding-right:80px; padding-bottom:5px;">
	  <div align="right">(si usa cheque(s) agregar en &quot;Concepto&quot;  numero(s) y  valor(es) individual(es)) </div>
	</div>	</td>
  </tr>
  <tr>
    <td bgcolor="#F5F5F5">
...
<td align='center' width='280'><span class='Estilo1'><b>DESCRIPCION</b></span></td>
<td align='center' width='120'><span class='Estilo1'><b>RECONOCIMIENTO</b></span></td>
...
</tr>", $rw["cuenta"], $rw["nombre"], $id_manu_reip, $rw["vr_digitado"]); 
...
</tr>", $rw2["pgcp".$i], $nom_rubro , $rw2["vr_deb_".$i], $rw2["vr_cre_".$i]); 
 }
