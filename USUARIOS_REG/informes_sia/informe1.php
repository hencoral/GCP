...
<br />
<center>
<div align="center" class="Titulotd" style="width:50%;padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">GENERANDO REPORTE DE CATALOGO DE CUENTAS - SIA</div>
</center>
<?php 
include('../config.php');		
...
where (fecha >= '$fecha_aux' and fecha <= '$corte') and cuenta = '$cuenta' order by cuenta asc";
$resultadoxx2a1 = mysql_db_query($database, $sqlxx2a1, $connectionxx);
...
<br />
<center>
<?php print "<a href='catalogo_cuentas2.php' target='_parent'><span class='Estilo5'><font color ='blue'>C&aacute;talogo de cuentas</font></span></a></div>"; ?>
<br  />
</center>
      ...
      <div align="center">
        <div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:150px'>
          <div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
            <div align="center"><a href='index.php' target='_parent'>VOLVER </a> </div>
          </div>
        </div>
      </div>
    </div></td>
