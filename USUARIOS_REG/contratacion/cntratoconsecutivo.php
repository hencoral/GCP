...
$cx = new mysqli($server, $dbuser, $dbpass, $database) or die ("Fallo en la Conexion a la Base de Datos");
			$sql2 = "SELECT fec_registro , num_contrato FROM contrataciones2  order by fec_registro, num_contrato asc;";
		   ...
		   // $row = mysql_fetch_array($res);
			 ...
			 {   
     		 ...
     		 { 
               			echo "<tr><td colspan=$columnes><div align='center'><strong>$rows resultados De Contratos </strong></div></font> </td></tr>"; 
              			echo"<tr>";
              		 	echo "<td ><div align='center'><font size='2'> <strong>Fecha</strong></div></font></td>"; 
            			echo "<td ><div align='center'><font size='2'><strong>N. Contrato</strong></div></font></td>";                                                  
                        echo"</tr>";
						...
						{ 
							...
							{		                  
								...
								}else
								{
									...
									echo "<td bgcolor='#CCCCCC'><class='required Estilo4'><font size='2'>$row[1]</font></td>"; 										echo "</tr>"; 
