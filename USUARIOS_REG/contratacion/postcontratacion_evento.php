...
<?php
	...
	{ // primer while
		...
		$fecha_ter 		=$row_contratos["fecha_terminacion"];
...
<tr>
	...
	<td  class="Estilo4">
			...
			<option selected value="ACTA">ACTA</option>
			<option value="DECRETO">DECRETO</option>
			<option value="OTRO">OTRO</option>
			</select>
			<input name="acto" type="text" size="10" class="Estilo4" ><div class="Estilo4" align="center" id='resp'></div>
				</td>
	<td  class="Titulofor">
			FECHA ACTO :	</td>
	<td  class="Estilo4">
			<input name="fecha_acto" type="text" size="12" class="Estilo4">
...
<tr>
	<td  class="Titulofor" >
			DESCRIPCION :	</td>
	<td  class="Estilo4" colspan="3">
			<input name="descripcion" type="text" size="113" class="Estilo4">	</td>
</tr>
...
<tr style="display:<? echo ($ver_adicion); ?> ">
	...
	<td  class="Titulofor">
			VALOR ADICION :	</td>
	<td  class="Estilo4">
			<input name="valor_adicion" type="text" size="20" class="Estilo4" style="text-align:right">	</td>
</tr>
...
<tr style="display:<? echo ($ver_prorroga); ?> ">
	<td  class="Titulofor">
			PLAZO :	</td>
	<td  class="Estilo4">
			<input name="plazo_numero" type="text" size="8" class="Estilo4">	</td>
	<td  class="Titulofor">
			UNIDAD :	</td>
	<td  class="Estilo4">
...
<tr style="display:<? echo ($ver_garantias); ?> ">
	<td  class="Titulofor">
			NUMERO DE POLIZA :	</td>
	<td  class="Estilo4">
			<input name="numero_poliza" type="text" size="20" class="Estilo4">	</td>

	<td  class="Titulofor">
			FECHA DE POLIZA :	</td>
	<td  class="Estilo4">
			<input name="fecha_poliza" type="text" size="12" class="Estilo4">
...
<tr  style="display:<? echo ($ver_garantias); ?> ">	
	...
	<td  class="Estilo4" colspan="3">
			...
			<option value="AS1">ACE SEGUROS S.A</option>
			<option value="AS2">CHARTIS S.A.	</option>
			<option value="AS3">ASEGURADORA COLSEGUROS S.A.</option>
			<option value="AS4">ASEGURADORA SOLIDARIA DE COLOMBIA LTDA. ENTIDAD COOPERATIVA</option>
			<option value="AS5">BBVA SEGUROS COLOMBIA S.A.</option>
			<option value="AS6">CONDOR S.A. COMPA��A DE SEGUROS GENERALES</option>
			<option value="AS7">COMPA��A MUNDIAL DE SEGUROS S.A</option>
			<option value="AS8">SEGUROS GENERALES SURAMERICANA S.A.</option>
			<option value="AS9">CHUBB DE COLOMBIA COMPA��A DE SEGUROS S.A.</option>
			<option value="AS10">GENERALI COLOMBIA SEGUROS GENERALES S.A.</option>
			<option value="AS11">LA PREVISORA S.A. COMPA��A DE SEGUROS</option>
			<option value="AS12">LIBERTY SEGUROS S.A.</option>
			<option value="AS13">SEGUROS ALFA S.A.</option>
			<option value="AS14">SEGUROS DEL ESTADO S.A.</option>
			<option value="AS15">COMPA�IA ASEGURADORA DE FINANZAS S.A. CONFIANZA</option>
			<option value="AS99">OTRA</option>
			</select>	</td>
</tr>
...
<tr style="display:<? echo ($ver_garantias); ?> ">
	<td  class="Titulofor" colspan="2">
			<input name="cr_poliza1" type="checkbox" />
			GARANTIA DE SERIEDAD DE LA OFERTA	</td>
	<td  class="Titulofor" align="center">
			
			<input name="vr_poliza1" type="text" size="15" style="text-align:right">	</td>
	<td  class="Titulofor" align="center">
			<input name="fecha_poliza1_d" type="text" size="12" class="Estilo4">
			...
			<input name="fecha_poliza1_h" type="text" size="12" class="Estilo4">
...
<tr style="display:<? echo ($ver_garantias); ?> ">
	<td  class="Titulofor" colspan="2">
<input name="cr_poliza2" type="checkbox" value="1" />			
CUMPLIMIENTO DEL CONTRATO	</td>
	<td  class="Titulofor" align="center">
			<input name="vr_poliza2" type="text" size="15" style="text-align:right">	</td>
	<td  class="Titulofor" align="center">
			<input name="fecha_poliza2_d" type="text" size="12" class="Estilo4">
			...
			<input name="fecha_poliza2_h" type="text" size="12" class="Estilo4">
...
<tr style="display:<? echo ($ver_garantias); ?> ">
	<td  class="Titulofor" colspan="2">
<input name="cr_poliza3" type="checkbox" value="1" />			
BUEN MANEJO E INVERSI�N DEL ANTICIPO	</td>
	<td  class="Titulofor" align="center">
			<input name="vr_poliza3" type="text" size="15" style="text-align:right">	</td>
	<td  class="Titulofor" align="center">
			<input name="fecha_poliza3_d" type="text" size="12" class="Estilo4">
			...
			<input name="fecha_poliza3_h" type="text" size="12" class="Estilo4">
...
<tr style="display:<? echo ($ver_garantias); ?> ">
	<td  class="Titulofor" colspan="2">
			<input name="cr_poliza4" type="checkbox" value="1" />
			SALARIOS Y PRESTACIONES SOCIALES	</td>
	<td  class="Titulofor" align="center">
			<input name="vr_poliza4" type="text" size="15" style="text-align:right">	</td>
	<td  class="Titulofor" align="center">
			<input name="fecha_poliza4_d" type="text" size="12" class="Estilo4">
			...
			<input name="fecha_poliza4_h" type="text" size="12" class="Estilo4">
...
<tr style="display:<? echo ($ver_garantias); ?> ">
	<td  class="Titulofor" colspan="2">
			<input name="cr_poliza5" type="checkbox" value="1" />
			CALIDAD DEL BIEN O SERVICIO	</td>
	<td  class="Titulofor" align="center">
			<input name="vr_poliza5" type="text" size="15" style="text-align:right">	</td>
	<td  class="Titulofor" align="center">
			<input name="fecha_poliza5_d" type="text" size="12" class="Estilo4">
			...
			<input name="fecha_poliza5_h" type="text" size="12" class="Estilo4">
...
<tr style="display:<? echo ($ver_garantias); ?> ">
	<td  class="Titulofor" colspan="2">
<input name="cr_poliza6" type="checkbox" value="1" />			
ESTABILIDAD DE LA OBRA	</td>
	<td  class="Titulofor" align="center">
			<input name="vr_poliza6" type="text" size="15" style="text-align:right">	</td>
	<td  class="Titulofor" align="center">
			<input name="fecha_poliza6_d" type="text" size="12" class="Estilo4">
			...
			<input name="fecha_poliza6_h" type="text" size="12" class="Estilo4">
...
<tr style="display:<? echo ($ver_garantias); ?> ">
	<td  class="Titulofor" colspan="2">
			<input name="cr_poliza7" type="checkbox" value="1" />
			OTRO AMPARO	</td>
	<td  class="Titulofor" align="center">
			<input name="vr_poliza7" type="text" size="15" style="text-align:right">	</td>
	<td  class="Titulofor" align="center">
			<input name="fecha_poliza7_d" type="text" size="12" class="Estilo4">
			...
			<input name="fecha_poliza7_h" type="text" size="12" class="Estilo4">
...
<tr style="display:<? echo ($ver_garantias); ?> ">
	...
	<td  class="Titulofor" align="left" colspan="2">
			&nbsp;&nbsp;&nbsp;&nbsp;
			<input name="otro_amparo" type="text" size="80" >	</td>
</tr>
...
<tr style="display:<? echo ($ver_interventoria); ?> ">
	...
	<td  class="Estilo4" colspan="3">
			...
			<option value="FINAL">NFORME FINAL</option>
			<option value="OTRO">OTRO</option>
			</select>
...
<tr style="display:<? echo ($ver_liquidacion); ?> ">
	...
	<td  class="Estilo4" colspan="2">
			<input name="fecha_termina" type="text" size="12" class="Estilo4" value="<?php echo $fecha_ter; ?>">
...
<tr>
	<td  class="Titulofor">
			OBSERVACIONES :	</td>
	<td  class="Estilo4" colspan="3">
			<textarea  name="observaciones" cols="115" rows="6" style="font-family:Verdana, Geneva, Arial, Helvetica, sans-serif; font-size: 11px; color: #333333;	line-height:12px;"></textarea>	</td>
</tr>
