...
$press_14=str_replace('.','',$_POST['conta_14']);
	...
	{ 
		 ...
		 if($tot_deb_a != $tot_cre_a)
		 ...
		 else
		  {
				...
				$sq2="select id_recau from recaudo_rica where id_recau ='$id_recau'";
				$rs2=mysql_query($sq2);
					...
					{	  // recibo variables 
						...
						while($row = mysql_fetch_array($resultado)) 
						{
						  ...
						  $nom_rubro = $row["nom_rubro"];
										...
										// inserto nuevo roit
										$sql = "INSERT INTO recaudo_rica ( 
									
										id_emp , id_reip , id_caic , id_recau , fecha_recaudo , des_recaudo , tercero ,
										id_unico_reip, cuenta, nombre, vr_orig_reip, vr_digitado, ter_nat, ter_jur, id_manu_rcgt,ter,tip_ica,cod_ica
									
										) VALUES ( 
													
										'$id_emp' , '$id_reip' , '$id_caic' , '$id_recau' , '$fecha_recaudo' , '$des_recaudo' ,'$tercero' ,
										'$id' , '$cuenta' , '$nom_rubro' , '$vr_orig_reip' , '$valor' , '$ter_nat', '$ter_jur', '$id_manu_rcgt','$ter','$tip_ica','$cod_ica'
					...
					$cuenta = $_POST['cuenta_'.$i];
						...
						while($row = mysql_fetch_array($resultado)) 
						{
						  ...
						  $nom_rubro = $row["nom_rubro"];
										...
										'$press_1','$press_2','$press_3','$press_4','$press_5','$press_6','$press_7','$press_8','$press_9','$press_10','$press_11','$press_12','$press_13','$press_14','$ter',
