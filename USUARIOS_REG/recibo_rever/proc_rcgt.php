...
$id_unico_reip='';
$vr_orig_reip='';
$id_manu_rcgt = 'REIN'.$_POST['id_manu_rcgt']; 
$id_recau = 'REIN'.$consec_recaudo; 
	...
	{ 
		 ...
		 if($tot_deb_a != $tot_cre_a)
		 ...
		 else
		  {
				...
				$sq2="select id_recau from recaudo_rcgt where id_recau ='$id_recau' ";
				$rs2=mysql_query($sq2);
...
cheque_1,cheque_2,cheque_3,cheque_4,cheque_5,cheque_6,cheque_7,cheque_8,cheque_9,cheque_10,cheque_11,cheque_12,cheque_13,cheque_14,cheque_15,cheque_16,cheque_17,cheque_18,cheque_19,cheque_20,
										...
										printf("<br><br><center class ='Estilo4'>REVERSION INSERTADA CON EXITO</center><br /><br />");
...
<input type='hidden' name='nn' value='REIN'>
