...
function validar(e) { 
    ...
    if (tecla==8 || tecla==46 || tecla ==44 || tecla ==45) return true; //Tecla de retroceso (para poder borrar) 
    patron = /\d/; //ver nota 
...
function agregar()
 {
	...
	td = tr.insertCell();
	td.innerHTML = "<div style='padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;'><span class='Estilo4'> <input type='text' size='15' style='text-align:left' id='pgcp"+contLin+"' name='pgcp"+contLin+"' value='' onkeyup='lookup(this.value,"+contLin+");' onkeydown='displaycode(event,id);' > </span></div> <div class='suggestionsBox' id='sugges"+contLin+"' style='display: none; position:absolute; left: 130px;'><img src='images/upArrow.png' style='position: relative; top: -10px; left: 0px;' title='PGCP'> <div class='suggestionList' id='autoSug"+contLin+"' align=left> &nbsp;  </div> </div>";
	
	td = tr.insertCell();
	td.innerHTML = "<input type='text' size='35' style='text-align:left' name='des"+contLin+"' id='des"+contLin+"' value='' readonly >";
	
	td = tr.insertCell();
	td.innerHTML = "<input type='text' size='18' style='text-align:right' name='vr_deb_"+contLin+"' id='vr_deb_" + contLin + "' value=0   onKeyUp='suma_tab();' onkeypress='return validar(event)' onblur='formato(id,value)' onfocus='siespgcp("+contLin+");' onkeydown='displaycode(event,id);' >";
	
	td = tr.insertCell();
	td.innerHTML = "<input type='text' size='18' style='text-align:right' name='vr_cre_" + contLin + "' id='vr_cre_" + contLin + "' value=0  onKeyUp='suma_tab();' onkeypress='return validar(event)' onblur='formato(id,value)' onkeydown='displaycode(event,id);' >";
	td = tr.insertCell();
	td.innerHTML = "<input type='text' size='18' style='text-align:left' name='cheque_"+contLin+"' id='cheque_"+contLin+"' value='' alt='2' onkeydown='displaycode(event,id);'>";
...
$num_filas =1;
$resulta = mysql_query("SHOW TABLE STATUS FROM $database LIKE 'recaudo_rcgt'");
            ...
            <table width="95%" border="0" align="center" id="tablei">
                    ...
                    for ($k=1;$k<=20;$k++)
					{
                      echo "<tr style='display:$ver;' id='inputx$k'>
                            <td align='center' width='55%'><input type='text' name='course_$k' class='Estilo4' id='course_$k' size='70' />
	  ...
	  <div align="center">
        ...
        <div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:150px'>
          <div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
            <div align="center"><a href='../recaudos_tesoreria/recaudos_tesoreria.php?a=REIN&nn=REIN' target='_parent'>VOLVER </a> </div>
          </div>
        </div>
	    </div>
	</div>	</td>
