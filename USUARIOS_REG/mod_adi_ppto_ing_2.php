...
?>
  ...
  <head>
    ...
    <script>
      ...
      function Comprueba() {
        ...
        ajax = objetoAjax();
        //uso del medotod GET
        ajax.open("POST", "comprobadores/consulta_ppto_ing.php");
  ...
  <body onload="Comprueba();">
    <table width="800" border="0" align="center">
      ...
      <tr>
        <td colspan="3">
          <form name="a" method="post" action="proc_mod_adi_ppto_ing.php">
                ...
                <td class="Estilo4" colspan="3">
                  <div align="center">
                    <div align="left" style="padding-left:5px;padding-top:5px;">
                      ...
                      $resultado = $connectionxx->query("SELECT * from adi_ppto_ing where id ='$id' and id_emp = '$idxx'");
                      while ($row = $resultado->fetch_assoc()) {
                        $id_emp = $row["id_emp"];
                        $cod_pptal = $row["cod_pptal"];
                        $fecha_adi = $row["fecha_adi"];
                        $tipo_acto = $row["tipo_acto"];
                        $num_acto = $row["num_acto"];
                        $valor_adi = $row["valor_adi"];
                        $concepto_adi = $row["concepto_adi"];
                      }
                      ?>
                      ...
                      <input name="fecha_cierre" type="hidden" id="fecha_cierre" value="<?php printf($fecha_adi2); ?>" />
                      <input name="id" type="hidden" value="<?php printf($id); ?>" />
                      <input name="nom_rubro" type="hidden" value="<?php printf("$r[nom_rubro]"); ?>" />
                      <strong id="mayor"></strong>
                    </div>
                    <div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:0px;">
                </td>
              ...
              <tr>
                ...
                <td width="245" bgcolor="#F5F5F5">
                  <div id="div2" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                    <div align="left">
                      <input name="fecha_adi" type="text" class="Estilo4" id="fecha_adi" value="<?php echo $fecha_adi; ?>" size="12" />
              ...
              <tr>
                ...
                <td>
                  <div id="div4" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                    <div align="left">
                      <input name="valor_adi" type="text" class="Estilo4" id="valor_adi" onkeypress="return validar(event)" size="30" maxlength="30" style="text-align:right" value="<?php echo $valor_adi; ?>" />
                    </div>
                  </div>
                </td>
                <td width="152">
                  ...
                  <div id="div11" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                    <div align="left">
                      <SELECT name="tipo_acto" class="Estilo4" id="tipo_acto">
                        <?php
                        $tip_acto = array("ORDENANZA", "ACUERDO", "DECRETO", "RESOLUCION", "OTRO TIPO DE ACTO ADMTVO", "NO APLICA");
                        $i = 0;
                        for ($i = 0; $i < 6; $i++) {
                          if ($tipo_acto == $tip_acto[$i]) {
                ...
                <td colspan="2">
                  <div id="div12" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                    <div align="left" class="Estilo4">
                      Numero:
                      <input name="num_acto" type="text" class="Estilo4" id="num_acto" size="30" maxlength="30" onkeyup="a.num_acto.value=a.num_acto.value.toUpperCase();" value="<?php echo $num_acto; ?>" />
                    </div>
                  </div>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td colspan="3">
                  <div id="div8" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
                    <div align="left">
                      <textarea name="concepto_adi" cols="100" rows="5" class="Estilo4" onkeyup="a.concepto_adi.value=a.concepto_adi.value.toUpperCase();"><?php echo $concepto_adi; ?></textarea>
                      <br />
                    </div>
                  </div>
                </td>
