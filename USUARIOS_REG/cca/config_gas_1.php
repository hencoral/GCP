      ...
      <div align="center">
        <div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:150px'>
          <div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
            <div align="center"><a href='gastos.php' target='_parent'>VOLVER </a> </div>
          </div>
        </div>
      </div>
    </div></td>
  ...
  <table width="400" border="1" align="center" class="bordepunteado1">
    ...
    <tr>
      <td colspan="2" bgcolor="#F5F5F5"><div class="Estilo4" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
        <div align="center">
          <input name="Submit2" type="submit" class="Estilo4" value="Aceptar" onclick="this.form.action = 'config_gas_1.php'" style="display: <?php echo $ver_boton; ?>" />
        </div>
      </div></td>
      </tr>
  </table>
...
include('../config.php');				
$cx = new mysqli($server, $dbuser, $dbpass, $database) or die ("Fallo en la Conexion a la Base de Datos");
$sqlxx = "select * from cca_gas where cod_pptal = '$codp' and ctrl ='CAUSACION DEL GASTO'";
$resultadoxx = mysql_db_query($database, $sqlxx, $cx);
while($rowxx = mysql_fetch_array($resultadoxx)) 
{
	...
	<table width="800" border="1" align="center" class="bordepunteado1">
      ...
      <tr>
        <td colspan="4" bgcolor="#DCE9E5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo4"><strong>SELECCIONE CUENTA DEBITO Y CREDITO DEL PGCP QUE SE USARAN EN LA CAUSACION DEL GASTO </strong>
		  <BR />
      ...
      <tr>
		...
		<div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo4"><strong>DEBITO</strong>s</div>
        </div>		</td>
        <td colspan="2" bgcolor="#DCE9E5" >
		<div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
      ...
      <tr>
        <td colspan="4"><div style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:5px;">
          <div align="center">
            <input name="ctrl" type="hidden" value="<? printf("CAUSACION DEL GASTO");?>" />
			<input name="Submit" type="submit" class="Estilo4" value="Guardar Configuracion" onclick="this.form.action = 'config_gas_2.php'" />
          </div>
        </div></td>
        </tr>
    </table>
...
if($var == 'directo')
{
	...
	include('../config.php');				
	$cx = new mysqli($server, $dbuser, $dbpass, $database) or die ("Fallo en la Conexion a la Base de Datos");
	$sqlxx = "select * from cca_gas where cod_pptal = '$codp' and ctrl ='PAGO DIRECTO'";
	$resultadoxx = mysql_db_query($database, $sqlxx, $cx);
	while($rowxx = mysql_fetch_array($resultadoxx)) 
	{
	  $ctrl=$rowxx["ctrl"];
...
(Si esta CONSULTANDO, presione la barra espaciadora en la cuenta para ver el nombre de la misma) 
      ...
      <tr>
        <td colspan="4"><div style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:5px;">
          <div align="center">
            <input name="ctrl" type="hidden" value="<? printf("PAGO DIRECTO");?>" />
			<input name="Submit" type="submit" class="Estilo4" value="Guardar Configuracion" onclick="this.form.action = 'config_gas_2.php'" />
          </div>
        </div></td>
        </tr>
