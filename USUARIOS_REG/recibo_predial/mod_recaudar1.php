...
$sq2= "select * from recaudo_riip where id_recau ='$id' order by id desc";
$rs2= mysql_query($sq2);
$rw2 =mysql_fetch_array($rs2);
$filas =mysql_num_rows($rs2);
$id_manu_rcgt = $rw2['id_manu_rcgt'];
$conta_1 = round($rw2['conta_1']);
$conta_2 =  round($rw2['conta_2']);
$conta_3 =  round($rw2['conta_3']);
$conta_4 =  round($rw2['conta_4']);
$conta_5 =  round($rw2['conta_5']);
$conta_6 = round($rw2['conta_6']);
$conta_7 =  round($rw2['conta_7']);
$conta_8 =  round($rw2['conta_8']);
$conta_9 =  round($rw2['conta_9']);
$conta_10 = round($rw2['conta_10']);
$conta_11 =  round($rw2['conta_11']);
...
var fils = "<?php echo $filas; ?>" ;
 ...
 <br />
 <form name="forma" method="post" id="forma" action="proc_rcgt_mod.php">
	...
	<table width="1000" border="1" align="center" class="bordepunteado1">
      ...
      <tr>
        ...
        <td colspan="2"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
            ...
            <div align="center">
              <input name="fecha_recaudo" type="text" class="required Estilo4" id="fecha_recaudo" value="<? printf("%s",$rw2['fecha_recaudo']);?>" size="12" alt="1" />
        ...
        <td><div style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
          <div align="center">
            ...
            <input name="id_manu_rcgt" type="text" class="required Estilo12" id="id_manu_rcgt" size="20" onkeypress="return validar(event)" style="text-align:center" onkeyup="chk_rcgt();" alt="1" value="<?php echo $id_manu_rcgt; ?>" />
      ...
      <tr>
        ...
        <td colspan="3" bgcolor="#FFFFFF"><div style="padding-left:10px; padding-top:5px; padding-right:0px; padding-bottom:5px;">
          		<input type='text' name='tercero' class='Estilo4' id='tercero' size='70' alt="1" value="<?php echo $rw2['ter']."-".$rw2['tercero']; ?> " /> &nbsp;<a href="../terceros/terceros.php" target="_new">Nuevo</a>
      ...
      <tr>
        ...
        <td colspan="3"><div style="padding-left:10px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
            <div align="center" class="Estilo4">
                  ...
                  <div align="left">
                    <input name="des_recaudo" type="text" class="required Estilo4" id="des_recaudo"  size="110" alt="1" value="<?php echo $rw2['des_recaudo']; ?>" />
                    </div>
            </div></div></td>
      </tr>
        ...
        <td colspan="4" bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:15px;">
            ...
            <table width="65%" border="0" align="center" id="tablei">
                ...
                <tr>
                    ...
                    (id);" onkeyup="totales();" value="<? echo $conta_1; ?>" onfocus="vaciar(id);" ondblclick="formula(id)" alt="1"/></td>
               	...
               	<tr>
                    ...
                    <td><input name="conta_2" id="conta_2" size="18" style='text-align:right' ondblclick="formula(id)" onblur="sumac(id);" onkeyup="totales();" value="<? echo $conta_2; ?>" onfocus="vaciar(id);" alt="1"/></td>
            	...
            	<tr>
                    ...
                    <td><input name="conta_3" id="conta_3" size="18" style='text-align:right' ondblclick="formula(id)" onblur="sumac(id);" onkeyup="totales();" value="<? echo $conta_3; ?>" onfocus="vaciar(id);" alt="1"/></td>
               	...
               	<tr>
                    ...
                    <td><input name="conta_4" id="conta_4" size="18" style='text-align:right' ondblclick="formula(id)" onblur="sumac(id);" onkeyup="totales();" value="<? echo $conta_4; ?>" onfocus="vaciar(id);" alt="1" /></td>
            	...
            	<tr>
                    ...
                    <td><input name="conta_7" id="conta_7" size="18" style='text-align:right' ondblclick="formula(id)" onblur="sumac(id);" onkeyup="totales();" value="<? echo $conta_7; ?>" onfocus="vaciar(id);" alt="1"/></td>
                ...
                <tr>
                    ...
                    <td><input name="conta_6" id="conta_6" size="18" style='text-align:right' ondblclick="formula(id)" onblur="sumac(id);" onkeyup="totales();" value="<? echo $conta_6; ?>" onfocus="vaciar(id);" alt="1"/></td>
                ...
                <tr>
                    ...
                    <td><input name="conta_5" id="conta_5" size="18" style='text-align:right' ondblclick="formula(id)" onblur="sumac(id);" onkeyup="totales();" value="<? echo $conta_5; ?>" onfocus="vaciar(id);" alt="1"/></td>
               	...
               	<tr>
                    ...
                    <td><input name="conta_8" id="conta_8" size="18" style='text-align:right' ondblclick="formula(id)" onblur="sumac(id);" onkeyup="totales();" value="<? echo $conta_8; ?>" onfocus="vaciar(id);" alt="1"/></td>
            	...
            	<tr>
                    ...
                    <td><input name="conta_9" id="conta_9" size="18" style='text-align:right' ondblclick="formula(id)" onblur="sumac(id);" onkeyup="totales();" value="<? echo $conta_9; ?>" onfocus="vaciar(id);" alt="1"/></td>
               	...
               	<tr>
                    ...
                    <td><input name="conta_10" id="conta_10" size="18" style='text-align:right' ondblclick="formula(id)" onblur="sumac(id);" onkeyup="totales();" value="<? echo $conta_10; ?>" onfocus="vaciar(id);" alt="1"/></td>
            	...
            	<tr>
                    ...
                    <td><input name="conta_11" id="conta_11" size="18" style='text-align:right' ondblclick="formula(id)" onblur="sumac(id);" onkeyup="totales();" value="<? echo $conta_11; ?>" onfocus="vaciar(id);" alt="1"/></td>
