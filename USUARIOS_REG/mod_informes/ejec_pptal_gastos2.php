...
//--------	--------------------------------------------------------------------------------------------
?><br />
<span class="Estilo1">EJECUCION PRESUPUESTAL DE GASTOS CON REGISTRO </span></div>
    </div></td>
  </tr>
  <tr>
    <td colspan="3">
	<form name="a" method="post" action="ejec_pptal_gastos3.php">
 <table width="600" border="1" align="center" class="bordepunteado1">
  ...
  <tr>
    <td ><div class="Estilo4" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
      <div align="right">Para consolidar : 
       
      </div>
    </div></td>
    <td>&nbsp;<input name="consolida" id="consolida" type="checkbox" class="Estilo4" value="1" /></td>
  </tr>
