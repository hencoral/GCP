...
<?php
	...
	// modificaciones mes
		...
		</tr>", $rw["cod_pptal"], ucfirst($rw["nom_rubro"]), number_format($inicial,2,'.',','), number_format($total_adi_mes,2,'.',','), number_format($total_adi,2,'.',','),number_format($total_red_mes,2,'.',','),number_format($total_red,2,'.',','), number_format($total_cre_mes,2,'.',','),number_format($total_cre,2,'.',','), number_format($total_ccr_mes,2,'.',','),number_format($total_ccre,2,'.',','), number_format($definitivo,2,'.',','),number_format($total_cdpp_mes,2,'.',','),number_format($total_cdpp,2,'.',','),number_format($total_crpp_mes,2,'.',','),number_format($total_crpp,2,'.',','),number_format($total_cobp_mes,2,'.',','), number_format($total_cobp,2,'.',','),number_format($total_ceva_mes,2,'.',','),number_format($total_ceva,2,'.',','), number_format($saldo_x_ejec,2,'.',','), number_format($reservas,2,'.',','), number_format($cxp,2,'.',','), $rw["tip_dato"], $rw["nivel"]); 
		   }
	printf("</table></center>");
}
...
if ($tipo ==1 && $consolida='1')
	...
	<td align='center' width='75'><span class='Estilo4'><b>Tipo</b></span></td>
	<td align='center' width='75'><span class='Estilo4'><b>Nivel</b></span></td>
	<td align='center' width='75'><span class='Estilo4'><b>Entidad</b></span></td>
	<td align='center' width='75'><span class='Estilo4'><b>Consolida</b></span></td>
	<td align='center' width='75'><span class='Estilo4'><b>Codigo</b></span></td>
	");
	...
	while($rw = $re->fetch_assoc())
	{
		...
		$cod_sia =$rw["cod_sia"];
		$cod_consol =$rw["cod_con"];
		//**** datos para consolidar
		 $color = "bgcolor='#F5F5F5'";
		 $cod_con='';
		if ($tip_dato == 'D')
		{
			if($cod_sia == 'E' || $cod_sia =='T' || $cod_sia =='S' || $cod_sia =='E')
			   {
			   	$con ='NO';
			   }else{
				$con ='SI';
						if ($empresa =='SECRETARIA DE EDUCACION MUNICIPAL' || $empresa =='MUNICIPIO DE IPIALES')
						{
							$cod_con = $cod;
						}
						if ($empresa =='SECRETARIA MUNICIPAL DE SALUD')
						{
							$cod_con = $cod_consol;
						}
			   }
			if($cod_sia =='') $color = "bgcolor='#CC3300'";    	
		}else{
		 $con ='';
		 $color = "bgcolor='#F5F5F5'";	
		}
		// para definir el codigo de consolidacion
	...
	// modificaciones mes
		...
		<td align='center' bgcolor='#F5F5F5'><span class='Estilo4'>%s</span></td>
		<td align='center' bgcolor='#F5F5F5'><span class='Estilo4'>%s</span></td>
		<td align='center' $color><span class='Estilo4' >%s</span></td>
		<td align='left' bgcolor='#F5F5F5' class='text'>%s</td>
		</tr>", $rw["cod_pptal"], ucfirst($rw["nom_rubro"]), number_format($inicial,2,'.',','), number_format($total_adi_mes,2,'.',','), number_format($total_adi,2,'.',','),number_format($total_red_mes,2,'.',','),number_format($total_red,2,'.',','), number_format($total_cre_mes,2,'.',','),number_format($total_cre,2,'.',','), number_format($total_ccr_mes,2,'.',','),number_format($total_ccre,2,'.',','), number_format($definitivo,2,'.',','),number_format($total_cdpp_mes,2,'.',','),number_format($total_cdpp,2,'.',','),number_format($total_crpp_mes,2,'.',','),number_format($total_crpp,2,'.',','),number_format($total_cobp_mes,2,'.',','), number_format($total_cobp,2,'.',','),number_format($total_ceva_mes,2,'.',','),number_format($total_ceva,2,'.',','), number_format($saldo_x_ejec,2,'.',','), number_format($reservas,2,'.',','), number_format($cxp,2,'.',','), $rw["tip_dato"], $rw["nivel"],$empresa,$con,$cod_con); 
		   }
	printf("</table></center>");
...
///      ****************************************************	EJECUCION NORMAL *******************************************************************************************
	...
	</tr>", $rw["cod_pptal"], ucfirst($rw["nom_rubro"]), number_format($inicial,2,'.',','), number_format($total_adi,2,'.',','), number_format($total_red,2,'.',','), number_format($total_cre,2,'.',','), number_format($total_ccre,2,'.',','), number_format($definitivo,2,'.',','), number_format($total_crpp,2,'.',','), number_format($total_cobp,2,'.',','), number_format($total_ceva,2,'.',','), number_format($saldo_x_ejec,2,'.',','), number_format($reservas,2,'.',','), number_format($cxp,2,'.',','), $rw["tip_dato"], $rw["nivel"]); 
	   }
	printf("</table></center>");
	}
...
<tr>
    <td align="center" colspan="10"><font size="4"><b>EJECUCION PRESUPUESTAL DE GASTOS X PERIODO</b></font></td>
</tr>
<tr>
...
<tr>
	<td align="left" colspan="11"><b>FECHA DE INICIO : </b><?php echo $fecha_per; ?></td>
</tr>

<tr>
	<td align="left" colspan="11"><b>FECHA DE CORTE : </b><?php echo $fecha_fin; ?></td>
</tr>
</table>
...
<?php
	...
	while($rw = $re->fetch_assoc())
	{
		...
		<tr>
			...
			<td align='center'><span class='Estilo4'>%s</span></td>
			<td align='center' bgcolor='#F5F5F5'><span class='Estilo4'>%s</span></td>
		</tr>", $rw["cod_pptal"], ucfirst($rw["nom_rubro"]),  number_format($definitivo,2,'.',','), number_format($total_adi_p,2,'.',','), number_format($total_red_p,2,'.',','), number_format($total_cre_p,2,'.',','), number_format($total_ccre_p,2,'.',','),number_format($total_crpp,2,'.',','),number_format($total_cobp,2,'.',','),number_format($total_ceva,2,'.',',') , $rw["tip_dato"], $rw["nivel"]); 
		   }
	printf("</table></center>");
