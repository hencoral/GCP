...
if (!isset($_SESSION["login"])) {
	...
	if ($fecha_reg > $bx or $fecha_reg < $ax) {
		...
		$sq = "INSERT INTO pac_gastos ( 	id_emp , fecha_reg , cod_pptal , nom_rubro , definitivo , meses ,
		...
		$sSQL = "Update car_ppto_gas Set pac='$pac' , afectado_otros='$afectado_otros' Where cod_pptal = '$cod_pptal' and id_emp ='$id_emp'";
		$cx->query($sSQL);
