          ...
          <form name='a' method="post" action="equiv_pptal_ing.php" onsubmit="return confirm('Verifique si todos los datos estan correctos')">
            ...
            <table width="750" border="1" align="center" class="bordepunteado1">
              ...
              <tr class="bordepunteado1">
                <td>
                  <div style="padding-left:5px; padding-top:15px; padding-right:5px; padding-bottom:15px;">
                    <div align="center"> <a href="rep_homologacion_ppto_gas.php"><strong>VER INFORME DE CUENTAS HOMOLOGADAS DEL PRESUPUESTO DE GASTOS </strong></a> </div>
                  </div>

                  <div style="padding-left:5px; padding-top:15px; padding-right:5px; padding-bottom:15px;">
                    <div align="center"> <a href="../sube_homo_gas/upload.php" target="_parent"><strong>CARGAR AL SISTEMA CUENTAS HOMOLOGADAS DEL <br />
                          PRESUPUESTO DE GASTOS USANDO MS Excel &copy; <br />
