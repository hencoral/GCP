...
if (!isset($_SESSION["login"])) {
	...
	if ($fecha_adi > $bx or $fecha_adi < $ax) {
		...
		$sq = "INSERT INTO adi_ppto_gas ( id_emp , cod_pptal , nom_rubro , fecha_adi , ppto_aprob , tipo_acto , num_acto , valor_adi , concepto_adi) VALUES ( '$id_emp' , '$cod_pptal' , '$nom_rubro' , '$fecha_adi' , '$ppto_aprob' , '$tipo_acto' , '$num_acto' , '$valor_adi' , '$concepto_adi')";
