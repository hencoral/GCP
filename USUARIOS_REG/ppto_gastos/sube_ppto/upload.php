  ...
  <div align="center">
    <div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:150px'>
      <div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
        <div align="center"><a href='../ppto_gastos/equiv_pptal_ing_aa.php' target='_parent' class="Estilo2">VOLVER </a> </div>
      </div>
    </div>
  </div>
</div>
...
<div class="Estilo2" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
	...
	1. Descargue la plantilla de MS Excel &copy; presionando el boton izquierdo de su raton ...::: <a href="../ppto_gastos/rep_homologacion_ppto_gas.php"><strong>AQUI</strong></a> :::...	</div>	</td>
  </tr>
  <tr>
    <td>
	<div class="Estilo2" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
  ...
  <tr>
   ...
   <div align="center">
    ...
    <br>-->
     ...
     <br />
	 <span class="Estilo2"><em>Nombre del archivo: homologacion_gastos.csv<br />
