	...
	<table width="100%" border="1" align="center" class="bordepunteado1">
      ...
      <tr>
       <td ><div id="div5" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:5px;">
        ...
        <td  colspan="2"><div id="div6" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
          <div align="center">
		  <?php 
include('../config.php');				
							...
							while ($rw2 = mysql_fetch_array ($re2))
							{
								...
								<tr class="Estilo4">
									...
									<td>
										...
										<?php
										echo "
										<a href=\"mod_red_ppto_ing.php?borrar=$id&fecha_a=$fecha_adi \"><img src=\"../simbolos/modificarblanco.png\" width=\"16px\" border=\"0\" title=\"Modificar\" /></a>
										";
										?>
									</td>
									<td>
