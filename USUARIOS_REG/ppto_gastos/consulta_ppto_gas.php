					...
					<td colspan="3">
						...
						<table width="800" border="0" align="center">
							<tr>
								<td>
									<div align="center">
										<p><span class="Estilo1">MAESTRO PRESUPUESTO DE GASTOS </b></span>
											<br />
											<br />
											<?php
											include('../config.php');
											...
											<tr>
												<td align="left">
													<div style="padding-left:10px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
														<span class="Estilo4">
															1. Si selecciona un <strong>CODIGO PRESUPUESTAL</strong> puede <strong>MODIFICAR</strong> su nombre, procedencia, situacion, inversion. <br />
										...
										<table width="800" border="1" align="center" class="bordepunteado1">
											<tr bgcolor='#DCE9E5'>
												<td colspan="3">
													<div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
														<div align="center" class="Estilo1">Opciones Maestro Presupuesto de Gastos </div>
													</div>
												</td>
											</tr>
											<tr>
...
<table width='1030' BORDER='1' class='bordepunteado1'>
<tr bgcolor='#DCE9E5'>
<td align='center' width='120' class='Estilo1'>Detalle</td>
<td align='center' width='150'><span class='Estilo1'>Fecha Creacion</span></td>
<td align='center' width='100'><span class='Estilo1'>Situacion</span></td>
<td align='center' width='100'><span class='Estilo1'>Vigencia</span></td>
<td align='center' width='100'><span class='Estilo1'>Recurso</span></td>
<td align='center' width='100'><span class='Estilo1'>Vg Futura</span></td>
...
");
											...
											while ($rw = $re->fetch_assoc()) {
												...
												//****
												//****
												$resultax = $cx->query("SELECT SUM(ppto_aprob) AS TOTAL from car_ppto_gas WHERE  tip_dato ='D' and cod_pptal LIKE '$cod%'");
												$rowx = $resultax->fetch_array();
												$inicial = $rowx[0];
												//****
												$resulta = $cx->query("SELECT SUM(valor_adi) AS TOTAL from adi_ppto_gas WHERE cod_pptal LIKE '$cod%'");
												$row = $resulta->fetch_array();
												$total_adi = $row[0];

												$resulta2 = $cx->query("SELECT SUM(valor_adi) AS TOTAL from red_ppto_gas WHERE  cod_pptal LIKE '$cod%'");
												$row2 = $resulta2->fetch_array();
												$total_red = $row2[0];

												$resulta3 = $cx->query("SELECT SUM(valor_adi) AS TOTAL from creditos WHERE  cod_pptal LIKE '$cod%'");
												$row3 = $resulta3->fetch_array();
												$total_cre = $row3[0];

												$resulta4 = $cx->query("SELECT SUM(valor_adi) AS TOTAL from contracreditos WHERE  cod_pptal LIKE '$cod%'");
												$row4 = $resulta4->fetch_array();
												$total_ccre = $row4[0];

												$definitivo = $inicial + $total_adi - $total_red + $total_cre - $total_ccre;
												$ver2 = '';
												if ($rw["vigencia"] == 'ANTERIOR') $ver2 = 'bgcolor=#93FF93';
												$ver3 = '';
...
<td align='center'>
<span class='Estilo4'>
<a href=\"ver_mas.php?vr=%s\" target=\"_blank\" onClick=\"window.open(this.href, this.target, 'width=900,height=640,scrollbars=yes'); return false;\">Ver Mas</a>
</span>
</td>

<td align='center'><span class='Estilo4'> %s </span></td>
<td align='center' $ver3><span class='Estilo4'> %s </span></td>
<td align='center' $ver2><span class='Estilo4'> %s </span></td>
<td align='center' $ver4><span class='Estilo4'> %s </span></td>
<td align='center' $ver5><span class='Estilo4'> %s </span></td>
<td align='left' $ver><span class='Estilo4'><a href=\"modi_nombre_cuenta.php?id=%s\"> %s </a></span></td>
