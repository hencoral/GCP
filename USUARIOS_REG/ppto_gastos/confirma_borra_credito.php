...
?>
	...
	$sqlxx = "SELECT * from creditos where id ='$id' and id_emp ='$idxx'";
...
<div align='center'><a href='creditos.php' target='_parent'>VOLVER</a>
		...
		case (2):
			...
			$re = $vr - $h;
			$sql = "UPDATE car_ppto_gas set definitivo = '$re', afectado_otros = '0', $afectado_otros = '0' where cod_pptal ='$codigo' and id_emp ='$idxx'";
...
<div align='center'><a href='creditos.php' target='_parent'>VOLVER</a>
		...
		case (4):
			...
			$re = $vr - $h;
			$sql = "UPDATE car_ppto_gas set definitivo = '$re', afectado_otros = '0' where cod_pptal ='$codigo' and id_emp ='$idxx'";
			$res = $connection->query($sql);
			// actualizo el valor de todos los padres
...
<div align='center'><a href='creditos.php' target='_parent'>VOLVER</a>
	...
	$sSQL = "Delete From creditos Where id='$id' and id_emp ='$idxx'";
	$cx->query($sSQL);

	printf("
<center class='Estilo4'><br><br><b>CREDITO ELIMINADO CON EXITO</B><br><br>
<div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:150px'>
<div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
<div align='center'><a href='creditos.php' target='_parent'>VOLVER</a>
</div>
