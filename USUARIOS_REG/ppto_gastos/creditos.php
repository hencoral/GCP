...
?>
	...
	<body>
		<table width="70%" border="0" align="center">
			...
			<tr>
				<td colspan="3">
					<form name="a" method="post" action="creditos_2.php">
							...
							<tr>
								<td colspan="3">
									<div id="div6" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
										<div align="center">
											<input name="Submit" type="submit" class="Estilo4" value="Nuevo Cr&eacute;dito" />
										</div>
									</div>
								</td>
							</tr>
					...
					<table width="100%" border="0" align="center">
						<tr>
							<td colspan="3" bgcolor="#FFFFFF">
								<div style='padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;'>
									<div align="center" class="Estilo4"><strong>CREDITOS HASTA LA FECHA</strong> </div>
								</div>
							</td>
						</tr>
					</table>
		...
		$sq = "SELECT fecha_adi, tipo_acto, num_acto,concepto_adi from creditos  group by tipo_acto,num_acto order by fecha_adi asc ";
		$re = $cx->query($sq);
		...
		?>
			<table width="68%" border="1" align="center" class="bordepunteado1">
				...
				$sq2 = "SELECT * from creditos  where tipo_acto = '$doc' and num_acto ='$acuerdo'";
				$re2 = $cx->query($sq2);
				...
				?>
					...
					<tr class="Estilo4">
						...
						<td>
							<?php
							echo "
										<a href=\"mod_credito_2.php?editar=$id&fecha_a=$fecha_adi&cod=$cod_pptal \"><img src=\"../simbolos/modificarblanco.png\" width=\"16px\" border=\"0\" title=\"Modificar\" /></a>
										";
							?>
						</td>
						<td>
							<?php
							echo "
										<a href=\"borra_credito.php?borrar=$id&fecha_a=$fecha_adi \"><img src=\"../simbolos/eliminarblanco.png\" width=\"16px\" border=\"0\" alt=\"Modificar\" /></a>
										";
							?>
						</td>
					</tr>
				...
				$sq3 = "SELECT sum(valor_adi) as valor from creditos  where tipo_acto = '$doc' and num_acto ='$acuerdo'";
				$re3 = $cx->query($sq3);
