...
?>
  ...
  <head>
    ...
    <script>
      ...
      function verificaSaldo() {
        ...
        var pos_url = 'comprobadores/comprueba_def2.php';
  ...
  <body onload="verificaSaldo()">
    ...
    <table width="800" border="0" align="center">
      ...
      <tr>
        <td colspan="3">
          <form name="a" method="post" action="proc_modred_ppto_ing.php" onsubmit="return confirm('Verifique que la Informacion es Correcta')">
              ...
              <tr>
                ...
                <td>
                  <div id="div4" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                    <div align="left">
                      <input name="valor_adi" type="text" class="Estilo4" id="valor_adi" value="<?php printf($valor_adi); ?>" style="text-align:right" onkeypress="return validar(event)" size="30" onblur="ValidaValor()" maxlength="30" />
              ...
              <tr>
                <td colspan="4">
                  <div id="div9" style="padding-left:3px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
                    <div align="center">
                      <input name="Submit" type="submit" class="Estilo4" value="Grabar Reduccion" />
