...
$conexion=mysql_connect ($server, $dbuser, $dbpass);
  ...
  <tr>
    <td colspan="2" bgcolor="#DCE9E5"><div class="Estilo5" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:5px;">
      <div align="center" class="Estilo4"><b>RELACION DE COMPROMISOS </b></div>
    </div></td>
  </tr>
  ...
  <tr>
    <td colspan="2"><div class="Estilo4" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
      <div align="center">
        <div align="center">
            <input name="Submit322" type="submit" class="Estilo4"  value="Generar Reporte" onclick="this.form.action = 'relacion_compromisos.php'" />
          </div>
      </div>
    </div></td>
  </tr>
