...
if (!isset($_SESSION["login"])) {
	...
	$sqlxx = "SELECT * from contracreditos where id ='$id' and id_emp ='$idxx'";
...
<div align='center'><a href='contracredito.php' target='_parent'>VOLVER</a>
	...
	$sSQL = "DELETE From contracreditos Where id='$id' and id_emp ='$idxx'";
	$cx->query($sSQL);

	printf("
<center class='Estilo4'><br><br><b>CONTRACREDITO ELIMINADO CON EXITO</B><br><br>
<div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:150px'>
<div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
<div align='center'><a href='contracredito.php' target='_parent'>VOLVER</a>
</div>
