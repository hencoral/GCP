			...
			<table width="750" border="0" align="center">
				...
				<tr>
					...
					<td colspan="3">
						...
						<form name="empresa" method="post" action="proc_carga_ppto_gas.php" onsubmit="return confirm('Verifique si todos los datos estan correctos')">
											...
											<tr>
												<td valign="top" bgcolor="#DCE9E5">
													<div style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
														<div align="center"><strong class="Estilo4">PRESUPUESTO DE GASTOS </strong><br />
														</div>
													</div>
												</td>
											</tr>
											...
											<tr>
												<td colspan="3" class="Estilo4" bgcolor='#DCE9E5'>
													<div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
														<CENTER>
															<span class="Estilo4"><strong>CARGAR PRESUPUESTO DE GASTOS </strong></span>
												...
												<td width="454" colspan="2" bgcolor="#EBEBE4" class="Estilo4">
													<div id="main_div" style="padding-left:30px; padding-top:5px; padding-right:3px; padding-bottom:3px;">
														...
														<div align="left">
															...
															<?php $consulta = $connection->query("SELECT * from tmp_cod_pptal");
															while ($row = $consulta->fetch_assoc()) {
																$tmp_cod_pptal = $row["cod"];
															}  ?>

															<input name="cod_pptal" type="text" class="Estilo7" id="cod_pptal" tabindex="0" value="<?php printf('%s', $tmp_cod_pptal); ?>" onkeyup="
var options = this.form.nn.options;for(var i = 0; i < options.length; i++){var match = options[i].value == this.value;if(match)break;}this.form.nn.SELECTedIndex = i;cambia();" size="40" maxlength="35" />
													...
													<div style="padding-left:80px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
														<div align="right" class="Estilo4">
															<div align="left">FUNCIONAMIENTO
																...
																<span class="Estilo33">::::::::::</span> INVERSION
																<input name="opc1" type="radio" value="INVERSION" />
																<span class="Estilo33">::::::::::</span> OPERACION COMERCIAL
																<input name="opc1" type="radio" value="OPERACION_COMERCIAL" />
																<span class="Estilo33">::::::::::</span> SERVICIO DEUDA
											...
											<tr>
												<td colspan="3" bgcolor="#EBEBE4" class="Estilo4">
													<div style="padding-left:80px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
														<div align="right" class="Estilo4">
															<div align="left">VIGENCIA ACTUAL
																<input name="vigencia" type="radio" value="ACTUAL" checked="checked" />
																<span class="Estilo31">::::::::</span> RESERVA
																<input name="vigencia" type="radio" value="ANTERIOR" />
																<span class="Estilo31">::::::::</span> VIGENCIAS FUTURAS
																<input name="vigencia" type="radio" value="FUTURA" />
															</div>
														</div>
													</div>
												</td>
										...
										<table width="750" border="1" align="center" class="bordepunteado1">
											...
											<tr class="bordepunteado1">
												<td width="375" valign="middle">
													<div style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
														<div align="center"><span class="Estilo4">Cargar Presupuesto de Gastos <br />
