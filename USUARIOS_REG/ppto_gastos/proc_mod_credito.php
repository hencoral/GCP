...
if (!isset($_SESSION["login"])) {
	...
	$sql = "SELECT nom_rubro from car_ppto_gas where cod_pptal ='$cod_pptal' ";
	...
	// valido que el credito no sea mayor al definitivo
	...
	if ($fecha_adi > $bx or $fecha_adi < $ax) {
		...
		$sq = "UPDATE creditos Set id_emp='2' , cod_pptal= '$cod_pptal' , nom_rubro='$nom_rubro' , fecha_adi='$fecha_adi' , tipo_acto='$tipo_acto' , num_acto='$num_acto' , valor_adi='$valor_adi' , concepto_adi='$concepto_adi' where id ='$id'";
...
<div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:150px'>
<div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
<div align='center'><a href='creditos.php' target='_parent'>VOLVER</a>
</div>
</div>
</div></center>";
				break;
			...
			case (2):
				...
				$c = $connection->query("SELECT * from car_ppto_gas where cod_pptal ='$codigo' and id_emp ='$idxx'");
				...
				$consultapa = $connection->query("SELECT * from car_ppto_gas where cod_pptal ='$pa' and id_emp ='$idxx'");
...
<div align='center'><a href='creditos.php' target='_parent'>VOLVER</a>
			...
			case (4):
				...
				$consultapb = $connection->query("SELECT * from car_ppto_gas where cod_pptal ='$pb' and id_emp ='$idxx'");
...
<div align='center'><a href='creditos.php' target='_parent'>VOLVER</a>
			...
			case (6):
				...
				$consultapc = $connection->query("SELECT * from car_ppto_gas where cod_pptal ='$pc' and id_emp ='$idxx'");
...
<div align='center'><a href='creditos.php' target='_parent'>VOLVER</a>
			...
			case (8):
				...
				$consultapd = $connection->query("SELECT * from car_ppto_gas where cod_pptal ='$pd' and id_emp ='$idxx'");
...
<div align='center'><a href='creditos.php' target='_parent'>VOLVER</a>
			...
			case (10):
				...
				$consultape = $connection->query("SELECT * from car_ppto_gas where cod_pptal ='$pe' and id_emp ='$idxx'");
...
<div align='center'><a href='creditos.php' target='_parent'>VOLVER</a>
			...
			case (12):
				...
				$consultapf = $connection->query("SELECT * from car_ppto_gas where cod_pptal ='$pf' and id_emp ='$idxx'");
...
<div align='center'><a href='creditos.php' target='_parent'>VOLVER</a>
			...
			case (14):
				...
				$consultapg = $connection->query("SELECT * from car_ppto_gas where cod_pptal ='$pg' and id_emp ='$idxx'");
...
<div align='center'><a href='creditos.php' target='_parent'>VOLVER</a>
			...
			case (16):
				...
				$consultaph = $connection->query("SELECT * from car_ppto_gas where cod_pptal ='$ph' and id_emp ='$idxx'");
...
<div align='center'><a href='creditos.php' target='_parent'>VOLVER</a>
			...
			case (18):
				...
				$consultapi = $connection->query("SELECT * from car_ppto_gas where cod_pptal ='$pi' and id_emp ='$idxx'");
...
<div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:150px'>
<div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
<div align='center'><a href='.php' target='_parent'>VOLVER</a>
</div>
</div>
</div></center>";
				break;
			...
			case (20):
				...
				$consultapj = $connection->query("SELECT * from car_ppto_gas where cod_pptal ='$pj' and id_emp ='$idxx'");
...
<div align='center'><a href='contracredito.php' target='_parent'>VOLVER</a>
			...
			case (22):
				...
				$consultapk = $connection->query("SELECT * from car_ppto_gas where cod_pptal ='$pk' and id_emp ='$idxx'");
...
<div align='center'><a href='creditos.php' target='_parent'>VOLVER</a>
			...
			case (24):
				...
				$consultapl = $connection->query("SELECT * from car_ppto_gas where cod_pptal ='$pl' and id_emp ='$idxx'");
...
<div align='center'><a href='contracredito.php' target='_parent'>VOLVER</a>
			...
			case (26):
				...
				$consultapm = $connection->query("SELECT * from car_ppto_gas where cod_pptal ='$pm' and id_emp ='$idxx'");
...
<div align='center'><a href='creditos.php' target='_parent'>VOLVER</a>
			...
			case (28):
				...
				$consultapn = $connection->query("SELECT * from car_ppto_gas where cod_pptal ='$pn' and id_emp ='$idxx'");
...
<div align='center'><a href='creditos.php' target='_parent'>VOLVER</a>
			...
			case (30):
				...
				$consultapo = $connection->query("SELECT * from car_ppto_gas where cod_pptal ='$po' and id_emp ='$idxx'");
...
<div align='center'><a href='creditos.php' target='_parent'>VOLVER</a>
		...
		printf("<BR><BR><center class='Estilo4'>CREDITO ALMACENADO CON EXITO<br><br>");
