...
*/
?>
<form action="confirma_deshacer_levantamiento.php" method="POST" onSubmit="return confirm('Confirme la Accion')">
<div align="center"><br><br>
<span class="Estilo1">Esta a punto de Deshacer el Levantamiento, esta seguro?  </span>
  <input type="hidden" name="id" value="<?php $id1=$_GET['deshacer']; printf("$id1"); ?>"><br>
  <br>
  <label>
  ...::: 
