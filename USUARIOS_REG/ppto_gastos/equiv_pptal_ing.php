          ...
          <form name='a' method="post" action="proc_equiv_pptal_ing.php" onsubmit="return confirm('Verifique si todos los datos estan correctos')">
                  ...
                  <div class="Estilo4" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                    <div align="center">
                      ...
                      while ($row = $a1->fetch_assoc()) {
                        ...
                        $ca = $row["cod_vigencia"];
                        $cb = $row["cod_ser_deuda"];

                        $cc = $row["vigencia"];
                        $cd = $row["opc1"];

                        $ent_recip = $row["ent_recip"];
                      }

                      ?>

                      <strong>DEFINIR HOMOLOGACION PRESUPUESTAL DE GASTOS </strong>
            ...
            ?>
              <table width="750" border="1" align="center" class="bordepunteado1">
                ...
                <tr>
                  <td bgcolor="#FFFFFF" class="Estilo4">
                    <div class="Estilo4" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                      ...
                      <?php if ($cc == 'ANTERIOR') {
                      ?>
                        <div align="left"><strong>VIGENCIA ANTERIOR (RESERVA)</strong></div>
                    </div>
                  </td>
                </tr>
                <tr>
                  <td bgcolor="#FFFFFF" class="Estilo4">
                    <div class="Estilo4" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                      <div align="left"><b>ACTUALMENTE</b> : <?php printf("%s", $ca); ?></div>
                    </div>
                  </td>
                </tr>
                <tr>
                  <td bgcolor="#FFFFFF" class="Estilo4">
                    <div class="Estilo4" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                      ...
                      <div align="center">
                        ...
                        <select name="vigencia" class="Estilo4" id="vigencia" style="width: 700px;">
                          <option value=""></option>
                          <?php
                          include('../config.php');
                          $query = "SELECT * FROM fut_cod_vig_ant ORDER BY cod";
                          $link = new mysqli($server, $dbuser, $dbpass, $database);
                          $result = $link->query($query);
                          while ($row = $result->fetch_assoc()) {
                            if ($row['cod'] == $ca) {
                ...
                <tr>
                  <td bgcolor="#F5F5F5" class="Estilo4">
                    <div class="Estilo4" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                      <?php if ($cd == 'SERVICIO_DEUDA') {
                      ?>
                        <div align="left"><strong>SERVICIO DE LA DEUDA </strong></div>
                    </div>
                  </td>
                </tr>
                <tr>
                  <td bgcolor="#F5F5F5" class="Estilo4">
                    <div class="Estilo4" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                      <div align="left"><b>ACTUALMENTE </b>: <?php printf("%s", $cb); ?></div>
                    </div>
                  </td>
                </tr>
                <tr>
                  <td bgcolor="#F5F5F5" class="Estilo4">
                    <div class="Estilo4" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                      ...
                      <div align="center">
                        ...
                        <select name="ser_deuda" class="Estilo4" id="ser_deuda" style="width: 700px;">
                          <option value=""></option>
                          <?php
                          include('../config.php');
                          $query = "SELECT * FROM fut_cod_ser_deuda ORDER BY cod";
                          $link = new mysqli($server, $dbuser, $dbpass, $database);
                          $result = $link->query($query);
                          while ($row = $result->fetch_assoc()) {
                            if ($row['cod'] == $cb) {
            ...
            <table width="750" border="1" align="center" class="bordepunteado1">
              ...
              <tr>
                <td>
                  <div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                    <div align="left"><b class="Estilo4">ACTUALMENTE</b> : <span class="Estilo4"><?php printf("%s", $ent_recip); ?></span></div>
                  </div>
                </td>
              </tr>
              <tr>
