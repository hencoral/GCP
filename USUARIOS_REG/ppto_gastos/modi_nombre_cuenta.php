      ...
      <tr>
        <td colspan="3">
          ...
          <table width="800" border="0" align="center">
            <tr>
              <td>
                <div align="center"><span class="Estilo4"><strong>MODIFICA DATOS CUENTA DEL PRESUPUESTO DE GASTOS </strong></span><br />
                  <?php
                  include('../config.php');
                  ...
                  ?>
                  <br />
                  <span class="Estilo4"><strong>...::: OBLIGATORIO :::... </strong>HACE REFERENCIA A SELECCIONAR EL MISMO VALOR O UN NUEVO VALOR PARA LA VARIABLE ALMACENADA, SINO SE HACE ASI, SE ALMACENARA POR DEFECTO LA PRIMERA VARIABLE ENCONTRADA EN LOS MENU DE SELECCION </span>
                </div>
                <BR />
              </td>
            </tr>
              ...
              <td>
                <form name="seg" method="post" action="proc_modi_nombre_cuenta.php" onsubmit="return confirm('Verifique si todos los datos estan correctos')">
                  <table width="750" border="1" align="center" class="bordepunteado1">
                    <tr>
                      <td colspan="2" bgcolor="#FFFFFF" class="Estilo4">
                        ...
                        <div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                          <div align="center"><strong>
                             ...
                             $cx = new mysqli($server, $dbuser, $dbpass, $database);
                              ...
                              $a = $_GET['id'];
                              $a1 = $cx->query("select * from car_ppto_gas where cod_pptal = '$a' and id_emp ='$idxxx'");
                    ...
                    <tr>
                      ...
                      <td class="Estilo4">
                        <div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;"><span class="Estilo8">
            ...
            <select name='proc_rec' class='Estilo4' id='proc_rec'>
		        ...
		        <option value='R'>Regalias</option>
                <option value='S'>SGP</option>
                <option value='C'>Colombia Humanitaria</option>
            ...
            <select name='proc_rec' class='Estilo4' id='proc_rec'>
		        ...
		        <option value='R' selected>Regalias</option>
                <option value='S'>SGP</option>
                <option value='C'>Colombia Humanitaria</option>
                <option value='O'>Otros</option>
	        </select>";
            ...
            <select name='proc_rec' class='Estilo4' id='proc_rec'>
		        <option value='P' >Propio</option>
		        <option value='R' >Regalias</option>
                <option value='S' selected>SGP</option>
                <option value='C'>Colombia Humanitaria</option>
                <option value='O'>Otros</option>
	        </select>";
                          }
            ...
            <select name='proc_rec' class='Estilo4' id='proc_rec'>
		        ...
		        <option value='R' >Regalias</option>
                <option value='S' >SGP</option>
                <option value='C' selected>Colombia Humanitaria</option>
                <option value='O'>Otros</option>
	        </select>";
                          }
                          if ($c2 == 'O') {
                ...
                <option value='O' selected>Otros</option>
                    ...
                    <tr>
                      <td colspan="2" bgcolor="#F5F5F5">
                        <div style="padding-left:80px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                          <div align="right" class="Estilo4">
                            <div align="left">FUNCIONAMIENTO
                              <?php
                              if ($opc1 == 'FUNCIONAMIENTO') {
                              ?>

                                <input name="opc1" type="radio" value="FUNCIONAMIENTO" checked="checked" />
                              <?php
                              } else {
                              ?>
                                <input name="opc1" type="radio" value="FUNCIONAMIENTO" />
                              <?php
                              }
                              ?>

                              <span class="Estilo9">::::::::::</span> INVERSION
                              <?php
                              if ($opc1 == 'INVERSION') {
                              ?>

                                <input name="opc1" type="radio" value="INVERSION" checked="checked" />
                              <?php
                              } else {
                              ?>
                                <input name="opc1" type="radio" value="INVERSION" />
                              <?php
                              }
                              ?>
                              <span class="Estilo9">::::::::::</span> MANTENIMIENTO
                              <?php
                              if ($opc1 == 'MANTENIMIENTO') {
                              ?>

                                <input name="opc1" type="radio" value="MANTENIMIENTO" checked="checked" />
                              <?php
                              } else {
                              ?>
                                <input name="opc1" type="radio" value="MANTENIMIENTO" />
                              <?php
                              }
                              ?>
                    ...
                    <tr>
                      <td colspan="2" bgcolor="#F5F5F5">
                        <div style="padding-left:80px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                          <div align="right" class="Estilo4">
                            <div align="left"> SERVICIO DE LA DEUDA
                              <?php
                              if ($opc1 == 'SERVICIO_DEUDA') {
                              ?>

                                <input name="opc1" type="radio" value="SERVICIO_DEUDA" checked="checked" />
                              <?php
                              } else {
                              ?>
                                <input name="opc1" type="radio" value="SERVICIO_DEUDA" />
                              <?php
                              }
                              ?>


                              <strong>(<em>NO SELECCIONAR SI MARCA VIGENCIA ANTERIOR </em>)</strong>
                            </div>
                          </div>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td colspan="2" bgcolor="#F5F5F5">
                        <div style="padding-left:80px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                          <div align="right" class="Estilo4">
                            <div align="left">VIGENCIA ACTUAL
                              <?php
                              if ($vigencia == 'ACTUAL') {
                              ?>

                                <input name="vigencia" type="radio" value="ACTUAL" checked="checked" />
                              <?php
                              } else {
                              ?>
                                <input name="vigencia" type="radio" value="ACTUAL" />
                              <?php
                              }
                              ?>

                              <span class="Estilo31">::::::::</span> VIGENCIA ANTERIOR
                              <?php
                              if ($vigencia == 'ANTERIOR') {
                              ?>
                                <input name="vigencia" type="radio" value="ANTERIOR" checked="checked" />
                              <?php
                              } else {
                              ?>
                                <input name="vigencia" type="radio" value="ANTERIOR" />
                              <?php
                              }
                              ?>
                            </div>
                    ...
                    <tr>
                      <td colspan="2" bgcolor="#F5F5F5" class="Estilo4">
                        <div style="padding-left:80px; padding-top:4px; padding-right:5px; padding-bottom:5px;">
                          VIGENCIA FUTURA <input name="futura" type="radio" value="SI" />
                        </div>
                      </td>
                    </tr>
                    <tr>
