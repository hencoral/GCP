...
if (!isset($_SESSION["login"])) {
	...
	if ($fecha_adi > $bx or $fecha_adi < $ax) {
		...
		$sq = "UPDATE contracreditos Set id_emp='2' , cod_pptal= '$cod_pptal' , nom_rubro='$nom_rubro' , fecha_adi='$fecha_adi' , tipo_acto='$tipo_acto' , num_acto='$num_acto' , valor_adi='$valor_adi' , concepto_adi='$concepto_adi' where id ='$id'";
