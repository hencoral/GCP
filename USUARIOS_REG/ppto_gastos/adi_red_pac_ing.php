...
?>
  ...
  <body>
    <table width="750" border="0" align="center">
              ...
              <tr>
                <td colspan="2" bgcolor="#DCE9E5" class="Estilo4">
                  <div id="div" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:3px;">
                    <div align="center"><strong>ADICION - REDUCCION P.A.C DE GASTOS </strong></div>
                  </div>
                </td>
              </tr>
              <tr>
                <td colspan="2" class="Estilo4">
                  <div id="div5" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:5px;">
                    <div align="center"><strong>PASO 1. </strong><br />
                      SELECCIONE la cuenta con la que desea TRABAJAR y / o DESEA ACTUALIZAR <br />
                  ...
                  <div id="div6" style="padding-left:3px; padding-top:15px; padding-right:3px; padding-bottom:15px;">
                    <div align="center">
                      <select name="nn" class="Estilo4" style="width: 400px;">
                        ...
                        $strSQL = "SELECT * FROM car_ppto_gas WHERE id_emp = '$idxx' AND pac = 'SI' ORDER BY cod_pptal";
                        $rs = $db->query($strSQL);
      ...
      <tr>
        <td colspan="3">
          <div id="div2" style="padding-left:3px; padding-top:15px; padding-right:3px; padding-bottom:15px;">
            <div align="center"><strong><a href="../pagos_tesoreria/pagos_tesoreria.php" target="_parent">...::: IR A TESORERIA :::...</a> </strong></div>
          </div>
        </td>
      </tr>
      <tr>
