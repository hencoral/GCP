...
?>
	...
	<body>
		...
		$sq = "SELECT fecha_adi, tipo_acto, num_acto,concepto_adi from adi_ppto_gas  group by tipo_acto,num_acto order by fecha_adi asc ";
		$re = $cx->query($sq);
		...
		?>
			<table width="68%" border="1" align="center" class="bordepunteado1">
				...
				$sq2 = "SELECT * from adi_ppto_gas  where tipo_acto = '$doc' and num_acto ='$acuerdo'";
				$re2 = $cx->query($sq2);
				...
				?>
					...
					<tr class="Estilo4">
						...
						<td>
							...
							<?php echo "
										<a href=\"mod_ppto_gas_2.php?editar=$id&fecha_e=$fecha_adi&cod=$cod_pptal\"><img src=\"../simbolos/modificarblanco.png\" width=\"16px\" border=\"0\" title=\"Modificar\" /></a>
										";
							?>
						</td>
						<td>
							<?php
							echo "
										<a href=\"borra_adi_ppto_ing.php?borrar=$id&fecha_a=$fecha_adi \"><img src=\"../simbolos/eliminarblanco.png\" width=\"16px\" border=\"0\" title=\"Eliminar\" /></a>
										";
							?>
						</td>
					</tr>
				...
				$sq3 = "SELECT sum(valor_adi) as valor from adi_ppto_gas  where tipo_acto = '$doc' and num_acto ='$acuerdo'";
				$re3 = $cx->query($sq3);
