    ...
    <table width="800" border="0" align="center">
      ...
      <tr>
        <td colspan="3">
          ...
          <form name="a" method="post" action="con_x_tip2.php">
            <table width="600" border="1" align="center" class="bordepunteado1">
              <tr>
                <td bgcolor="#DCE9E5">
                  <div style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
                    <div align="center" class="Estilo4"><strong>CONSULTA POR TIPO DE DOCUMENTO FUENTE<br />PRESUPUESTO DE GASTOS </strong></div>
                  </div>
                </td>
              </tr>
              <tr>
