...
if (!isset($_SESSION["login"])) {
	...
	$ingresa = isset($_POST['nn']) ? $_POST['nn'] : -1;
	if ($ingresa == -1) {
		echo "<center class='Estilo4'><br><br><b>Codigo Presupuestal</B> ...:::VACIO:::... <B> ES INCORRECTO</b><br><br><B><u>RECUERDE</u></B><br><br>Debe Ingresar la Cuentas por <B>PARES</B> y cada <b>PAR</b> no debe exceder 99<br><br> Verifique nuevamente su informacion<br><br>
	...
	$a1 = $a2 = null;
	$sq = "SELECT * from car_ppto_gas where id_emp = '$idxx' and cod_pptal = '$ingresa'";
...
<div align='center'><a href='eliminar_codigo.php' target='_parent'>VOLVER</a>
			...
			case (2):
				...
				$result = $connection->query("SELECT * from car_ppto_gas where padre ='$padre' and id_emp ='$idxx' ");
				$num_rows = $result->num_rows;
				if ($num_rows > '1') {
				} else {
					$sql2 = "UPDATE car_ppto_gas set afectado='0' where cod_pptal ='$padre' and id_emp ='$idxx'";
...
<div align='center'><a href='eliminar_codigo.php' target='_parent'>VOLVER</a>
		...
		$sSQL = "DELETE from car_ppto_gas Where cod_pptal='$ingresa' and id_emp = '$idxx'";
		$cx->query($sSQL);
