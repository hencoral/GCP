              ...
              <tr>
                <td colspan="2" bgcolor="#DCE9E5" class="Estilo4">
                  <div id="div" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:3px;">
                    <div align="center"><strong>ELIMINAR CUENTA DEL PRESUPUESTO DE GASTOS </strong><br />
                      <br />
                      <strong>Descripcion</strong>: Este proceso consiste en ELIMINAR una cuenta existente, sea MAYOR o DETALLE, que NO haya sido AFECTADA por ningun usuario del Sistema, con el objetivo de corregir errores en la <strong>Carga del Presupuesto de Gastos </strong> o eliminar la cuenta definitivamente.
                    </div>
                  </div>
                </td>
              </tr>
                  ...
                  <div id="div6" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:15px;">
                    <div align="center"><strong>CUENTAS CARGADAS HASTA LA FECHA</strong><br />
                      ...
                      <select name="nn" class="Estilo4" style="width: 400px;">
                        ...
                        $strSQL = "SELECT * FROM car_ppto_gas WHERE id_emp = '$idxx' AND afectado = '0' AND afectado_otros ='0' AND pac ='NO' ORDER BY cod_pptal";
                        $rs = $db->query($strSQL);
