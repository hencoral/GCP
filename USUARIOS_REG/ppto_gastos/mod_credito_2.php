...
?>
  ...
  <head>
    ...
    <script>
      ...
      function ValidaValor() {
        ...
        valor1 = def;
        valor2 = comp;
        valor3 = parseFloat(valor1 - valor2) + parseFloat(vr_adi);
        if (valor3 < valor0) {
          alert("El valor a reducir es mayor al saldo del rubro m�s el valor inicialmente reducido");
          document.a.valor_adi.value = vr_adi;
        }
      }
  ...
  <body onload="cambia();">
    <table width="800" border="0" align="center">
      ...
      <tr>
        <td colspan="3">
          <form name="a" method="post" action="proc_mod_credito.php">
            <table width="750" border="1" align="center" class="bordepunteado1">
              ...
              <tr>
                ...
                <td colspan="3">
                  <div id="div6" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                    <div align="left">
                      <?php
                      $editar = $_GET['editar']; //echo "editar".$editar;
                      $fecha_e = $_GET['fecha_a']; //echo "fecha".$fecha_e;
                      ...
                      $sqlxxx = "SELECT cod_pptal, num_acto,concepto_adi,valor_adi,tipo_acto from creditos where id='$editar'";
              ...
              <tr>
                ...
                <td>
                  <input name="valor_adi" type="text" class="Estilo4" id="valor_adi" value=" <?php printf($valor_adi); ?>" onkeypress="return validar(event)" onchange="ValidaValor()" />
        ...
        <td width="266">
          <div class="Estilo7" id="main_div" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:15px;">
            <div align="center">Desarrollado por <br />
              <a href="http://www.qualisoftsalud.com" target="_blank"><img src="../images/logoqsft2.png" width="150" height="69" border="0" /></a><br /> Derechos Reservados - 2009
            </div>
          </div>
        </td>
      </tr>
