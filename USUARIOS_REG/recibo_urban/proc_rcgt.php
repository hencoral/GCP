...
$id_unico_reip='';
$vr_orig_reip='';
$id_manu_rcgt = 'RIUR'.$_POST['id_manu_rcgt']; 
$id_recau = 'RIUR'.$consec_recaudo; 
	...
	{ 
		 ...
		 if($tot_deb_a != $tot_cre_a)
		 ...
		 else
		  {
				...
				$sq2="select id_recau from recaudo_riur where id_recau ='$id_recau' ";
				$rs2=mysql_query($sq2);
					...
					$cuenta = $_POST['cuenta_'.$i];
						...
						while($row = mysql_fetch_array($resultado)) 
						{
						  ...
						  $nom_rubro = $row["nom_rubro"];
										...
										// inserto nuevo roit
										$sq2 = "INSERT INTO recaudo_riur (id_emp , id_reip , id_caic , id_recau , fecha_recaudo , des_recaudo , tercero ,
										...
										press_1,press_2,press_3,press_4,press_5,press_6,press_7,press_8,press_9,ter,cheque_1,cheque_2,cheque_3,cheque_4,cheque_5,cheque_6,cheque_7,cheque_8,cheque_9,cheque_10,cheque_11,cheque_12,cheque_13,cheque_14,cheque_15,cheque_16,cheque_17,cheque_18,cheque_19,cheque_20
...
<input type='hidden' name='nn' value='RIUR'>
