...
<script>
function chk_rcgt(){
var pos_url = '../comprobadores/comprueba_riur.php';
...
function agregar()
 {
	...
	td = tr.insertCell();
	td.innerHTML = "<input type='text' size='20' style='text-align:right' name='vr_deb_"+contLin+"' id='vr_deb_" + contLin + "' value=0   onKeyUp='suma_tab();' onkeypress='return validar(event)' onkeydown='displaycode(event,id);' onblur='formato(id,value);' >";
...
$resulta = mysql_query("SHOW TABLE STATUS FROM $database LIKE 'recaudo_riur'");
      ...
      <tr>
        ...
        <td colspan="3"><div style="padding-left:10px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
            <div align="center" class="Estilo4">
                  ...
                  <div align="left">
                    <input name="des_recaudo" type="text" class="required Estilo4" id="des_recaudo"  size="110"  />
                    </div>
            </div></div></td>
      </tr>
      ...
      <tr>
        <td colspan="4" bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:15px;">
            ...
            <table width="45%" border="0" align="center" id="tablei">
                ...
                <tr>
                	<td>Uso de suelo</td>
                    <td><input name="conta_1" id="conta_1" size="18" style='text-align:right' onblur="sumac(id);" onkeyup="totales();" value="0" onfocus="vaciar(id);"/></td>
                </tr>
               	<tr>
                	<td>Aprobaci&oacute;n de planos</td>
                    <td><input name="conta_2" id="conta_2" size="18" style='text-align:right' onblur="sumac(id);" onkeyup="totales();" value="0" onfocus="vaciar(id);"/></td>
                </tr>
            	<tr>
                	<td>Estampilla procultura</td>
                    <td><input name="conta_3" id="conta_3" size="18" style='text-align:right' onblur="sumac(id);" onkeyup="totales();" value="0" onfocus="vaciar(id);"/></td>
                </tr>
               	<tr>
                	<td>Linea paramental</td>
                    <td><input name="conta_4" id="conta_4" size="18" style='text-align:right' onblur="sumac(id);" onkeyup="totales();" value="0" onfocus="vaciar(id);"/></td>
                </tr>
            	<tr>
                	<td>Nomenclatura</td>
                    <td><input name="conta_5" id="conta_5" size="18" style='text-align:right' onblur="sumac(id);" onkeyup="totales();" value="0" onfocus="vaciar(id);"/></td>
                </tr>
               	<tr>
                	<td>Cierre de vias</td>
                    <td><input name="conta_6" id="conta_6" size="18" style='text-align:right' onblur="sumac(id);" onkeyup="totales();" value="0" onfocus="vaciar(id);"/></td>
                </tr>
            	<tr>
                	<td>Ocupaci&oacute;n de vias</td>
                    <td><input name="conta_7" id="conta_7" size="18" style='text-align:right' onblur="sumac(id);" onkeyup="totales();" value="0" onfocus="vaciar(id);"/></td>
                </tr>
               	<tr>
                	<td>Rotura de v&iacute;a</td>
                    <td><input name="conta_8" id="conta_8" size="18" style='text-align:right' onblur="sumac(id);" onkeyup="totales();" value="0" onfocus="vaciar(id);"/></td>
                </tr>
            	<tr>
                	<td>Otros</td>
                    <td><input name="conta_9" id="conta_9" size="18" style='text-align:right' onblur="sumac(id);" onkeyup="totales();" value="0" onfocus="vaciar(id);"/></td>
                </tr>
               	<tr>
                	<td><b>TOTAL</b></td>
