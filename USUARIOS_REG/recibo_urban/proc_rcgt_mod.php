	...
	{ 
		 ...
		 if($tot_deb_a != $tot_cre_a)
		 ...
		 else
		  {
				...
				$k =0;
				$sq2="select id,id_recau from recaudo_riur where id_recau ='$id_recau' ";
				$rs2=mysql_query($sq2);
				mysql_num_rows($rs2);
						...
						while($row = mysql_fetch_array($resultado)) 
						{
						  ...
						  $nom_rubro = $row["nom_rubro"];
										...
										$sq3 = "UPDATE  recaudo_riur set 
												...
												where id='$idv2[$k]'
										";
										mysql_query($sq3, $connectionxx) or die(mysql_error());
										$k++;
					} // end for
