...
function agregar()
 {
	...
	td = tr.insertCell();
	td.innerHTML = "<div style='padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;'><span class='Estilo4'> <input type='text' size='20' style='text-align:left' id='pgcp"+contLin+"' name='pgcp"+contLin+"' value='' onkeyup='lookup(this.value,"+contLin+");' onkeydown='displaycode(event,id);' > </span></div> <div class='suggestionsBox' id='sugges"+contLin+"' style='display: none; position:absolute; left: 130px;'><img src='../simbolos/upArrow.png' style='position: relative; top: -10px; left: 0px;' title='PGCP'> <div class='suggestionList' id='autoSug"+contLin+"' align=left> &nbsp;  </div> </div>";
	
	td = tr.insertCell();
	td.innerHTML = "<input type='text' size='50' style='text-align:left' name='des"+contLin+"' id='des"+contLin+"' value='' readonly >";
	
	td = tr.insertCell();
	td.innerHTML = "<input type='text' size='20' style='text-align:right' name='vr_deb_"+contLin+"' id='vr_deb_" + contLin + "' value=0   onKeyUp='suma_tab();' onkeypress='return validar(event)' onkeydown='displaycode(event,id);' onblur='formato(id,value);' onfocus='siespgcp("+contLin+");'>";
	
	td = tr.insertCell();
	td.innerHTML = "<input type='text' size='20' style='text-align:right' name='vr_cre_" + contLin + "' id='vr_cre_" + contLin + "' value=0  onKeyUp='suma_tab();' onkeypress='return validar(event)'  onkeydown='displaycode(event,id);' onblur='formato(id,value);'>";
	td = tr.insertCell();
	td.innerHTML = "<input type='text' size='20' style='text-align:left' name='cheque_"+contLin+"' id='cheque_"+contLin+"' value='' alt='2' onkeydown='displaycode(event,id);'>";
...
{ 
		...
		for (j=1;j<=9;j++)
		{
			var conta =document.getElementById('conta_'+j).value.replace(/\./,'');
			if (conta >0)
			{
			k++;
			agregar();
...
function procesar_reporte()
{
	...
	for (i=1;i<=9;i++)
	{
		if (i==3)
		{
		cult = parseFloat(document.getElementById('conta_'+i).value.replace(/\./g,''));
		}
		datos += parseFloat(document.getElementById('conta_'+i).value.replace(/\./g,''));
	}
	var dif = datos - cult;
	if (dif > 0)
	{
			k++;
			cuentas = cuenta_press(1);
			...
			document.getElementById('valor_'+k).value=formatea(datos-cult);
	...
	if (cult > 0 && dif >0)
	{
			k++;
			mas_inputs();
			cuentas = cuenta_press(3);
			valores = cuentas.split(',');
			document.getElementById('course_'+k).value=valores[0]+ ' - '+ valores[1];
			document.getElementById('valcourse_'+k).value=valores[0];
			document.getElementById('valor_'+k).value=formatea(cult);
	}
...
$sq2= "select * from recaudo_riur where id_recau ='$id' order by id desc";
$rs2= mysql_query($sq2);
...
var fils = "<?php echo $filas; ?>" ;
  ...
  <td colspan="3">
      ...
      <tr>
        ...
        <td colspan="3"><div style="padding-left:10px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
            <div align="center" class="Estilo4">
                  ...
                  <div align="left">
                    <input name="des_recaudo" type="text" class="required Estilo4" id="des_recaudo"  size="110" value="<?php echo $rw2['des_recaudo']; ?> "/>
                    </div>
            </div></div></td>
      </tr>
	...
	<br />
    <table width="800" border="0" align="center" class="bordepunteado1">
      <tr>
      ...
      <tr>
        <td colspan="4" bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:15px;">
            ...
            <table width="45%" border="0" align="center" id="tablei">
                ...
                <tr>
                	<td>Uso de suelo</td>
                    <td><input name="conta_1" id="conta_1" size="18" style='text-align:right' onblur="sumac(id);" onkeyup="totales();" onfocus="vaciar(id);" value="<?php echo number_format($rw2['press_1'],0,',','.'); ?>"/></td>
                </tr>
               	<tr>
                	<td>Aprobaci&oacute;n de planos</td>
                    <td><input name="conta_2" id="conta_2" size="18" style='text-align:right' onblur="sumac(id);" onkeyup="totales();" value="<?php echo number_format($rw2['press_2'],0,',','.'); ?>" onfocus="vaciar(id);"/></td>
                </tr>
            	<tr>
                	<td>Estampilla procultura</td>
                    <td><input name="conta_3" id="conta_3" size="18" style='text-align:right' onblur="sumac(id);" onkeyup="totales();" value="<?php echo number_format($rw2['press_3'],0,',','.'); ?>" onfocus="vaciar(id);"/></td>
                </tr>
               	<tr>
                	<td>Linea paramental</td>
                    <td><input name="conta_4" id="conta_4" size="18" style='text-align:right' onblur="sumac(id);" onkeyup="totales();" value="<?php echo number_format($rw2['press_4'],0,',','.'); ?>" onfocus="vaciar(id);"/></td>
                </tr>
            	<tr>
                	<td>Nomenclatura</td>
                    <td><input name="conta_5" id="conta_5" size="18" style='text-align:right' onblur="sumac(id);" onkeyup="totales();" value="<?php echo number_format($rw2['press_5'],0,',','.'); ?>" onfocus="vaciar(id);"/></td>
                </tr>
               	<tr>
                	<td>Cierre de vias</td>
                    <td><input name="conta_6" id="conta_6" size="18" style='text-align:right' onblur="sumac(id);" onkeyup="totales();" value="<?php echo number_format($rw2['press_6'],0,',','.'); ?>" onfocus="vaciar(id);"/></td>
                </tr>
            	<tr>
                	<td>Ocupaci&oacute;n de vias</td>
                    <td><input name="conta_7" id="conta_7" size="18" style='text-align:right' onblur="sumac(id);" onkeyup="totales();" value="<?php echo number_format($rw2['press_7'],0,',','.'); ?>" onfocus="vaciar(id);"/></td>
                </tr>
               	<tr>
                	<td>Rotura de v&iacute;a</td>
                    <td><input name="conta_8" id="conta_8" size="18" style='text-align:right' onblur="sumac(id);" onkeyup="totales();" value="<?php echo number_format($rw2['press_8'],0,',','.'); ?>" onfocus="vaciar(id);"/></td>
                </tr>
            	<tr>
                	<td>Otros</td>
                    <td><input name="conta_9" id="conta_9" size="18" style='text-align:right' onblur="sumac(id);" onkeyup="totales();" value="<?php echo number_format($rw2['press_9'],0,',','.'); ?>" onfocus="vaciar(id);"/></td>
                </tr>
               	<tr>
                	<td><b>TOTAL</b></td>
               ...
               <tr>
               	<td colspan="2"  align="center"><input name="generar" type="button" value="Porcesar reporte diario" onclick="procesar_reporte();"/> </td>
                </tr>
  ...
  <tr>
    ...
    <table width="800" border="1" id="tablaf" align="center" class="bordepunteado1">   
	  ...
	  <div align="center">
        ...
        <div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:150px'>
          <div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
            <div align="center"><a href='../recaudos_tesoreria/recaudos_tesoreria.php?a=RIUR&nn=RIUR' target='_parent'>VOLVER </a> </div>
          </div>
        </div>
	    </div>
	</div>	</td>
