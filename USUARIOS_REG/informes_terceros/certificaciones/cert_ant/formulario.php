...
<table width='90%'   class='punteado'  cellpadding='3' cellspacing='0' border='0'> 
    <tr  bgcolor='#F4F4F4'>
        ...
        <td width='8%' align="right" onClick="cargaArchivo('conten.php','contenido');"><b><font color="#003399" style="cursor:pointer">X&nbsp;</font></b></td>
    </tr>
</table>
<table width='90%'   class='punteado'  cellpadding='3' cellspacing='0' border='0'> 
    <tr bgcolor="#B4B4B4">
...
while ($rw8 = mysql_fetch_array ($rs8))
{
	...
	// genero el repoprte
	$valor = $rw8['vr_digitado'];
	$archi ="animated_fv.php?id_crpp=$id_crpp&cuenta=$rw8[cuenta]&valor=$valor";
	$div ="emergente";
		echo"<tr>
    	<td  align='left'>$rw8[cuenta]</td>
		<td  align='left'>$nom_rubro_crpp</td>
        <td  align='right' id='crppv$cont_crpp' onMouseOver='cambiaColortr(id);' onMouseOut='cambiaColortr2(id);' style='cursor:pointer;'  onClick='cargaArchivo(\"$archi\",\"$div\");'>$valor_crp</td>
...
while ($rw9 = mysql_fetch_array ($rs9))
{
		...
		// consulto el valor contabilizado si la obligacion no fue enviada directo a tesorer�a
		if ($rw9['tesoreria'] == 'SI')
		{
			$total_deb ='Directo';
		...
		// Consulto el valor pagado de cada obligaci�n
		...
		// C�lculo  el valor de la cuenta por pagar
