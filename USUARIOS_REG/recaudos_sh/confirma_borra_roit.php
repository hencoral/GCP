...
?>
  ...
  <head>
    ...
    <style type="text/css">
      ...
      </style><script language="JavaScript"type="text/javascript"src="javas.js"></script>
  ...
  <body>
    ...
    <div align="center">
      ...
      $sq = "SELECT * from recaudo_ncbt where id_emp = '$idxx' and id_recau='$id_recau' order by id asc ";
      $re = $cx->query($sq);
...
<span class='Estilo4'>
<strong>DATOS DE LA NOTA CREDITO BANCARIA ...::: " . $id_manu_ncbt . " :::...</strong>
</span>
</DIV>
<BR>
</center>
...
<br>
<form method='post' action='borrar_ncbt.php'>
        ...
        <table width="910" border="1" align="center" class="bordepunteado1">
          ...
          <tr>
            <td colspan="3" bgcolor="#F5F5F5">
              ...
              <input name="ter_nat" type="hidden" id="ter_nat" value="LAHS">
              <input name="ter_jur" type="hidden" id="ter_jur" value="LAHS">
            ...
            <td colspan="4">
              <div class="Estilo12" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
                <div align="center"><span class="Estilo8">:::</span>
                  <input name="Submit322" type="submit" class="Estilo12" value="Agregar Imputacion Presupuestal a la Nota Credito Bancaria Actual" onclick="return noVacio4(this.form,this.form.contador.value)" />
                </div>
              </div>
            </td>
          </tr>
