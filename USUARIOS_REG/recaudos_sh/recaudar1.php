  ...
  <head>
    ...
    <script>
      ...
      function consecutivo2() {
        ...
        var pos_url2 = 'consultas/concec_ncbt.php';
        ...
        if (req1) {
          req1.onreadystatechange = function() {
            if (req1.readyState == 4) {
              ...
              concec = elem[0];
              fecha2 = elem[1];
              document.getElementById('id_manu_ncbt').value = concec;
              if (fec != fecha2) {
        ...
        <tr>
          <td colspan="3">
            <div style="padding-left:10px; padding-top:30px; padding-right:10px; padding-bottom:10px;">
              <div align="center" class="Estilo4"><strong>NOTA CREDITO BANCARIA </strong>
                <?php
            ...
            <table width="780" border="1" align="center" class="bordepunteado1">
              ...
              <tr>
                <td colspan="4" bgcolor="#DCE9E5">
                  <div style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
                    <div align="center" class="Estilo4"><strong>INFORMACION REQUERIDA PARA LA NOTA CREDITO BANCARIA </strong></div>
                  </div>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                    <div align="center"> <span class="Estilo4">
                        ...
                        $resulta = $cx->query("SHOW TABLE STATUS FROM $database LIKE 'recaudo_ncbt'");
                        ...
                        <input name="consec_ncbt" type="hidden" id="consec_ncbt" value="<?php printf("%s", $consec_recaudo); ?>" />
                      </span></div>
                  </div>
                </td>
                <td bgcolor="#F5F5F5">
                ...
                <td>
                  <div style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
                    <div align="center">
                      <input name="id_manu_ncbt" type="text" class="required Estilo12" id="id_manu_ncbt" size="20" onkeypress="return validar(event)" style="text-align:center" onkeyup="chk_ncbt();" />
                    ...
                    Arial, Helvetica, sans-serif; font-size: 12px; font-weight: normal; border: #333333 
                     3px solid; background-color: #FAFAFA; color: #000000; display:none;">
                        ...
                        <iframe id="datamain" src="ncbtconsecutivo.php" width="200" height="290" marginwidth="0" marginheight="1" hspace="0" vspace="0" frameborder="0" scrolling="si"> </iframe>
                      </div>
                      <div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              ...
              <tr>
                <td bgcolor="#F5F5F5">
                  <div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                    <div align="center" class="Estilo4">
                      <div align="center"><strong>Fecha de la NCBT </strong></div>
                    </div>
                  </div>
                </td>
                <td colspan="2">
              ...
              <tr>
                <td bgcolor="#F5F5F5">
                  <div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                    <div align="center" class="Estilo4">
                      <div align="right"><strong>Detalle de la NCBT </strong></div>
                    </div>
                  </div>
                </td>
                <td colspan="3">
                ...
                <td colspan="4">
                  <div class="Estilo12" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
                    <div align="center">
                      ...
                      <span class="Estilo8">:::</span>
                      <input name="submit" id="btn2" type="submit" class="Estilo12" value="Guardar Nota Credito Bancaria y Terminar" onclick="return noVacio4(this.form,this.form.contador.value)" />
                    </div>
                  </div>
                </td>
              </tr>
