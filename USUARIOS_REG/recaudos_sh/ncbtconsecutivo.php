...
DO NOT REMOVE BELOW SCRIPT. IT SHOULD ALWAYS APPEAR AT THE VERY END OF YOUR CONTENT-->
	...
	$sql2 = "SELECT fecha_recaudo , id_manu_ncbt FROM recaudo_ncbt order by fecha_recaudo, id_manu_ncbt asc;";
	$res = $cx->query($sql2);
	// $row =$res->fetch_assoc();
	$rows = $res->num_rows;
	echo "<center>";
	...
	if ($rows == 0) {
		...
		echo "<tr><td colspan=$columnes><div align='center'><strong>$rows resultados de  NCBT </strong></div></font> </td></tr>";
		echo "<tr>";
		echo "<td ><div align='center'><font size='2'> <strong>FECHA</strong></div></font></td>";
		echo "<td ><div align='center'><font size='2'><strong>NCBT</strong></div></font></td>";
		echo "</tr>";
