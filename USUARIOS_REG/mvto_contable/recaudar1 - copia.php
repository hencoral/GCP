            ...
            <table width="65%" border="0" align="center" id="tablei">
            	...
            	<tr>
               	...
               	<tr>
                    ...
                    <td><input name="press_6" id="press_6" size="18" style='text-align:right;background:#CCC' disabled="disabled" onblur="sumac(id);" onkeyup="totales();" value="0" onfocus="vaciar(id);"/></td>
                </tr>
            	<tr>
                    ...
                    <td><input name="press_7" id="press_7" size="18" style='text-align:right;background:#CCC' disabled="disabled" onblur="sumac(id);" onkeyup="totales();" value="0" onfocus="vaciar(id);"/></td>
                </tr>
               	<tr>
                    ...
                    <td><input name="press_8" id="press_8" size="18" style='text-align:right; background:#CCC' disabled="disabled" value="0"/></td>
                </tr>
            	<tr>
                    ...
                    <td><input name="press_9" id="press_9" size="18" style='text-align:right' onblur="sumac(id);" onkeyup="totales();" value="0" onfocus="vaciar(id);"/></td>
                </tr>
               	<tr>
                	<td><b>TOTAL</b></td>
    ...
    <tr>
        <td colspan="4"><div class="Estilo12" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
          <div align="center">
            ...
            <span class="Estilo8">:::</span>
            <input name="submit0" type="button"  id="btn2" class="Estilo12"  value="Guardar formulario" onclick="return validaForm(form,'proc_rcgt.php','conten')" />
