...
<table width="800" border="0" align="center">
  ...
  <form name="a" method="post" id="commentForm" action='proc_cesp.php'>
  <tr>
  <td colspan="3">
  ...
  <table width="915" border="1" align="center" class="bordepunteado1">
    ...
    <tr>
      <td colspan="5" bgcolor="#DCE9E5"><div style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
          ...
          <input type="hidden" name='contador' value=<? echo $contis; ?> id="contador">
          <input type="hidden" name='ccnit' value=<? echo $ccnit; ?> id="ccnit"><br>
    ...
    <tr>
      <td colspan="5"><div class="Estilo12" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
        <div align="center">
          <input name="Submit" type="submit" class="Estilo4" value="Grabar COMPRO. DE EGRESO SIN AFEC. PPTAL" onclick="return noVacio3(this.form,this.form.contador.value);" >
        </div>
      </div></td>
    </tr>
    <!--secciones de fila -->
