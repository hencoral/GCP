...
$ter_nat = $_POST['ter_nat'];//printf("ter_nat : %s<br>",$ter_nat);

$ter_jur = $_POST['ter_jur'];//printf("ter_jur : %s<br>",$ter_jur);

$des_ncon = strtoupper($_POST['des_ncon']);//printf("%s<br>",$des_ncon);

$forma_pago = $_POST['forma_pago'];//printf("forma_pago : %s<br>",$forma_pago);
...
$vr_deb_1 =str_replace(',','',$_POST['vr_deb_1'])+0;//printf("vr_deb_1 : %s<br>",$vr_deb_1);

$vr_deb_2 = str_replace(',','',$_POST['vr_deb_2'])+0;//printf("vr_deb_2 : %s<br>",$vr_deb_2);

$vr_deb_3 = str_replace(',','',$_POST['vr_deb_3'])+0;//printf("vr_deb_3 : %s<br>",$vr_deb_3);

$vr_deb_4 = str_replace(',','',$_POST['vr_deb_4'])+0;//printf("vr_deb_4 : %s<br>",$vr_deb_4);

$vr_deb_5 = str_replace(',','',$_POST['vr_deb_5'])+0;//printf("vr_deb_5 : %s<br>",$vr_deb_5);

$vr_deb_6 =str_replace(',','', $_POST['vr_deb_6'])+0;

$vr_deb_7 = str_replace(',','',$_POST['vr_deb_7'])+0;

$vr_deb_8 = str_replace(',','',$_POST['vr_deb_8'])+0;

$vr_deb_9 = str_replace(',','',$_POST['vr_deb_9'])+0;

$vr_deb_10 = str_replace(',','',$_POST['vr_deb_10'])+0;

$vr_deb_11 = str_replace(',','',$_POST['vr_deb_11'])+0;

$vr_deb_12 = str_replace(',','',$_POST['vr_deb_12'])+0;

$vr_deb_13 = str_replace(',','',$_POST['vr_deb_13'])+0;

$vr_deb_14 = str_replace(',','',$_POST['vr_deb_14'])+0;

$vr_deb_15 = str_replace(',','',$_POST['vr_deb_15'])+0;

$vr_deb_16 = str_replace(',','',$_POST['vr_deb_16'])+0;

$vr_deb_17 = str_replace(',','',$_POST['vr_deb_17'])+0;

$vr_deb_18 = str_replace(',','',$_POST['vr_deb_18'])+0;

$vr_deb_19 = str_replace(',','',$_POST['vr_deb_19'])+0;

$vr_deb_20 = str_replace(',','',$_POST['vr_deb_20'])+0;

$vr_deb_21 = str_replace(',','',$_POST['vr_deb_21'])+0;

$vr_deb_22 = str_replace(',','',$_POST['vr_deb_22'])+0;

$vr_deb_23 = str_replace(',','',$_POST['vr_deb_23'])+0;

$vr_deb_24 = str_replace(',','',$_POST['vr_deb_24'])+0;

$vr_deb_25 = str_replace(',','',$_POST['vr_deb_25'])+0;

$vr_deb_26 = str_replace(',','',$_POST['vr_deb_26'])+0;

$vr_deb_27 = str_replace(',','',$_POST['vr_deb_27'])+0;

$vr_deb_28 = str_replace(',','',$_POST['vr_deb_28'])+0;

$vr_deb_29 = str_replace(',','',$_POST['vr_deb_29'])+0;

$vr_deb_30 = str_replace(',','',$_POST['vr_deb_30'])+0;

$vr_deb_31 = str_replace(',','',$_POST['vr_deb_31'])+0;

$vr_deb_32 = str_replace(',','',$_POST['vr_deb_32'])+0;

$vr_deb_33 = str_replace(',','',$_POST['vr_deb_33'])+0;

$vr_deb_34 = str_replace(',','',$_POST['vr_deb_34'])+0;

$vr_deb_35 = str_replace(',','',$_POST['vr_deb_35'])+0;

$vr_deb_36 = str_replace(',','',$_POST['vr_deb_36'])+0;

$vr_deb_37 = str_replace(',','',$_POST['vr_deb_37'])+0;

$vr_deb_38 = str_replace(',','',$_POST['vr_deb_38'])+0;

$vr_deb_39 = str_replace(',','',$_POST['vr_deb_39'])+0;

$vr_deb_40 = str_replace(',','',$_POST['vr_deb_40'])+0;

$vr_deb_41 = str_replace(',','',$_POST['vr_deb_41'])+0;

$vr_deb_42 = str_replace(',','',$_POST['vr_deb_42'])+0;

$vr_deb_43 = str_replace(',','',$_POST['vr_deb_43'])+0;

$vr_deb_44 = str_replace(',','',$_POST['vr_deb_44'])+0;

$vr_deb_45 = str_replace(',','',$_POST['vr_deb_45'])+0;

$vr_deb_46 = str_replace(',','',$_POST['vr_deb_46'])+0;

$vr_deb_47 = str_replace(',','',$_POST['vr_deb_47'])+0;

$vr_deb_48 = str_replace(',','',$_POST['vr_deb_48'])+0;

$vr_deb_49 = str_replace(',','',$_POST['vr_deb_49'])+0;

$vr_deb_50 = str_replace(',','',$_POST['vr_deb_50'])+0;



$vr_cre_1 = str_replace(',','',$_POST['vr_cre_1'])+0;//printf("vr_cre_1 : %s<br>",$vr_cre_1);

$vr_cre_2 = str_replace(',','',$_POST['vr_cre_2'])+0;//printf("vr_cre_2 : %s<br>",$vr_cre_2);

$vr_cre_3 = str_replace(',','',$_POST['vr_cre_3'])+0;//printf("vr_cre_3 : %s<br>",$vr_cre_3);

$vr_cre_4 = str_replace(',','',$_POST['vr_cre_4'])+0;//printf("vr_cre_4 : %s<br>",$vr_cre_4);

$vr_cre_5 = str_replace(',','',$_POST['vr_cre_5'])+0;//printf("vr_cre_5 : %s<br>",$vr_cre_5);

$vr_cre_6 = str_replace(',','',$_POST['vr_cre_6'])+0;

$vr_cre_7 = str_replace(',','',$_POST['vr_cre_7'])+0;

$vr_cre_8 = str_replace(',','',$_POST['vr_cre_8'])+0;

$vr_cre_9 = str_replace(',','',$_POST['vr_cre_9'])+0;

$vr_cre_10 = str_replace(',','',$_POST['vr_cre_10'])+0;

$vr_cre_11 = str_replace(',','',$_POST['vr_cre_11'])+0;

$vr_cre_12 = str_replace(',','',$_POST['vr_cre_12'])+0;

$vr_cre_13 = str_replace(',','',$_POST['vr_cre_13'])+0;

$vr_cre_14 = str_replace(',','',$_POST['vr_cre_14'])+0;

$vr_cre_15 = str_replace(',','',$_POST['vr_cre_15'])+0;

$vr_cre_16 = str_replace(',','',$_POST['vr_cre_16'])+0;

$vr_cre_17 = str_replace(',','',$_POST['vr_cre_17'])+0;

$vr_cre_18 =str_replace(',','', $_POST['vr_cre_18'])+0;

$vr_cre_19 = str_replace(',','',$_POST['vr_cre_19'])+0;

$vr_cre_20 =str_replace(',','', $_POST['vr_cre_20'])+0;

$vr_cre_21 = str_replace(',','',$_POST['vr_cre_21'])+0;

$vr_cre_22 = str_replace(',','',$_POST['vr_cre_22'])+0;

$vr_cre_23 = str_replace(',','',$_POST['vr_cre_23'])+0;

$vr_cre_24 = str_replace(',','',$_POST['vr_cre_24'])+0;

$vr_cre_25 = str_replace(',','',$_POST['vr_cre_25'])+0;

$vr_cre_26 = str_replace(',','',$_POST['vr_cre_26'])+0;

$vr_cre_27 = str_replace(',','',$_POST['vr_cre_27'])+0;

$vr_cre_28 = str_replace(',','',$_POST['vr_cre_28'])+0;

$vr_cre_29 = str_replace(',','',$_POST['vr_cre_29'])+0;

$vr_cre_30 = str_replace(',','',$_POST['vr_cre_30'])+0;

$vr_cre_31 = str_replace(',','',$_POST['vr_cre_31'])+0;

$vr_cre_32 = str_replace(',','',$_POST['vr_cre_32'])+0;

$vr_cre_33 = str_replace(',','',$_POST['vr_cre_33'])+0;

$vr_cre_34 = str_replace(',','',$_POST['vr_cre_34'])+0;

$vr_cre_35 =str_replace(',','', $_POST['vr_cre_35'])+0;

$vr_cre_36 = str_replace(',','',$_POST['vr_cre_36'])+0;

$vr_cre_37 = str_replace(',','',$_POST['vr_cre_37'])+0;

$vr_cre_38 =str_replace(',','',$_POST['vr_cre_38'])+0;

$vr_cre_39 = str_replace(',','',$_POST['vr_cre_39'])+0;

$vr_cre_40 = str_replace(',','',$_POST['vr_cre_40'])+0;

$vr_cre_41 = str_replace(',','',$_POST['vr_cre_41'])+0;

$vr_cre_42 = str_replace(',','',$_POST['vr_cre_42'])+0;

$vr_cre_43 = str_replace(',','',$_POST['vr_cre_43'])+0;

$vr_cre_44 = str_replace(',','',$_POST['vr_cre_44'])+0;

$vr_cre_45 = str_replace(',','',$_POST['vr_cre_45'])+0;

$vr_cre_46 = str_replace(',','',$_POST['vr_cre_46'])+0;

$vr_cre_47 = str_replace(',','',$_POST['vr_cre_47'])+0;

$vr_cre_48 = str_replace(',','',$_POST['vr_cre_48'])+0;

$vr_cre_49 = str_replace(',','',$_POST['vr_cre_49'])+0;

$vr_cre_50 = str_replace(',','',$_POST['vr_cre_50'])+0;
...

{
	...
	{ 
		...
		// VERIFICO EL ID AUTO NO EXISTA
		$sq5 ="select * from conta_cesp where id_auto_ncon ='$id_auto_ncon'";
		$re5 = mysql_db_query($database, $sq5, $connectionxx);
...
pgcp1 , pgcp2 , pgcp3 , pgcp4 , pgcp5 , pgcp6 , pgcp7 , pgcp8 , pgcp9 , pgcp10 , pgcp11 , pgcp12 , pgcp13 , pgcp14 , pgcp15 , pgcp16, pgcp17, pgcp18, pgcp19, pgcp20, pgcp21, pgcp22, pgcp23, pgcp24, pgcp25, pgcp26, pgcp27, pgcp28, pgcp29, pgcp30, pgcp31, pgcp32, pgcp33, pgcp34, pgcp35, pgcp36, pgcp37, pgcp38, pgcp39, pgcp40, pgcp41, pgcp42, pgcp43, pgcp44, pgcp45, pgcp46, pgcp47, pgcp48, pgcp49, pgcp50 ,
				...
				'$cheque_1' , '$cheque_2' , '$cheque_3' , '$cheque_4' , '$cheque_5' , '$cheque_6' , '$cheque_7' , '$cheque_8' , '$cheque_9' , '$cheque_10' , '$cheque_11' , '$cheque_12' , '$cheque_13' , '$cheque_14' , '$cheque_15', '$cheque_16' , '$cheque_17' , '$cheque_18' , '$cheque_19' , '$cheque_20' , '$cheque_21' , '$cheque_22' , '$cheque_23' , '$cheque_24' , '$cheque_25' , '$cheque_26' , '$cheque_27' , '$cheque_28' , '$cheque_29' , '$cheque_30','$cheque_31' , '$cheque_32' , '$cheque_33' , '$cheque_34' , '$cheque_35' , '$cheque_36' , '$cheque_37' , '$cheque_38' , '$cheque_39' , '$cheque_40' , '$cheque_41' , '$cheque_42' , '$cheque_43' , '$cheque_44' , '$cheque_45', '$cheque_46', '$cheque_47','$cheque_48','$cheque_49','$cheque_50',
