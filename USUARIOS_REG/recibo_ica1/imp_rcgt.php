...
$sqlxx = "select * from recaudo_rica1 where id_recau ='$id' and id_emp='$id_emp'";
...
<table width="798" border="1" align="center" class="bordepunteado1">
  <tr>
	...
	<div align="center" class="Estilo16">
	  <h3>RECIBO DE INDUSTRIA Y COMERCIO  </h3> 
	</div>
	</div>	</td>
...
$resulta=mysql_query("select SUM(vr_digitado) AS TOTAL from recaudo_rica1 WHERE id_recau = '$id' AND id_emp='$id_emp'",$link) or die (mysql_error());
...
$sq = "select * from recaudo_rica1 where id_emp = '$id_emp' and id_recau ='$id' order by id asc ";
...
while($rw = mysql_fetch_array($re)) 
   {
	$sq3 ="select nom_rubro from car_ppto_ing where cod_pptal ='$rw[cuenta]'";
	...
	</tr>", $rw["cuenta"], $rw3["nom_rubro"], number_format($xx,2,',','.')); 
	$suma=$suma+$xx;

   }
$suma = number_format($suma,2,',','.');
echo "<tr><td colspan=2 class='Estilo4'><b>&nbsp;Total</b></td>
	<td align='right' class='Estilo4' ><b>$suma &nbsp;</b></td>
</tr>";
...
$sq2 = "select * from recaudo_rica1 where id_emp = '$id_emp' and id_recau ='$id' order by id asc ";
...
<table width="800" border="1" align="center" class="bordepunteado1">
  ...
  <tr>
    <td colspan="4"><div align="center">
      <textarea name="observaciones" cols="40" rows="5" class="Estilo4" id="observaciones" onKeyUp="a.observaciones.value=a.observaciones.value.toUpperCase();" style="border:0px"></textarea>
    </div></td>
  </tr>
  <tr>
    <td>
