...
$resulta = mysql_query("SHOW TABLE STATUS FROM $database LIKE 'recaudo_rica1'");
	...
	{ 
		 ...
		 if($tot_deb_a != $tot_cre_a)
		 ...
		 else
		  {
				...
				$sq2="select id_recau from recaudo_rica1 where id_recau ='$id_recau'";
				$rs2=mysql_query($sq2);
					...
					$cuenta = $_POST['cuenta_'.$i];
						...
						while($row = mysql_fetch_array($resultado)) 
						{
						  ...
						  $nom_rubro = $row["nom_rubro"];
										...
										// inserto nuevo roit
										$sq2 = "INSERT INTO recaudo_rica1 (id_emp , id_reip , id_caic , id_recau , fecha_recaudo , des_recaudo , tercero ,tip_ica,cod_ica,
										...
										'$press_1','$press_2','$press_3','$press_4','$press_5','$press_6','$press_7','$press_8','$press_9','$press_10','$press_11','$press_12','$press_13','$ter',
...
<input type='hidden' name='nn' value='ICA1'>
