	...
	{ 
		 ...
		 if($tot_deb_a != $tot_cre_a)
		 ...
		 else
		  {
				...
				$k=0;
				$sq2="select id,id_recau from recaudo_rica1 where id_recau ='$id_recau' ";
				$rs2=mysql_query($sq2);
