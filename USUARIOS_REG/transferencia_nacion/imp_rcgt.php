...
?>
  ...
  <body>
    ...
    while ($rowxx = $resultadoxx->fetch_assoc()) {
      ...
      $id_manu_rcgt = $rowxx["id_manu_tnat"];
        ...
        <tr>
          ...
          <td colspan="2" bgcolor="#FFFFFF">
            <div class="Estilo4" style="padding-left:15px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
              ...
              $resulta = $link->query("select SUM(vr_digitado) AS TOTAL from recaudo_tnat WHERE id_recau = '$id' AND id_emp='$id_emp'") or die(mysqli_error($link));
...
</tr>", $rw["cuenta"], $rw["nombre"] . 'FF', number_format($xx, 2, ',', '.'));
        }
