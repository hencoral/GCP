		...
		<script type="text/javascript">
						...
						if (req1) {
							req1.onreadystatechange = function() {
								if (req1.readyState == 4) {
									var dato = req1.responseText;
									var elem = dato.split(',');
									document.getElementById("pgcp" + j).value = elem[0];
									document.getElementById("des" + j).value = elem[1];
									document.getElementById("vr_cre_" + j).value = document.getElementById("valor_" + j).value;
			...
			function entrada() {
				...
				for (j = 1; j <= fils; j++) {
					...
					document.getElementById('valor_' + j).value = formatea(parseFloat(cuentas[k + ctrl]));
				}
				var cpgcp = pgcp();
				...
				for (h = 1; h <= f; h++) {
					...
					document.getElementById('vr_deb_' + h).value = formatea(parseFloat(cpgcp2[h + cg]));
					document.getElementById('vr_cre_' + h).value = formatea(parseFloat(cpgcp2[h + cg * 2]));
					...
					<td colspan="3">
						<div style="padding-left:10px; padding-top:30px; padding-right:10px; padding-bottom:10px;">
							<div align="center" class="Estilo4"><strong>RECIBO DE CAJA GENERAL </strong>
								...
								$sq2 = "select * from recaudo_tnat where id_recau ='$id' order by id desc";
								$rs2 = $cx->query($sq2);
								$rw2 = $rs2->fetch_assoc();
								$filas = $rs2->num_rows;
								$id_manu_rcgt = substr($rw2['id_manu_tnat'], 4);
								...
								<input name="consec_ncbt" type="hidden" id="consec_ncbt" value="<?php printf("%s", $id); ?>" />
								...
								<td bgcolor="#F5F5F5">
									<div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
										<div align="center" class="Estilo4">
											<div align="right"><strong>Fecha del TNAT</strong></div>
										</div>
									</div>
								</td>
								<td colspan="2">
									<div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
										...
										<div align="center">
											<input name="fecha_recaudo" type="text" class="required Estilo4" id="fecha_recaudo" value="<?php printf("%s", $rw2['fecha_recaudo']); ?>" size="12" />
							...
							<tr>
								...
								<td colspan="3" bgcolor="#FFFFFF">
									<div style="padding-left:10px; padding-top:5px; padding-right:0px; padding-bottom:5px;">
										...
										<input type='hidden' name='valtercero' id='valtercero' value="<?php echo $rw2['ter']; ?>" />
									</div>
								</td>
							...
							<div align="center">
								...
								<div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:150px'>
									<div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
										<div align="center"><a href='../recaudos_tesoreria/recaudos_tesoreria.php?a=TNAT&nn=TNAT' target='_parent'>VOLVER </a> </div>
									</div>
								</div>
							</div>
						</div>
