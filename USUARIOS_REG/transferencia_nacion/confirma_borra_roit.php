...
// saco el id de la empresa
   $connectionxx = new mysqli($server, $dbuser, $dbpass, $database) or die ("Fallo en la Conexion a la Base de Datos");
	    ...
	    $sqlxxq = "select * from recaudo_rcgt  where id_recau='$id_recau' order by id desc ";
...
$sq = "select * from recaudo_rcgt where id_emp = '$idxx' and id_recau='$id_recau' order by id asc ";
...
<span class='Estilo4'>
<strong>DATOS DEL RECIBO DE CAJA GENERAL ...::: ".$id_manu_ncbt." :::...</strong>
</span>
</DIV>
<BR>
</center>
