				...
				<tr>
					<td colspan="3">
						<div style="padding-left:10px; padding-top:30px; padding-right:10px; padding-bottom:10px;">
							<div align="center" class="Estilo4"><strong>TRANSFERENCIA DE LA NACION / OTRAS TRANSFERENCIAS</strong>
								<?php
								...
								<td colspan="4">
									<div class="Estilo12" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
										<div align="center">
											...
											<span class="Estilo8">:::</span>
											<input name="submit" type="submit" id="btn2" class="Estilo12" value="Guardar Tranasferencia" onclick="return validaForm()" />
										</div>
									</div>
								</td>
							</tr>
