	...
	<body>
		<table width="800" border="0" align="center">
			...
			<tr>
				<td colspan="3">
					...
					<table width="800" border="0" align="center">
						<tr>
							<td>
								<div align="center"><span class="Estilo4"><strong>MODIFICA DATOS CUENTA DEL PRESUPUESTO DE INGRESOS </strong></span><br />
									<?php
									include('config.php');
									...
									<?php
									//-------
									$re2 = $cxx->query("SELECT * from empresa where cod_emp = '$idxxx'");
											...
											<td width="375" bgcolor="#F5F5F5" class="Estilo4">
												<div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
													<div align="center"><strong>
															<?php
															$a = $_GET['id'];
															$result =$cxx->query("SELECT * from car_ppto_ing where cod_pptal = '$a' and id_emp ='$idxxx'");
            ...
            <SELECT name='proc_rec' class='Estilo4' id='proc_rec'>
		        <option value='P' SELECTed>Propios</option>
				<option value='I'>Propios Inversion</option>
												...
												<div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
													<div align="right" class="Estilo4">
														<div align="left">VIGENCIA ACTUAL
															...
															<span class="Estilo31">::::::::</span> RESERVAS
															<?php
															if ($vigencia == 'RESERVA') {
															?>
																<input name="vigencia" type="radio" value="RESERVA" checked="checked" />
															<?php
															} else {
															?>
																<input name="vigencia" type="radio" value="RESERVA" />
															<?php
															}
															?>
														</div>
									...
									<div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
										<div align="center"> <span class="Estilo4">Fecha de esta Sesion:</span> <br />
											<span class="Estilo4"> <strong>
													<?php
													$resultadoxx = $cxx->query("SELECT * from fecha");
