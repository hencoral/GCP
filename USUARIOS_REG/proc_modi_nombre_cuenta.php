...
?>
	...
	$rx = $cxx->query("SELECT tip_dato from car_ppto_ing where id_emp='$idxx' AND cod_pptal ='$cod_pptal'");
	...
	$sSQL = "";
	$cxx->query("UPDATE car_ppto_ing Set nom_rubro='$nombre', proc_rec='$proc_rec', situacion='$situacion',vigencia ='$vigencia' Where cod_pptal = '$cod_pptal' and id_emp ='$idxx'");
