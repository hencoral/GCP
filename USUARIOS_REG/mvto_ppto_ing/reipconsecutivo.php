...
DO NOT REMOVE BELOW SCRIPT. IT SHOULD ALWAYS APPEAR AT THE VERY END OF YOUR CONTENT-->
	...
	$sql2 = "SELECT fecha_reg , id_manu_reip FROM reip_ing order by fecha_reg, id_manu_reip asc;";
	$res = $cx->query($sql2);
	// $row = $res->fetch_assoc();
	...
	if ($rows = $res->num_rows == 0) {
		...
		echo "<tr><td colspan=$columnes><div align='center'><strong>$rows resultados De  REIP </strong></div></font> </td></tr>";
		echo "<tr>";
