...
?>
	...
	<body onload="verificaSaldo()">
		...
		<table width="800" border="0" align="center">
			...
			<tr>
				<td colspan="3">
					<form name="a" method="post" action="proc_modccred_ppto_ing.php" onsubmit="return confirm('Verifique que la Informacion es Correcta')">
							...
							<tr>
								...
								<td class="Estilo4" colspan="3">
									<div align="left" style="padding-left:5px;">
										...
										$sqlxxx = "SELECT cod_pptal, num_acto,concepto_adi,valor_adi,tipo_acto from contracreditos_ing where id='$editar'";
							...
							<tr>
								...
								<td>
									<div id="div4" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
										<div align="left">
											<input name="valor_adi" type="text" class="Estilo4" id="valor_adi" value="<?php printf($valor_adi); ?>" style="text-align:right" onkeypress="return validar(event)" size="30" maxlength="30" onkeyup="validar_saldo();" />
