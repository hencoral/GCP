...
?>
	...
	<body>
		...
		$sq = "SELECT fecha_adi, tipo_acto, num_acto,concepto_adi from creditos_ing  group by tipo_acto,num_acto order by fecha_adi asc ";
		$re = $cx->query($sq);
		...
		?>
			<table width="68%" border="1" align="center" class="bordepunteado1">
				...
				$sq2 = "SELECT * from creditos_ing  where tipo_acto = '$doc' and num_acto ='$acuerdo'";
				$re2 = $cx->query($sq2);
				...
				$sq3 = "SELECT sum(valor_adi) as valor from creditos_ing  where tipo_acto = '$doc' and num_acto ='$acuerdo'";
				$re3 = $cx->query($sq3);
