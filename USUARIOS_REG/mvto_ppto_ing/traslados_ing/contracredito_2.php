              ...
              <tr>
                ...
                <td>
                  <div id="div4" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                    <div align="left">
                      <input name="valor_adi" type="text" class="Estilo4" id="valor_adi" onkeyup="validar_saldo();" onkeypress="return validar(event)" size="30" maxlength="30" style="text-align:right" />
                    </div>
                  </div>
                </td>
                <td width="143">
