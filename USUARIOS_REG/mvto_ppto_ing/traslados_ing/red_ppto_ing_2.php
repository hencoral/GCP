...
?>
  ...
  <head>
    ...
    <script>
        ...
        if (req2) {
          req2.onreadystatechange = function() {
            if (req2.readyState == 4 && (req2.status == 200 || req2.status == 304)) {
              ...
              document.getElementById('saldo_o').value = saldof; // alert(saldof);
              return def;
            }
          }
      ...
      function ValidarForm() {
        ...
        if (valor <= 0) {
          alert("El valor a contracreditar no puede ser \"0\" ");
          document.a.valor_adi.focus();
          return (false);
        }
        if (acto == "") {
  ...
  <body onload="cambia();">
    <table width="800" border="0" align="center">
      ...
      <tr>
        <td colspan="3">
          <form name="a" method="post" id="a" action="proc_red_ppt_ing.php">
            <table width="750" border="1" align="center" class="bordepunteado1">
              <tr>
                <td colspan="4" bgcolor="#DCE9E5">
                  <div style='padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;'>
                    <div align="center" class="Estilo4"><strong>MODIFICACIONES AL PRESUPUESTO DE INGRESOS</strong></div>
                  </div>
                </td>
              </tr>
              <tr>
                  ...
                  <div id="div6" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                    <div align="left">
                      ...
                      <SELECT name="cod_pptal" id="cod_pptal" onchange="cambia()" class="Estilo4" style="width: 400px;" onblur="val_cta_dlle();">
                        ...
                        include('../../config.php');
                        $connectionxx = new mysqli($server, $dbuser, $dbpass, $database) or die("Fallo en la Conexion a la Base de Datos");
                        $sql = "SELECT * FROM car_ppto_ing WHERE id_emp = '$idxx'  ORDER BY cod_pptal";
                        $rs = $connectionxx->query($sql);
                      ...
                      <input name="nom_rubro" type="hidden" id="id_emp" value="<?php printf($rubro); ?>" />
                    </div>
                  </div>
                </td>
              </tr>
              <tr>
                <td width="178" bgcolor="#F5F5F5">
                  <div id="div" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:5px;">
                    <div align="center"><span class="Estilo4"><strong>Fecha de la reducci&oacute;n</strong></span><br />
                    </div>
                  </div>
                </td>
                <td width="245" bgcolor="#F5F5F5">
                  <div id="div2" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                    <div align="left">
                      ...
                      <input name="button" type="button" class="Estilo4" id="button" onclick="displayCalendar(document.a.fecha_adi,'yyyy/mm/dd',this)" value="Seleccionar Fecha" />
              ...
              <tr>
                ...
                <td width="154">
                  <div id="div13" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
                    <div align="center"> <span class="Estilo4"><strong>Presupuesto Reconocido </strong><br />
                        <div id="resp">
              ...
              <tr>
                <td colspan="4">
                  <div id="div9" style="padding-left:3px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
                    <div align="center">
                      <input name="Submit" type="submit" class="Estilo4" value="Grabar Modificación" onClick="return ValidarForm();" />
