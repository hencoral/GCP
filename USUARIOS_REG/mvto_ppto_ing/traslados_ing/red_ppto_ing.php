						...
						<tr>
							<td colspan="3" bgcolor="#DCE9E5">
								<div style='padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;'>
									<div align="center" class="Estilo4"><span class="Estilo41"><strong>MODIFICACIONES AL PRESUPUESTO DE INGRESOS<br />
												<br />
												Reducciones al Presupuesto </strong></span></div>
								</div>
							</td>
						</tr>
						...
						<tr>
							<td colspan="3">
								<div id="div6" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
									<div align="center">
										<input name="Submit" type="submit" class="Estilo4" value="Nueva Reduccion" />
									</div>
								</div>
							</td>
						</tr>
					...
					<table width="100%" border="0" align="center">
						<tr>
							<td colspan="3" bgcolor="#FFFFFF">
								<div style='padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;'>
									<div align="center" class="Estilo4"><strong>REDUCCIONES HASTA LA FECHA</strong> </div>
								</div>
							</td>
						</tr>
					</table>
				...
				?>
					<tr class="Estilo4">
						...
						<td>
							<?php
							echo "
										<a href=\"mod_red_ppto_ing_2.php?editar=$id&fecha_a=$fecha_adi&cod=$cod_pptal \"><img src=\"../../simbolos/modificarblanco.png\" width=\"16px\" border=\"0\" title=\"Modificar\" /></a>
										";
							?>
						</td>
						<td>
