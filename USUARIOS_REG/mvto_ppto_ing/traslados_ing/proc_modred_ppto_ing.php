...
");
		...
		<div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:150px'>
          <div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
			...
			$sq = "UPDATE red_ppto_ing  set id_emp='$id_emp' , cod_pptal='$cod_pptal' , nom_rubro='$nom_rubro' , fecha_adi= '$fecha_adi' , ppto_aprob= '$ppto_aprob' , tipo_acto='$tipo_acto' , num_acto= '$num_acto' , valor_adi='$valor_adi' , concepto_adi='$concepto_adi' where id ='$id'";
