	...
	{ 
		 ...
		 if($tot_deb_a != $tot_cre_a)
		 ...
		 else
		  {
				...
				$sq2="select id_recau from recaudo_rica2 where id_recau ='$id_recau'";
				$rs2=mysql_query($sq2);
					...
					$cuenta = $_POST['cuenta_'.$i];
						...
						while($row = mysql_fetch_array($resultado)) 
						{
						  ...
						  $nom_rubro = $row["nom_rubro"];
										...
										// inserto nuevo roit
										$sq2 = "INSERT INTO recaudo_rica2 (id_emp , id_reip , id_caic , id_recau , fecha_recaudo , des_recaudo , tercero ,tip_ica,cod_ica,
...
<input type='hidden' name='nn' value='ICA3'>
