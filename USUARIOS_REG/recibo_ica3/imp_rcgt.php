...
$sqlxx = "select * from recaudo_rica where id_recau ='$id' and id_emp='$id_emp'";
...
$resulta=mysql_query("select SUM(vr_digitado) AS TOTAL from recaudo_rica WHERE id_recau = '$id' AND id_emp='$id_emp'",$link) or die (mysql_error());
...
$sq = "select * from recaudo_rica where id_emp = '$id_emp' and id_recau ='$id' order by id asc ";
...
$sq2 = "select * from recaudo_rica where id_emp = '$id_emp' and id_recau ='$id' order by id asc ";
