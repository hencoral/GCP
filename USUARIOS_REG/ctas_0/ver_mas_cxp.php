...
//********* consulta si ya esta configurada
	...
	$sqlxx3a = "select * from ctas0_cxp_ok where cod_pptal ='$cuenta'";
	$resultadoxx3a = mysql_db_query($database, $sqlxx3a, $connectionxx);
	
	while($rowxx3a= mysql_fetch_array($resultadoxx3a)) 
	   {
	   
	   $cod_cxp_constia=$rowxx3a["cod_cxp_consti"];
	   $nom_cxp_consti=$rowxx3a["nom_cxp_consti"];
	   
	   $cod_cxp_x_cancelar =$rowxx3a["cod_cxp_x_cancelar"];
	   $nom_cxp_x_cancelar =$rowxx3a["nom_cxp_x_cancelar"];

       } 

//*****************
   
$sqlxx2 = "select * from cxp where cod_pptal ='$cuenta'";
...
?>
<br />
<form name="a" method="post" action="ver_mas_cxp.php">
<table width="600" border="1" align="center" class="bordepunteado1">
  ...
  <tr>
    <td colspan="4" bgcolor="#DCE9E5"><div class="Estilo4" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
      <div align="center">CONFIGURACION DE CUENTAS 0 - CXP </div>
    </div></td>
  </tr>
  <tr>
    <td colspan="4" bgcolor="#DCE9E5"><div class="Estilo4" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
  ...
  <? 
			...
			if (empty($_POST['cod_cxp_consti'])) 
			{
			$cuenta_ver = $cod_cxp_constia;
			}
			else
			{
			$cuenta_ver = $cod_cxp_consti;
			}
					 ...
					 <td><div aling='right' class='Estilo5' style='padding-left:49px; padding-top:3px; padding-right:2px; padding-bottom:3px;'>DIGITE CODIGO CUENTA 0 APROBADO : </div></td>
					  ...
					  <input name='cod_cxp_consti' type='text' class='Estilo5' id='pgcp$i' style='width:120px;' value='$cuenta_ver' onkeyup='lookupcxp(this.value,$i);'>
...
<table width="800" border="1" align="center" class="bordepunteado1">
  <tr>
	...
	if (empty($_POST['cod_cxp_consti'])) 
	{
	$longitud = strlen($cod_cxp_constia);  //print($cod_pptal_ing_apr);
	$variable =$cod_cxp_constia; // print($longitud);
	}else{
	$longitud = strlen($cod_cxp_consti); 
	$variable =$cod_cxp_consti;
	}
...
/*	printf("
	...
	echo $cod_cxp_constia;
	$sqlxx3 = "select * from ctas0_cxp where cod_cxp_consti ='$variable'";
	$resultadoxx3 = mysql_db_query($database, $sqlxx3, $connectionxx);
	
	while($rowxx3= mysql_fetch_array($resultadoxx3)) 
	   {
	   
	   $nom_cxp_consti=$rowxx3["nom_cxp_consti"];
	   
	   $cod_cxp_x_cancelar =$rowxx3["cod_cxp_x_cancelar"];
	   $nom_cxp_x_cancelar =$rowxx3["nom_cxp_x_cancelar"];
	   
	   $cod_cxp_canceladas =$rowxx3["cod_cxp_canceladas"];
	   $nom_cxp_canceladas =$rowxx3["nom_cxp_canceladas"];
	...
	else
	{
       ...
       $nom_cxp_consti='ERROR - LA CUENTA A CONFIGURAR DEBE SER DE NIVEL 4';
	   
	  // $cod_pptal_gas_apr2='ERROR - LA CUENTA A CONFIGURAR DEBE SER DE NIVEL 4';
	   $nom_cxp_x_cancelar='ERROR - LA CUENTA A CONFIGURAR DEBE SER DE NIVEL 4';
	   
	   $nom_cxp_canceladas='ERROR - LA CUENTA A CONFIGURAR DEBE SER DE NIVEL 4';
  ...
  <tr>
    <td width="200" bgcolor="#F5F5F5"><div class="Estilo4" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
        <div align="right">CTA 0 CONSTITUIDA  </div>
    </div></td>
	<?
	if($cod_cxp_consti == '')
	{
	...
	?>
    <td bgcolor="#FFFFFF" width="150"><div class="Estilo5" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;"><? printf("%s",$cod_cxp_constia); ?></div></td>
	<?
	}
	else
	{
	?>
    <td bgcolor="#FFFFFF" width="150"><div class="Estilo5" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;"><? printf("%s",$cod_cxp_consti); ?></div></td>
	<?	
	}
	?>
    <td colspan="2" bgcolor="#F5F5F5" width="450"><div class="Estilo5" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
      <div align="left"><? printf("%s",$nom_cxp_consti); ?></div>
    </div></td>
  </tr>
  <tr>
    <td bgcolor="#F5F5F5"><div class="Estilo4" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
        <div align="right">CTA 0 POR PAGAR : </div>
    </div></td>
    <td bgcolor="#FFFFFF"><div class="Estilo5" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;"><? printf("%s",$cod_cxp_x_cancelar); ?></div></td>
    <td colspan="2" bgcolor="#F5F5F5"><div class="Estilo5" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
        <div align="left"><? printf("%s",$nom_cxp_x_cancelar); ?></div>
    </div></td>
  </tr>
  <tr>
    <td bgcolor="#F5F5F5"><div class="Estilo4" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
      <div align="right">CTA 0 PAGADAS : </div>
    </div></td>
    <td bgcolor="#FFFFFF"><div class="Estilo5" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;"><? printf("%s",$cod_cxp_canceladas); ?></div></td>
    <td colspan="2" bgcolor="#F5F5F5"><div class="Estilo5" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
      <div align="left"><? printf("%s",$nom_cxp_canceladas); ?></div>
    </div></td>
  </tr>
</table>
<br />
<form method="post" name="aa">
	...
	<input type="hidden" name="cod_cxp_consti" value="<? printf("%s",$cod_cxp_consti); ?>" />
	<input type="hidden" name="nom_cxp_consti" value="<? printf("%s",$nom_cxp_consti); ?>" />
	
	<input type="hidden" name="cod_cxp_x_cancelar" value="<? printf("%s",$cod_cxp_x_cancelar); ?>" />
	<input type="hidden" name="nom_cxp_x_cancelar" value="<? printf("%s",$nom_cxp_x_cancelar); ?>" />
	
	<input type="hidden" name="cod_cxp_canceladas" value="<? printf("%s",$cod_cxp_canceladas); ?>" />
	<input type="hidden" name="nom_cxp_canceladas" value="<? printf("%s",$nom_cxp_canceladas); ?>" />
	
	
  <div align="center" class="Estilo4">Paso No 2 -&gt; 
    <input name="Submit2" type="submit" class="Estilo5" value="Guardar Configuracion Cuenta 0" onclick="this.form.action = 'ver_mas_cxp_guardar.php'" /> 
  </div>
</form>
<br />
<form name="aaa">
