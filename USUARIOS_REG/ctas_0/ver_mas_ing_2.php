...
/*	printf("
	...
	$sqlxx3 = "select * from ctas0_ing_ok where cod_pptal ='$cuenta'";
	$resultadoxx3 = mysql_db_query($database, $sqlxx3, $connectionxx);
	
	while($rowxx3= mysql_fetch_array($resultadoxx3)) 
	   {
	   
	   $cod_pptal_ing_apr=$rowxx3["cod_pptal_ing_apr"];
	   $nom_pptal_ing_apr=$rowxx3["nom_pptal_ing_apr"];
	   
	   $cod_pptal_ing_x_eje=$rowxx3["cod_pptal_ing_x_eje"];
	   $nom_pptal_ing_x_eje=$rowxx3["nom_pptal_ing_x_eje"];
	   
	   $cod_pptal_ing_eje=$rowxx3["cod_pptal_ing_eje"];
	   $nom_pptal_ing_eje=$rowxx3["nom_pptal_ing_eje"];
	  
	   $cod_pptal_otros=$rowxx3["cod_pptal_otros"];
	   $nom_pptal_otros=$rowxx3["nom_pptal_otros"];
	   
	   $cod_pptal_no_aforados=$rowxx3["cod_pptal_no_aforados"];
	   $nom_pptal_no_aforados=$rowxx3["nom_pptal_no_aforados"];
  ...
  <tr>
    ...
    <td bgcolor="#FFFFFF"><div class="Estilo5" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;"><? printf("%s",$cod_pptal_ing_apr); ?></div></td>
