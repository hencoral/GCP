...
$usuarios = mysql_query("Select * from ctas0_cxp  where cod_cxp_consti  like '".$_REQUEST['cod']."%'   ",$conexion);
...
{
		$sql2 = "Select * from ctas0_cxp  where cod_cxp_consti  like '".$_REQUEST['cod']."%'";
		$resultado2 = mysql_db_query($database, $sql2, $conexion);
		printf("<center><table>");
		while($row2 = mysql_fetch_array($resultado2)) 
		{
		  $cod_cxp_consti =$row2["cod_cxp_consti"];
		  $nom_cxp_consti =$row2["nom_cxp_consti"];
		   printf("<tr><td align='left'><span class='Estilo5'>%s&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></td>
		               <td align='left'><span class='Estilo5'>%s</span></td></tr>",$cod_cxp_consti,$nom_cxp_consti);
		}
		printf("</center></table>");		
