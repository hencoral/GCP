...
<table width="800" border="0" align="center">
  ...
  <tr>
   ...
   <tr>
  <td colspan="3" align="right"><a href="reporte_cta_0_cxp.php"><font color="#FF0000">VER REPORTE CONFIGURACION </font></a></td>
  </tr>
  <tr>
...
<span class='Estilo4'>
<a href=\"ver_mas_cxp.php?vr=%s\" target=\"_blank\" onClick=\"window.open(this.href, this.target, 'width=900,height=510,scrollbars=yes'); return false;\">Configurar</a>
</span>
</td>",$rw["cod_pptal"]);

	$sql = "select * from ctas0_cxp_ok  where cod_pptal='$cod_pptal' and id_emp='$id'";
	...
	{
	printf("
	<a href=\"ver_mas_cxp_2.php?vr=%s\" target=\"_blank\" onClick=\"window.open(this.href, this.target, 'width=900,height=450,scrollbars=yes'); return false;\">
