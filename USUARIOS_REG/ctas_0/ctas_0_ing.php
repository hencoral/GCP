...
<script>
function chk_cta0(){
var pos_url = 'comprueba_cta_0_ing.php';
...
<table width="800" border="0" align="center">
  ...
  <tr>
  <td colspan="3" align="right"><a href="reporte_cta_0_ing.php"><font color="#FF0000">VER REPORTE CONFIGURACION </font></a></td>
  </tr>
...
<td align='center' width='130'><span class='Estilo4'><b>Consulta</b></span></td>
...
<span class='Estilo4'>
<a href=\"ver_mas_ing.php?vr=%s\" target=\"_blank\" onClick=\"window.open(this.href, this.target, 'width=900,height=480,scrollbars=yes'); return false;\">Configurar</a>
</span>
</td>",$rw["cod_pptal"]);

	$sql = "select * from ctas0_ing_ok  where cod_pptal='$cod_pptal' and id_emp='$id'";
	...
	{
	printf("
	<a href=\"ver_mas_ing_2.php?vr=%s\" target=\"_blank\" onClick=\"window.open(this.href, this.target, 'width=900,height=450,scrollbars=yes'); return false;\">
