...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example" >
   ...
   <?php
   	...
   	while ($datos = mysql_fetch_array($rs))
	{
		...
		<tr class="odd_gradeX" id="opener" onClick="cargaArchivo('USUARIOS_REG/informes_terceros/certificaciones/histo/formulario.php?id=<?php echo $datos['id']; ?>','contenido')" style="cursor:pointer">
