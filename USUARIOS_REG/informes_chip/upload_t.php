...
// ******************* Creo la tabla
  ...
  `ppto_aprob` varchar(200) NOT NULL,
  `sum_adiciones` decimal(10,2) NOT NULL,
  `sum_reducciones` decimal(10,2) NOT NULL,
  `cancelaciones` decimal(10,2) NOT NULL,
  `sum_creditos` decimal(10,2) NOT NULL,
  `sum_contracreditos` decimal(10,2) NOT NULL,
  `sum_aplazamientos` decimal(10,2) NOT NULL, 
  `definitivo` decimal(10,2) NOT NULL,
  `suma_cdpp` decimal(10,2) NOT NULL,
  `reversion_cdpp` decimal(10,2) NOT NULL
