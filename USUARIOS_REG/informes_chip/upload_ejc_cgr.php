...
// ******************* Creo la tabla
  ...
  `ppto_aprob` decimal(30,2) NOT NULL,
  `sum_adiciones` decimal(30,2) NOT NULL,
  `sum_reducciones` decimal(30,2) NOT NULL,
  `cancelaciones` decimal(30,2) NOT NULL,
  `sum_creditos` decimal(30,2) NOT NULL,
  `sum_contracreditos` decimal(30,2) NOT NULL,
  `sum_aplazamientos` decimal(30,2) NOT NULL,
  `sum_desaplazamientos` decimal(30,2) NOT NULL, 
  `definitivo` decimal(30,2) NOT NULL,
  `suma_cdpp` decimal(30,2) NOT NULL,
  `reversion_cdpp` decimal(30,2) NOT NULL,
  `compromisos_ca` decimal(30,2) NOT NULL,
  `compromisos_sa` decimal(30,2) NOT NULL,
  `compromisos_rev` decimal(30,2) NOT NULL,
  `obligaciones` decimal(30,2) NOT NULL,
  `obligaciones_rev` decimal(30,2) NOT NULL,
  `pagos` decimal(30,2) NOT NULL,
  `pagos_rev` decimal(30,2) NOT NULL
...
<table width="60%" border="1" align="center" class="bordepunteado1">
  <tr>
	...
	<div align="center" class="Estilo2 Estilo4">Acumular C.G.R Ejecución de Gastos</div>
	</div>	</td>
  </tr>
  <tr>
    <td>
	<form action="sube_archivo_ejec_cgr.php" method="post" enctype="multipart/form-data">
   <div align="center">
     <input type="hidden" name="MAX_FILE_SIZE" value="1000000">
     <br>
     <span class="Estilo2"><em>Nombre del archivo: <a href="plantilla/CGR_GASTOS_EJEC.csv">CGR_GASTOS_EJEC.csv</a><br />
