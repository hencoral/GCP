...
<div style="padding-left:5px; padding-top:15px; padding-right:5px; padding-bottom:5px;">	
  <div align="center" class="Estilo4"><strong>C.G.R DE INGRESOS </strong></div>
  <br />
...
<br />
<br />
<input name="Submit" type="submit" class="Estilo4" value="Generar Informe" onclick="this.form.action = 'cgr_ingresos_2.php'"  />
</div>
</form>
