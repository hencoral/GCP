...
?>
	...
	<body>
		<table width="70%" border="0" align="center">
			...
			<tr>
				<td colspan="3">
					<form name="a" method="post" action="adi_ppto_ing_2.php">
							...
							<tr>
								<td colspan="3">
									<div id="div6" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
										<div align="center">
											<input name="Submit" type="submit" class="Estilo4" value="Nueva Adici&oacute;n" />
										</div>
									</div>
								</td>
						...
						<tr>
							<td colspan="3" bgcolor="#FFFFFF">
								<div style='padding-left:5px; padding-top:0px; padding-right:5px; padding-bottom:0px;'>
									<div align="center" class="Estilo4"><strong>ADICIONES REALIZADAS AL PRESUPUESTO HASTA LA FECHA</strong> </div>
								</div>
							</td>
						</tr>
					</table>
		...
		$sq = "SELECT fecha_adi, tipo_acto, num_acto,concepto_adi,id from adi_ppto_ing  group by tipo_acto,num_acto order by fecha_adi asc ";
		$re = $cx->query($sq);
		...
		?>
			<table width="68%" border="1" align="center" class="bordepunteado1">
				...
				$re2 = $cx->query("SELECT * from adi_ppto_ing  where tipo_acto = '$doc' and num_acto ='$acuerdo'");

				while ($rw2 = $re2->fetch_array()) {
					$rwDos  = $rw2[2];
					$re4 = $cx->query("SELECT nom_rubro from car_ppto_ing where cod_pptal = '$rwDos'");
					$rw4 = $re4->fetch_array();
					$id = $rw2[0];
					$cod_pptal = $rw2[2];
				...
				?>
					...
					<tr class="Estilo4">
						...
						<td>
							<?php
							echo "
										<a href=\"mod_adi_ppto_ing_2.php?id=$id&fecha=$fecha_adi\"><img src=\"simbolos/modificarblanco.png\" width=\"16px\" border=\"0\" alt=\"Editar\" /></a>
										";
							?>
						</td>
						<td>
							<?php
							echo "
										<a href=\"borra_adi_ppto_ing.php?borrar=$id&fecha_a=$fecha_adi \"><img src=\"simbolos/eliminarblanco.png\" width=\"16px\" border=\"0\" alt=\"Modificar\" /></a>
										";
							?>
						</td>
					</tr>
				...
				$re3 = $cx->query("SELECT sum(valor_adi) as valor from adi_ppto_ing  where tipo_acto = '$doc' and num_acto ='$acuerdo'");
						...
						<div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
							<div align="center"> <span class="Estilo4">Fecha de esta Sesion:</span> <br />
								<span class="Estilo4"> <strong>
										<?php
										$resultadoxx = $cx->query("SELECT * from fecha");
