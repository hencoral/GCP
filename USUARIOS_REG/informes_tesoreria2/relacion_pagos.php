...
while($rw = mysql_fetch_array($re))
{
		...
		$saldo = $rw7['vr_digitado'] - $valor;
				...
				<td align='center' bgcolor='#CCCCCC'>%s</td>
				<td align='center' bgcolor='#CCCCCC'>%s</td>
				</tr>",$rw["fecha_ceva"],$rw1["cuenta"],ucfirst($rw5["nom_rubro"]),$rw["id_manu_ceva"],$rw["tercero"],$rw["ccnit"],ucfirst(ereg_replace("[,;]", "",$rw["des_cobp"])),$valor,$seg_soc,$reten,$otros_des,$neto,$banco,$cunta_ban,$cheque,$rw1['id_manu_cdpp'],$rw1['id_manu_crpp'],$rw7['n_contrato'],$rw7['vr_digitado'],$saldo);
		$banco ='';
		$cunta_ban='';
		$cheque='';
				}else{
				...
				while($rw1 = mysql_fetch_array($re1))
					{
						...
						if ($rw1["pag"] >0)
						{
							...
							printf("
								...
								<td align='center' bgcolor='#CCCCCC'>%s</td>
								<td align='center' bgcolor='#CCCCCC'>%s</td>
								</tr>",$rw["fecha_ceva"],$rw1["cuenta"],ucfirst($rw6["nom_rubro"]),$rw["id_manu_ceva"],$rw["tercero"],$rw["ccnit"],ucfirst(ereg_replace("[,;]", "",$rw["des_ceva"])),$rw1["pag"],$seg_soc2,$reten2,$otros_des2,$neto2,$banco,$cunta_ban,$cheque,$rw1['id_manu_cdpp'],$rw1['id_manu_crpp'],$rw7['n_contrato'],$rw7['vr_digitado'],$saldo);
								$banco ='';
		$cunta_ban='';
		$cheque='';
							}	
