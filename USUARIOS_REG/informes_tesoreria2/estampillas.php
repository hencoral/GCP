...
?>	
  ...
  <tr>
    <td colspan="2"><div class="Estilo4" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
      ...
      <input name="Submit3221" type="submit" class="Estilo4"  value="Generar detallado" 
			onclick="this.form.action = 'estampillas3.php'" />
       <input name="Submit3221" type="submit" class="Estilo4"  value="Generar consolidado" 
			onclick="this.form.action = 'estampillas31.php'" />      
</div>
    </div></td>
  </tr>
