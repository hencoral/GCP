            ...
            <table width="800" border="0" align="center">
                ...
                <tr>
                    <td colspan="3" bgcolor="#FFFFFF">
                        <div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:10px;">
                            <div align="center" class="Estilo4"><strong>RELACION DE PAGOS COMPROBANTES DE EGRESO </strong></div>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td colspan="3">
                        ...
                        ?>
                        <form name="a" method="post" action="retefuente3.php">
                            <table width="600" border="1" align="center" class="bordepunteado1">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <div class="Estilo4" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
                                            <div align="center">
                                                <select name="cuenta" id="cuenta" class="Estilo4">
                                                    <?php
                                                    $sql = "select * from desc_list order by nombre asc";
                                                    $res43 = $cx->query($sql);
                                                    $fil = $res43->num_rows;
                                                    for ($i = 0; $i < $fil; $i++) {
                                                        $r = $res43->fetch_assoc();
                                                        echo "<OPTION value='$r[cuenta]'>$r[nombre]</OPTION>";
                                                    }
                                                    ?>
                                                </select>
                                    ...
                                    <td colspan="2">
                                        <div class="Estilo4" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
                                            <div align="center">
                                                ...
                                                <input name="Submit3221" type="submit" class="Estilo4" value="Generar detallado" onclick="this.form.action = 'estampillas3.php'" />
                                                <input name="Submit3221" type="submit" class="Estilo4" value="Generar consolidado" onclick="this.form.action = 'estampillas31.php'" />
                                            </div>
                                        </div>
                                    </td>
                                </tr>
