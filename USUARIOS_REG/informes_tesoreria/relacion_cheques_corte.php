                                ...
                                <tr>
                                    <td colspan="2" bgcolor="#DCE9E5">
                                        <div class="Estilo5" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:5px;">
                                            <div align="center" class="Estilo4"><b>GENERAR LIBRO RADICADOR DE CHEQUES </b></div>
                                        </div>
                                    </td>
                                </tr>
                                    ...
                                    <td>
                                        <div id="div2" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                                            <div align="center" class="Estilo4">
                                                <input name="fecha_ini" type="text" class="Estilo4" id="fecha_ini" value="<?php printf($ano); ?>" size="12" />
                                        ...
                                        <div class="Estilo4" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
                                            <div align="center">
                                                <div align="center">
                                                    ...
                                                    <input name="Submit322" type="submit" class="Estilo4" value="Generar Reporte" onclick="this.form.action = 'relacion_cheques.php'" />
                                                </div>
                                            </div>
                                        </div>
                                    </td>
