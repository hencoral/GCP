                                ...
                                <tr>
                                    <td colspan="2" bgcolor="#DCE9E5">
                                        <div class="Estilo5" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:5px;">
                                            <div align="center" class="Estilo4"><b>RELACION DE INGRESOS </b></div>
                                        </div>
                                    </td>
                                </tr>
                                        ...
                                        <div class="Estilo4" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
                                            <div align="center">
                                                <select name="cod_ini" class="Estilo4" id="cod_ini" style="width: 400px;">
                                                    ...
                                                    $strSQL = "SELECT * FROM car_ppto_ing ORDER BY cod_pptal asc";
                                                    $rs = $db->query($strSQL);
                                ...
                                <tr>
                                    <td colspan="2">
                                        <div class="Estilo4" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
                                            <div align="center">
                                                <div align="center">
                                                    <input name="Submit322" type="submit" class="Estilo4" value="Reporte General" onclick="this.form.action = 'relacion_ingresos.php'" />
                                                    <input name="Submit322" type="submit" class="Estilo4" value="Reporte por rubro" onclick="this.form.action = 'ingresos_x_rubro.php'" />
                                                </div>
                                            </div>
                                        </div>
                                    </td>
