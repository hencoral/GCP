...
if (!isset($_SESSION["login"]))  {
	...
	if ($fecha_adi > $bx or $fecha_adi < $ax) {
		...
		$sq = "UPDATE adi_ppto_ing set  id_emp='$id_emp', cod_pptal='$cod_pptal', nom_rubro='$nom_rubro' , fecha_adi='$fecha_adi', tipo_acto='$tipo_acto', num_acto='$num_acto' , valor_adi='$valor_adi', concepto_adi='$concepto_adi' where id ='$id'";

		$res = $cx->query($sq);

		$afectado_otros = '1';
		$sSQL = "UPDATE car_ppto_ing Set afectado_otros='$afectado_otros' Where cod_pptal = '$cod_pptal' and id_emp ='$id_emp'";
		$cx->query($sSQL);
...
<div align='center'><a href='adi_ppto_ing.php' target='_parent'>VOLVER</a>
			...
			case (2):
				...
				$c =$connection->query("SELECT * from car_ppto_ing where cod_pptal ='$codigo' and id_emp ='$idxx'");
				while ($r = $c->fetch_assoc()) {
					$vr = $r["definitivo"];
				}
				$re = $vr + $h;
				$sql = "UPDATE car_ppto_ing set definitivo = '$re' where cod_pptal ='$codigo' and id_emp ='$idxx'";
				$res = $connection->query($sql);
				// actualizo el valor de todos los padres
				// padre cuenta nivel 2
				$pa = substr($codigo, 0, 1);
				$consultapa =$connection->query("SELECT * from car_ppto_ing where cod_pptal ='$pa' and id_emp ='$idxx'");
...
<div align='center'><a href='adi_ppto_ing.php' target='_parent'>VOLVER</a>
			...
			case (4):
				...
				$consultapb =$connection->query("SELECT * from car_ppto_ing where cod_pptal ='$pb' and id_emp ='$idxx'");
...
<div align='center'><a href='adi_ppto_ing.php' target='_parent'>VOLVER</a>
			...
			case (6):
				...
				$consultapc =$connection->query("SELECT * from car_ppto_ing where cod_pptal ='$pc' and id_emp ='$idxx'");
...
<div align='center'><a href='adi_ppto_ing.php' target='_parent'>VOLVER</a>
			...
			case (8):
				...
				$consultapd =$connection->query("SELECT * from car_ppto_ing where cod_pptal ='$pd' and id_emp ='$idxx'");
...
<div align='center'><a href='adi_ppto_ing.php' target='_parent'>VOLVER</a>
			...
			case (10):
				...
				$consultape =$connection->query("SELECT * from car_ppto_ing where cod_pptal ='$pe' and id_emp ='$idxx'");
...
<div align='center'><a href='adi_ppto_ing.php' target='_parent'>VOLVER</a>
			...
			case (12):
				...
				$consultapf =$connection->query("SELECT * from car_ppto_ing where cod_pptal ='$pf' and id_emp ='$idxx'");
...
<div align='center'><a href='adi_ppto_ing.php' target='_parent'>VOLVER</a>
			...
			case (14):
				...
				$consultapg =$connection->query("SELECT * from car_ppto_ing where cod_pptal ='$pg' and id_emp ='$idxx'");
...
<div align='center'><a href='adi_ppto_ing.php' target='_parent'>VOLVER</a>
			...
			case (16):
				...
				$consultaph =$connection->query("SELECT * from car_ppto_ing where cod_pptal ='$ph' and id_emp ='$idxx'");
...
<div align='center'><a href='adi_ppto_ing.php' target='_parent'>VOLVER</a>
			...
			case (18):
				...
				$consultapi =$connection->query("SELECT * from car_ppto_ing where cod_pptal ='$pi' and id_emp ='$idxx'");
...
<div align='center'><a href='adi_ppto_ing.php' target='_parent'>VOLVER</a>
			...
			case (20):
				...
				$consultapj =$connection->query("SELECT * from car_ppto_ing where cod_pptal ='$pj' and id_emp ='$idxx'");
...
<div align='center'><a href='adi_ppto_ing.php' target='_parent'>VOLVER</a>
			...
			case (22):
				...
				$consultapk =$connection->query("SELECT * from car_ppto_ing where cod_pptal ='$pk' and id_emp ='$idxx'");
...
<div align='center'><a href='adi_ppto_ing.php' target='_parent'>VOLVER</a>
			...
			case (24):
				...
				$consultapl =$connection->query("SELECT * from car_ppto_ing where cod_pptal ='$pl' and id_emp ='$idxx'");
...
<div align='center'><a href='adi_ppto_ing.php' target='_parent'>VOLVER</a>
			...
			case (26):
				...
				$consultapm =$connection->query("SELECT * from car_ppto_ing where cod_pptal ='$pm' and id_emp ='$idxx'");
...
<div align='center'><a href='adi_ppto_ing.php' target='_parent'>VOLVER</a>
			...
			case (28):
				...
				$consultapn =$connection->query("SELECT * from car_ppto_ing where cod_pptal ='$pn' and id_emp ='$idxx'");
...
<div align='center'><a href='adi_ppto_ing.php' target='_parent'>VOLVER</a>
			...
			case (30):
				...
				$consultapo =$connection->query("SELECT * from car_ppto_ing where cod_pptal ='$po' and id_emp ='$idxx'");
