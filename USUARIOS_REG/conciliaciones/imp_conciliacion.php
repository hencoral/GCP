...
while($row2 = $re2->fetch_assoc()) 
   {
	...
	$cargo_teso = $row2["cargo_teso"];
	$nom_rep_leg =$row2["nom_rep_leg"];
	$cargo_rep_leg =$row2["cargo_rep_leg"];
	
   }
$sq4="select * from usuarios2 where login ='$_SESSION[login]'";
$re4 = mysql_db_query($database, $sq4, $cx2);
$rw4 = mysql_fetch_array($re4);
$user = $rw4['nombre']. " ". $rw4['apaterno']. " ". $rw4['amaterno'];
$carg_aux = $rw4['cargo'];
...
//****** consulta en tabla auxiliar SIN CONCILIAR
$cx = new mysqli($server, $dbuser, $dbpass, $database) or die ("Fallo en la Conexion a la Base de Datos");
$sq = "select (dcto), fecha,tercero,cheque,debito,credito,fecha_marca,estado,fecha_fin from aux_conciliaciones2 where ((fecha between '$fecha_mes_ant' and '$fecha_fin' ) and cuenta ='$cuenta' and flag1 = '0' and flag2 = '0') or ((fecha between '$fecha_mes_ant' and '$fecha_fin' ) and cuenta ='$cuenta' and flag1 = '1' and flag2 = '0') order by fecha asc";
$re = $cx->query($sq);
$ad3='0';
$ac3='0';
while($rw = $re->fetch_assoc()) 
...
?>
     ...
     <td bgcolor="#009900"><div style="padding-left:5px; padding-top:3px; padding-right:20px; padding-bottom:3px;">
       <div align="right" class="Estilo10"><?php printf("%s",number_format($RES1,2,',','.'));?> </div>
     </div></td>
	 </tr>
<?php
...
<table width="800" border="0" align="center">
  ...
  <tr>
    <td width="2394" colspan="3"><table width="800" border="1" align="center" class="bordepunteado1">
      <tr>
        <td width="278"><div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
            <div align="center" class="Estilo4"><strong>PREPAR&Oacute;</strong></div>
        </div></td>
        <td width="298"><div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
          <div align="center" class="Estilo16">REVISO</div>
          </div>          <div style="padding-left:5px; padding-top:3px; padding-right:5px; padding-bottom:3px;">
            <div align="center" class="Estilo16"></div>
          </div></td>
      ...
      <tr>
        <td height="57"><div style="padding-left:5px; padding-top:30px; padding-right:5px; padding-bottom:5px;">
            <div align="center" class="Estilo4">
            <?php echo $user ."<br>".$carg_aux; ?>
            </div>
        </div></td>
        <td><div style="padding-left:5px; padding-top:30px; padding-right:5px; padding-bottom:5px;">
          <div align="center" class="Estilo4">
            <?php echo $nom_otr_resp ."<br>".$cargo_teso;?>
            </div>
          </div></td>
        <td>
  <div align="center">
