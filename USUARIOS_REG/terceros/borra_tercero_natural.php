...
<form action="confirma_borra_tercero_natural.php" method="POST" onSubmit="return confirm('Confirme la Accion')">
<div align="center"><br><br>
<span class="Estilo1">Esta a punto de eliminar el Tercero Natural, esta seguro?  </span>
