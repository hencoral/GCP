...
<table width="800" border="1" align="center" class="bordepunteado1">
  <tr>
	...
	Pasos a seguir para realizar la importaciond de TERCEROS NATURALES
	 </div>
	</div>	</td>
  </tr>
  <tr>
...
<div class="Estilo2" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
  ...
  <tr>
    <td>
	<form action="sube_ter.php" method="post" enctype="multipart/form-data">
   <div align="center">
    ...
    <br>-->
     ...
     <br />
	 <span class="Estilo2"><em>Nombre del archivo: terceros.csv<br />
