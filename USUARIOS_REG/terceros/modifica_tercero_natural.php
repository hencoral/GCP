...
.Estilo24 {font-weight: bold}
.Estilo25 {font-weight: bold}
.Estilo26 {font-weight: bold}
...
//-----------
$s = "select * from terceros_naturales where id ='$id' and id_emp = '$id_emp'";
...
$fax=$rw["fax"];
$email=$rw["email"];
$contabilidad=$rw["contabilidad"];
$ppto=$rw["ppto"];
$tesoreria=$rw["tesoreria"];
$almacen=$rw["almacen"];
$interventor=$rw["interventor"];
$embargo=$rw["embargo"];
$monto=$rw["monto"];
...
//-----------
	...
	<form name="a" method="post" action="proc_modi_tercero_natural.php" onsubmit="return confirm('Verifique su Informacion antes de Grabar')">
	  <table width="750" border="1" align="center" class="bordepunteado1">
        <tr>
          <td colspan="4" bgcolor="#DCE9E5">
		   <div style='padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;'>
		     <div align="center" class="Estilo4"><strong>MODIFICAR TERCEROS NATURALES		   </strong></div>
		   </div>		  </td>
          </tr>
        <tr>
          <td width="176" bgcolor="#F5F5F5" class="Estilo4"><div class="Estilo10" style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
            <div align="right">TIPO DE IDENTIFICACION </div>
          </div></td>
          <td width="182" bgcolor="#F5F5F5"><div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
            <select name="tipo_id" class="Estilo4" id="tipo_id" style="width:155px;">
              <?php 
			  $tipo = array('vacio','CEDULA CIUDADANIA','NIT','CEDULA EXTRANJERIA','PASAPORTE','SOC EXTRANJERA SIN NIT','REGISTRO CIVIL','TARJETA DE IDENTIDAD','TARJETA DE EXTRANJERIA','OTROS');
			  $i=0;
			  for ($i=1;$i<=9;$i++)
			  {
			  	if ($tipo_id == $i)
					{
					 echo "<option value='$i' selected>$tipo[$i]</option>";
					}else{
          ...
          <td width="176" bgcolor="#F5F5F5" class="Estilo4"><div class="Estilo20" style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
          ...
          <td width="186" bgcolor="#F5F5F5"><div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
            <input name="num_id" type="text" class="Estilo4" id="num_id" style="width:150px;" onkeypress="return validar(event)"  value="<?php printf("%s",$num_id);?>"/>
</div></td>
        </tr>
        <tr>
          ...
          <td class="Estilo4"><div class="Estilo21" style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
            <div align="right">CLASE </div>
          </div></td>
          <td><div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
            <select name="clase" class="Estilo4" id="clase">
              <?php
			  $clase_aux = array ('CLIENTE','PROVEEDOR','CONTRATISTA','NOMINA CA','NOMINA LNR');
			  $i=0;
			  for ($i=0;$i<5;$i++)
			  {
			  	if ($clase == $clase_aux[$i])
				{
					echo "<option value=$clase_aux[$i] selected>$clase_aux[$i]</option>";
				}else{
					echo "<option value=$clase_aux[$i]>$clase_aux[$i]</option>";
				}	
			  }
			 ?>
            </select>
        ...
        <tr>
          ...
          <td bgcolor="#F5F5F5"><div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
            <select name="regimen" class="Estilo4" id="regimen">
              <?php
			  $regimen_aux = array ('COMUN','SIMPLIFICADO','GRAN CONTRIBUYENTE','SECTOR PUBLICO','ESPECIAL','OTRO','NINGUNO');
			  $i=0;
			  for ($i=0;$i<5;$i++)
			  {
			  	if ($regimen == $regimen_aux[$i])
				{
					echo "<option value=$regimen_aux[$i] selected>$regimen_aux[$i]</option>";
				}else{
					echo "<option value=$regimen_aux[$i]>$regimen_aux[$i]</option>";
				}	
			  }
			  ?>
            </select>
            </div></td>
          <td bgcolor="#F5F5F5" class="Estilo4"><div class="Estilo22" style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
        ...
        <tr>
          <td class="Estilo4"><div class="Estilo13" style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
            <div align="right">PRIMER APELLIDO  </div>
          </div></td>
          <td><div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
            <input name="pri_ape" type="text" class="Estilo4" id="pri_ape" style="width:150px;" onkeyup="a.pri_ape.value=a.pri_ape.value.toUpperCase();" value="<?php printf("%s",$pri_ape);?>"  />
</div></td>
          <td class="Estilo4"><div class="Estilo23" style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
            <div align="right">SEGUNDO APELLIDO  </div>
          </div></td>
          <td><div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
            <input name="seg_ape" type="text" class="Estilo4" id="seg_ape" style="width:150px;" onkeyup="a.seg_ape.value=a.seg_ape.value.toUpperCase();" value="<?php printf("%s",$seg_ape);?>" />
</div></td>
        </tr>
        <tr>
          <td bgcolor="#F5F5F5" class="Estilo4"><div class="Estilo14" style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
            <div align="right">PRIMER NOMBRE  </div>
          </div></td>
          <td bgcolor="#F5F5F5"><div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
            <input name="pri_nom" type="text" class="Estilo4" id="pri_nom" style="width:150px;" onkeyup="a.pri_nom.value=a.pri_nom.value.toUpperCase();" value="<?php printf("%s",$pri_nom);?>"  />
</div></td>
          <td bgcolor="#F5F5F5" class="Estilo4"><div class="Estilo24" style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
            <div align="right">SEGUNDO NOMBRE  </div>
          </div></td>
          <td bgcolor="#F5F5F5"><div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
            <input name="seg_nom" type="text" class="Estilo4" id="seg_nom" style="width:150px;" onkeyup="a.seg_nom.value=a.seg_nom.value.toUpperCase();" value="<?php printf("%s",$seg_nom);?>" />
</div></td>
        </tr>
        <tr>
          <td>
		  <div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
			...
			<span class="Estilo4">(CIIU)			</span></div>
          </div>
		  </td>
          <td><div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
            <input name="nom_com" type="text" class="Estilo4" id="nom_com" style="width:80px;" onkeyup="a.nom_com.value=a.nom_com.value.toUpperCase();" value="<?php printf("%s",$nom_com);?>"   />
</div></td>
          <td class="Estilo4"><div class="Estilo25" style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
        ...
        <tr>
          <td bgcolor="#F5F5F5" class="Estilo4"><div class="Estilo16" style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
		  ...
		  <div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
			...
			<?php
			$sql2 = mysql_db_query($database,"selected * from conceptos_et where entidad ='$dpto' and tipo ='D'",$connectionxx);
          ...
          <td bgcolor="#F5F5F5" class="Estilo4"><div class="Estilo26" style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
		  ...
		  <div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
			...
			<?php
			$sql2 = mysql_db_query($database,"selected * from conceptos_et where entidad ='$mpio' and tipo ='M'",$connectionxx);
 			while ($rw2 = mysql_fetch_array($sql2))
			{
			$mupio =$rw2["entidad"];
			}
			if ($mupio = $mpio)
				{
				echo "<option value='$mupio'>$mupio</option>";
				}else{
			    echo "<option>- - - - - -</option>";
				}
			?>
        ...
        <tr>
          <td class="Estilo4"><div class="Estilo17" style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
            <div align="right">DIRECCION </div>
          </div></td>
          <td><div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
            <input name="dir" type="text" class="Estilo4" id="dir" style="width:150px;" onkeyup="a.dir.value=a.dir.value.toUpperCase();" value="<?php printf("%s",$dir);?>" />
</div></td>
          <td class="Estilo4"><div class="Estilo27" style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
            <div align="right">TELEFONO </div>
          </div></td>
          <td><div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
            <input name="tel" type="text" class="Estilo4" id="tel" style="width:150px;" onkeypress="return validar(event)" value="<?php printf("%s",$tel);?>" />
</div></td>
        </tr>
        <tr>
          <td bgcolor="#F5F5F5" class="Estilo4"><div class="Estilo18" style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
            <div align="right">FAX </div>
          </div></td>
          <td bgcolor="#F5F5F5"><div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
            <input name="fax" type="text" class="Estilo4" id="fax" style="width:150px;" onkeypress="return validar(event)" value="<?php printf("%s",$fax);?>" />
</div></td>
          ...
          <td bgcolor="#F5F5F5"><div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
            <input name="email" type="text" class="Estilo4" id="email" style="width:150px;" value="<?php printf("%s",$email);?>" />
</div></td>
        </tr>
        <tr>
...
{
?>
              <input name="contabilidad" type="checkbox" class="Estilo4" id="contabilidad" value="SI" checked="checked" />
<?php
}
else
{
...
{
?>
               <input name="tesoreria" type="checkbox" class="Estilo4" id="tesoreria" value="SI" checked="checked" />
<?php
}
else
{
...
?>
          ...
          <td class="Estilo4"><div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'></div></td>
        </tr>
        <tr>
...
{
?>
                <input name="ppto" type="checkbox" class="Estilo4" id="ppto" value="SI" checked="checked" />
<?php
}
else
{
...
{
?>
                 <input name="almacen" type="checkbox" class="Estilo4" id="almacen" value="SI" checked="checked" />
<?php
}
else
{
...
{
?>
                <input name="embargo" type="checkbox" class="Estilo4" id="embargo" value="SI" checked="checked" />
<?php
}
else
{
...
?>
          ...
          <td  class="Estilo4"><div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>Valor <input name="monto" type="text" class="Estilo4" id="monto" style="width:100px;text-align:right" value='<?php echo $monto; ?>' /></div></td>
        </tr>     
