...
//-----------
$s = "select * from terceros_juridicos where id ='$id' and id_emp = '$id_emp'";
...
$dv2=$rw["dv2"];
$clase2=$rw["clase2"];
$regimen2=$rw["regimen2"];
$ent_ofi2=$rw["ent_ofi2"];
$raz_soc2=$rw["raz_soc2"];
$nom_com2=$rw["nom_com2"];
$pais2=$rw["pais2"];
$dpto2=$rw["dpto2"];
$mpio2=$rw["mpio2"];
$dir2=$rw["dir2"];
...
$fax2=$rw["fax2"];
$em2=$rw["em2"];
$contabilidad2=$rw["contabilidad2"];
$ppto2=$rw["ppto2"];
$tesoreria2=$rw["tesoreria2"];
$almacen2=$rw["almacen2"];
$pri_ape2=$rw["pri_ape2"];
$seg_ape2=$rw["seg_ape2"];
$pri_nom2=$rw["pri_nom2"];
$seg_nom2=$rw["seg_nom2"];
$dir22=$rw["dir22"];
$tel22=$rw["tel22"];
$fax22=$rw["fax22"];
$em22=$rw["em22"];
...
//-----------
	...
	<form name="b" method="post" action="proc_modi_tercero_juridico.php" onsubmit="return confirm('Verifique su Informacion antes de Grabar')">
	  <table width="750" border="1" align="center" class="bordepunteado1">
        <tr>
          <td colspan="4" bgcolor="#DCE9E5"><div style='padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;'>
              <div align="center" class="Estilo4"><strong>MODIFICA TERCEROS JURIDICOS </strong></div>
          </div></td>
        </tr>
        <tr>
          <td width="176" bgcolor="#F5F5F5" class="Estilo4"><div class="Estilo28" style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
        ...
        <tr>
          ...
          <td bgcolor="#F5F5F5"><div class="Estilo4" style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
              <select name="ent_ofi2" class="Estilo4" id="select5">
				...
				if ($ent_ofi2 =='SI') 
				{
					echo "<option value='NO1'>NO</option>
        ...
        <tr>
          ...
          <td bgcolor="#F5F5F5"><div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
            ...
            <?php
			$sql2 = mysql_db_query($database,"selected * from conceptos_et where entidad ='$dpto2' and tipo ='D'",$connectionxx);
          ...
          <td bgcolor="#F5F5F5"><div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
            ...
            <?php
			$sql2 = mysql_db_query($database,"selected * from conceptos_et where entidad ='$mpio2' and tipo ='M'",$connectionxx);
 			while ($rw2 = mysql_fetch_array($sql2))
			{
			$mupio =$rw2["entidad"];
			}
...
?>
        ...
        <tr>
          <td colspan="4" bgcolor="#DCE9E5"><div class="Estilo4" style='padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;'>
              <div align="center"><strong>MODIFICA REPRESENTANTE LEGAL </strong></div>
          </div></td>
        </tr>
        <tr>
          <td class="Estilo4"><div class="Estilo28" style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;'>
        ...
        <tr>
          <td colspan="4"><div style='padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;'>
              <div align="center">
                <input name="Submit2" type="submit" class="Estilo4" value="Modificar" />
              </div>
          </div></td>
        </tr>
      </table>
