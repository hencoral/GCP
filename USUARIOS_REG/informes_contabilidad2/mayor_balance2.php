...
<br />
<center>
<div align="center" class="Titulotd" style="width:50%;padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">GENERANDO LIBROS OFICIALES</div>
</center>
<?php 
$mes = $_GET["fecha"];
include('../config.php');		
...
`inicial_deb` decimal(20,2) NOT NULL default '0.00',
`inicial_cred` decimal(20,2) NOT NULL default '0.00',
...
`saldo_deb` decimal(20,2) NOT NULL default '0.00',
`saldo_cred` decimal(20,2) NOT NULL default '0.00',
...
mysql_select_db ($base, $connectionxx);
if(mysql_query ($anadir7 ,$connectionxx)) 
{
//echo "listo";
}
else
...
while ($rwv = mysql_fetch_array($sqlv))
	...
	$anno = $cod2[0]; 
$fechas_corte =array($anno.'/01/31',$anno.'/02/29',$anno.'/03/31',$anno.'/04/30',$anno.'/05/31',$anno.'/06/30',$anno.'/07/31',$anno.'/08/31',$anno.'/09/30',$anno.'/10/31',$anno.'/11/30',$anno.'/12/31',$anno.'/12/31');	
...
if($corte == $var2)
{
  $fecha_aux = $anio."/02/01";
}
if($corte == $var3)
{
  $fecha_aux = $anio."/03/01";
}
if($corte == $var4)
{
...
if($corte == $var5)
{
  $fecha_aux = $anio."/05/01";
}
if($corte == $var6)
{
  $fecha_aux = $anio."/06/01";
}
if($corte == $var7)
{
...
if($corte == $var8)
{
  $fecha_aux = $anio."/08/01";
}
if($corte == $var9)
{
  $fecha_aux = $anio."/09/01";
}
if($corte == $var10)
{
...
if($corte == $var11)
{
$fecha_aux = $anio."/11/01";
}
		
if($corte == $var12)
{
$fecha_aux = $anio."/12/01";
}

if($corte == $var12 && $mes==12)
{
$fecha_aux = $anio."/01/01";
}
//*********************************
...
{
$saldo_inicial=$credito_sico + $rowxx2a[debitos] - $rowxx2a[creditos];
$saldo_inicial_cred=($credito_sico + $rowxx2a[debitos] - $rowxx2a[creditos])*-1;
$saldo_inicial_deb= 0;	
...
<br />
<center>
<?php print "<a href='mayor_balance3.php?fec1=$fecha_aux&fec2=$corte' target='_parent'><span class='Estilo5'><font color ='blue'>Libro Mayor y Balance</font></span></a></div>"; ?>
<br  />
<?php print "<a href='libro_diario.php?fec1=$fecha_aux&fec2=$corte' target='_parent'><span class='Estilo5'><font color ='blue'>Libro Diario Resumen</font></span></a></div>"; ?>
<br  />
<?php print "<a href='libro_diario2.php?fech=$mes' target='_parent'><span class='Estilo5'><font color ='blue'>Libro Diario Columnario</font></span></a></div>"; ?>
      ...
      <div align="center">
        <div style='padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px; background:#004080; width:150px'>
          <div style='padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px; background:#FFFFFF'>
            <div align="center"><a href='mayor_balance0.php' target='_parent'>VOLVER </a> </div>
          </div>
        </div>
      </div>
    </div></td>
