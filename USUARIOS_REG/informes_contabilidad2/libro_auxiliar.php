...
function vacia()
{
	var campo = document.getElementById('tercero').value;
	if (campo =='')
	{
		document.getElementById('valtercero').value='';	
	}
}
</script>
</head>
...
<table width="800" border="0" align="center">
  ...
  <tr>
    <td colspan="3" bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:10px;">
      <div align="center" class="Estilo4"><strong>GENERACION DE LIBROS AUXILIARES </strong><BR />
      </div>
    </div></td>
  </tr>
  <tr>
...
?>	
  ...
  <tr>
    <td colspan="2"><div class="Estilo4" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
      <div align="center">
	  <label>Cuenta inicio:  </label><select name="nn"  class="Estilo4" style="width: 400px;">
		                <?
include('../config.php');
...
?>
    ...
    <td colspan="2"><div class="Estilo4" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
      <div align="center">
	  <label>Cuenta final:&nbsp;  </label><select name="nn_fin"  class="Estilo4" style="width: 400px;">
		                <?
include('../config.php');
$db = new mysqli($server, $dbuser, $dbpass, $database);
...
?>
  ...
  <tr>
    <td colspan="2"><div class="Estilo4" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
      <div align="center">
	  <label>Tercero: &nbsp;</label>
                 <input type='text' name='tercero' class='Estilo4' id='tercero' size='67' onblur="vacia();" /> 
    ...
    <td colspan="2"><div class="Estilo4" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
      <div align="center">
        <div align="center">
			...
			onclick="this.form.action = 'libro_auxiliar2.php'" />
              <input name="Submit3221" type="submit" class="Estilo4"  value="Exportar Libro Auxiliar" 
			onclick="this.form.action = 'libro_auxiliar2_xls.php'" />
          </div>
      </div>
    </div></td>
  </tr>
