...
<?php
printf ("<table width='1380' border ='1' align='center' class='bordepunteado1'>
		<tr>
		...
		while ($rw2 = mysql_fetch_array($re2))
			{
				...
				$suma = abs($ini_deb) + abs($ini_cred) + abs($deb) + abs($cred);
					...
					printf("
							...
							",$cuenta, $nombre, $ini_deb,$ini_cred,$deb,$cred,$sal_deb,$sal_cred,$tip_dato,$nivel);
					}
				$ini_deb = 0;
				$ini_cred = 0;
				$deb = 0;
