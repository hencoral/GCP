...
<table width="800" border="0" align="center">
  ...
  <tr>
    <td bgcolor="#FFFFFF"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:10px;">
      <div align="center" class="Estilo4"><strong>ESTADO DE RESULTADOS</strong><BR />
      </div>
    </div></td>
  </tr>
  <tr>
...
?>	
  ...
  <tr>
    <td colspan="2"><div class="Estilo4" style="padding-left:3px; padding-top:3px; padding-right:3px; padding-bottom:3px;">
      <div align="center">
        <div align="center">
            <input name="Submit322" type="button" class="Estilo4"  value="Generar reporte" 
			onClick="mostrarForm(a,'estado_resultados_proces.php');" />
          </div>
      </div>
    </div></td>
  </tr>
