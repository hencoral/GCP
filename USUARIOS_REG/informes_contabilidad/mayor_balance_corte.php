...
// calculo del inicial
$sqlxx2a = "select sum(debito) as debitos, sum(credito) as creditos from aux_cta_0 where (fecha < '$fecha_aux') and cuenta = '$cuenta' and fecha >= '$fecha_ini_op'";
$resultadoxx2a = mysql_db_query($database, $sqlxx2a, $connectionxx);
...
// Mostrar icono con resultado
 print "<a href='mayor_balance3.php?fec1=$fecha_aux&fec2=$corte' target='_parent'><span class='Estilo5'><font color ='blue'>Libro Mayor y Balance</font></span></a></div>"; 
