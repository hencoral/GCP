...
while ($rwv = mysql_fetch_array($sqlv))
	...
	$anno = $cod2[0]; 
	// fecha de corete anterir
	$nuevafecha = strtotime($corte_ini) -1; 
	$corte_mes_anterior = date("Y/m/d", $nuevafecha);
?>
...
<tr>
	...
	<td>LIBROS AUXILIARES GENERALES</td>
</tr>
<tr>
	<td><b>PERIODO:</b></td>
