...
<div align='center'><a href='cambiar_codigo.php' target='_parent'>VOLVER</a>
		...
		$sql = "SELECT * from car_ppto_ing where cod_pptal='$ingresa' and id_emp='$idxx'";
...
<div align='center'><a href='cambiar_codigo.php' target='_parent'>VOLVER</a>
				...
				case (2):
					...
					$consulta = $connection->query("SELECT * from car_ppto_ing where cod_pptal ='$padre' 
						 and id_emp ='$idxx'");
					...
					$sql2 = "update car_ppto_ing set tip_dato='M',ppto_aprob='0' , definitivo='0' 
					...
					// me llevo los vrs de tmp a ../proc_carga_ppto_ing.php y guardo la nueva cuenta
					printf("<center class='Estilo4'><br>Cambios Realizados con Exito<br><br>
						 <form name='form1' method='post' action='../proc_carga_ppto_ing.php'>
