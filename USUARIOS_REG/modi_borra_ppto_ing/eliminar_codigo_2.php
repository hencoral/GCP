...
if (!isset($_SESSION["login"])) {
	...
	$sq = "SELECT * from car_ppto_ing where id_emp = '$idxx' and cod_pptal = '$ingresa'";
...
<div align='center'><a href='eliminar_codigo.php' target='_parent'>VOLVER</a>
			...
			case (2):
				...
				$result = $connection->query("SELECT * FROM car_ppto_ing where padre ='$padre' and id_emp ='$idxx' ");
				if ($result->num_rows > '1') {
				} else {
					$sql2 = "update car_ppto_ing set afectado='0' where cod_pptal ='$padre' and id_emp ='$idxx'";
...
<div align='center'><a href='eliminar_codigo.php' target='_parent'>VOLVER</a>
		...
		$sSQL = "Delete From car_ppto_ing Where cod_pptal='$ingresa' and id_emp = '$idxx'";
		$cx->query($sSQL);
