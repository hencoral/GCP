              ...
              <tr>
                <td colspan="2" bgcolor="#DCE9E5" class="Estilo4">
                  <div id="div7" style="padding-left:3px; padding-top:15px; padding-right:3px; padding-bottom:15px;">
                    <div align="center"><strong>MODIFICAR CUENTA DEL PRESUPUESTO DE INGRESOS</strong><br /><br />
                      <strong>Descripcion</strong>: Este proceso consiste en CAMBIAR una cuenta DETALLE a MAYOR, que NO haya sido AFECTADA por ningun usuario del Sistema, con el objetivo de corregir errores en la <strong>Carga del Presupuesto de Ingresos. </strong>
                    </div>
                  </div>
                </td>
              </tr>
                  ...
                  <div id="div6" style="padding-left:3px; padding-top:5px; padding-right:3px; padding-bottom:15px;">
                    <div align="center">(Puede modificar cuentas que <strong>NO</strong> tengan P.A.C, ADICIONES, REDUCCIONES o AFECTACION ALGUNA)<br /> <br />
                      ...
                      <SELECT name="nn" onchange="cambia()" class="Estilo4" style="width: 400px;">
                        ...
                        $strSQL = "SELECT * FROM car_ppto_ing WHERE id_emp = '$idxx' AND tip_dato = 'D' AND afectado = '0' 
