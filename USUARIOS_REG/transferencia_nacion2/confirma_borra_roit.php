...
// saco el id de la empresa
   $connectionxx = new mysqli($server, $dbuser, $dbpass, $database) or die ("Fallo en la Conexion a la Base de Datos");
	    ...
	    $sqlxxq = "select * from recaudo_tnat where id_emp = '$idxx' and id_recau='$id_recau' order by id asc ";
	    $resultadoxxq = mysql_db_query($database, $sqlxxq, $connectionxx);
	    while($rowxxq = mysql_fetch_array($resultadoxxq)) 
  	    {
     	 $id_manu_ncbt=$rowxxq["id_manu_tnat"];
...
$sq = "select * from recaudo_tnat where id_emp = '$idxx' and id_recau='$id_recau' order by id asc ";
...
<span class='Estilo4'>
<strong>DATOS DE LA TRANSFERENCIA CREDITO BANCARIA ...::: ".$id_manu_ncbt." :::...</strong>
</span>
</DIV>
<BR>
</center>
...
<br>
<form method='post' action='borrar_tnat.php'>
...
$rw["id"] , $rw["id_reip"] , $rw["id_caic"] , $rw["id_recau"] , $rw["cuenta"] , $rw["nombre"] , $rw["vr_digitado"], $rw["tercero"], $rw["des_recaudo"], $rw["id_manu_tnat"], $id_recau, $rw["fecha_recaudo"]
); 
    ...
    <tr>
        <td colspan="4"><div class="Estilo12" style="padding-left:5px; padding-top:10px; padding-right:5px; padding-bottom:10px;">
          <div align="center"><span class="Estilo8">:::</span>
            <input name="Submit322" type="submit" class="Estilo12"  value="Agregar Imputacion Presupuestal a la Nota Credito Bancaria Actual" 
