...
session_start();
$campo ='vf';
$titulo ='ADMINISTRACION DE VIGENCIAS';
$ancho ='70%';
...
<table width="<?php echo $ancho; ?>" border="0" class="punteado" cellpadding='3' cellspacing='0'> 
  ...
  <table width="<?php echo $ancho; ?>" border="0" class="punteado" cellpadding='3' cellspacing='0'>   
    <tr bgcolor="#F5F5F5">
    	<td width='20%' align='left'>Vigencia</td>
        <td width='20%'>Estado</td>
		<td width='20%' ondblclick="">Base de datos</td>
        <td width='15%' align="center" ondblclick="">Fecha inicial</td>
        <td width='15%' align="center" ondblclick="">Fecha final</td>
        <td width='10%' align="center" ondblclick="">Acciones</td>
    </tr>
<?php
// campó y tabla
// selecciono todos los capmpos de tareas para mostrar en la lista
$sql = "select * from $campo order by anno asc";
...
while($row = mysql_fetch_array($res))
	...
	<tr id='$row[id]' onmouseover=cambiaColor(id); onmouseout=fueraPuntero(id);   bgcolor='#ffffff'>
		...
		<td $link align='left'> $row[nombre_bd]</td>
