...
<a class="menuButton" href="" onClick="return buttonClick(event, 'editMenu');" onMouseOver="buttonMouseover(event, 'editMenu');">Reportes</a>
...
<a class="menuItem" href="#" onclick="cargaMenu(event,'admin/usuarios/reporte.php','contenido','fileMenu');">Usuarios del sistema</a>
<a class="menuItem" href="#" onclick="cargaMenu(event,'admin/comunidades/reporte.php','contenido','fileMenu');">Comunidades</a>
<a class="menuItem" href="#" onclick="cargaMenu(event,'admin/cuentas/reporte.php','contenido','fileMenu');">Gesti&oacute;n de cuentas</a>
...
<a class="menuItem" href="#" onclick="cargaMenu(event,'user/proyectos/entidades.php','contenido','editMenu');">Flujo de efectivo</a>
<a class="menuItem" href="#" onclick="cargaMenu(event,'user/proyectos/entidades.php','contenido','editMenu');">Activos fijos</a>

</div>

<div id="herrMenu" class="menu">
<a class="menuItem" href="#" onclick="cargaMenu('user/herramientas/fichas/buscar.php','contenido','herrMenu');">Memorandum</a>
<a class="menuItem" href="#" onclick="cargaMenu('user/herramientas/fichas/buscar.php','contenido','herrMenu');">Autorizar periodo</a>
</div>
