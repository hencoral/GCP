...
//printf("%s",$id);
$sqlxx = "select * from lib_aux4 where id_auto ='$id'";
$resultadoxx = mysql_query($sqlxx, $cx);
while($rowxx = mysql_fetch_array($resultadoxx)) 
{
  $fecha_recaudo=$rowxx["fecha"];
  $tercero=$rowxx["tercero"];
  $id_unico_reip=$rowxx["id_unico_reip"];
  $id_manu_rcgt=$rowxx["dcto"];
  $des_recaudo=$rowxx["detalle"];
...
$resultadoxx24 = mysql_query($sqlxx24, $cx);
...
<table width="798" border="1" align="center" class="bordepunteado1">
  <tr>
	...
	<div align="center" class="Estilo4"><img src="../../../images/PLANTILLA PNG PARA LOGO EMPRESA.png" width="140" ><br/><b>  </div>
	</div>	</td>
	...
	<div align="center" class="Estilo16">
	  <h3>COMPROBANTE DE EGRESO PAGO QUINCENA</h3> 
	</div>
	</div>	</td>
...
<? printf("%s",$des_recaudo); ?>
  ...
  <tr>
    <td bgcolor="#F5F5F5"><div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
      <div align="right" class="Estilo16">Valor en Letras : </div>
    </div></td>
    <td colspan="2" bgcolor="#FFFFFF"><div class="Estilo4" style="padding-left:15px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
      <? 
	
$resulta=mysql_query("select SUM(debito) AS TOTAL from lib_aux4 WHERE id_auto = '$id'",$cx) or die (mysql_error());
...
$sq2 = "select * from lib_aux4 where  id_auto ='$id' order by id asc ";
...
<table width="800" border="1" align="center" class="bordepunteado1">
  ...
  <tr>
    ...
    <td width="165"><div class="Estilo4" style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;"> 
