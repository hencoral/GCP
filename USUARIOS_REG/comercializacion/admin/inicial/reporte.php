...
<center>
 <table width="90%" border="0" class="punteado" cellpadding='3' cellspacing='0'>   
    <tr bgcolor="#F5F5F5">
        ...
        <td width='50%' align='left'>Detalle</td>
         <td width='15%' align='right'>Unitario</td>
        <td width='15%' align='right'>Total</td>
       <td width='10%' align="center" ondblclick=""></td>
    </tr>
<?php
// selecciono parametros
$sq3="select * from farm_kardex where doc_num ='$factura' and doc_ref ='1'";
$re3=mysql_query($sq3,$cx);
while($rw3 = mysql_fetch_array($re3))
{
	$link ="onclick=cargaArchivo(&#34admin/inicial/producto.php?cod=$rw3[cod_int]&id=$rw3[id]&#34,&#34producto2&#34)";	
	//colorear filas
	$cont++;
