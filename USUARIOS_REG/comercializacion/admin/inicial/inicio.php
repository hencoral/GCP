...
function llamaMenu2()
{
	...
	var archivo = 'admin/inicial/reporte.php?factura='+id;
...
function nuevoArt()
{
	...
	// campos para validar
	var camposval = ["bodega", "tipo_art", "acta","codigo","cant","compra","venta"]; // 6
	...
	if (error ==0)
	{
	var archivo = 'admin/inicial/agregarpro.php?bodega='+bodega+'&tipo_art='+tipo_art+'&fecha='+fecha+'&concepto='+concepto+'&acta='+acta+'&codigo='+codigo+'&barras='+barras+'&lote='+lote+'&fecha_ven='+fecha_ven+'&cant='+cant+'&compra='+compra+'&venta='+venta+'&Invima='+Invima+'&id='+id;
	cargaArchivo(archivo,'reporte');
...
<table width="90%" border="0" class="punteado" cellpadding='3' cellspacing='0' align="center"> 
 ...
 <table width="90%" border="0" class="punteado" cellpadding='0' cellspacing='0' align="center">   
   ...
   <table width="90%" border="0" class="punteado" cellpadding='0' cellspacing='0' align="center">  
     ...
     <tr>
         <td>Concepto:</td>
         <td><input type='text' name='concepto' id='concepto' size='60' value='CARGA INVENTARIO INICIAL' /> 
               </td>
     </tr>
     <tr>  
         <td>No acta:</td>
         <td><input name="acta" id="acta" size="10" onchange="llamaMenu2()" alt="1" />
         <label id="acta_e" style="color:#F00"></label>&nbsp;<i class="fa fa-bars" style="font-size:15px;color:#CCC;cursor:pointer" aria-hidden="true" title="Listar documento" onclick="llamaMenu2();"></i></td>
     </tr>
     <tr>
