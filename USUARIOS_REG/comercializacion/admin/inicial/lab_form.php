...
function nuevoArt3()
{
	...
	var archivo = 'admin/inicial/lab_agregar.php?laboratorio='+laboratorio+'&cod_art='+tipo_art3+'&id='+id;
...
<table width="90%" border="0" class="punteado" cellpadding='3' cellspacing='0' align="center"> 
 ...
 <table width="90%" border="0" class="punteado" cellpadding='0' cellspacing='0' align="center">   
   ...
   <table width="90%" border="0" class="punteado" cellpadding='0' cellspacing='0' align="center">  
     <tr>
         <td>Laboratorio:</td>
         <td><input type='hidden' name='id' id='id' size='3' value='<?php echo $id ; ?>' />
          <input type='text' name='laboratorio' id='laboratorio' size='80' value='<?php echo $nombre ; ?>' /></td>
     </tr>
      <tr>
         <td></td>
