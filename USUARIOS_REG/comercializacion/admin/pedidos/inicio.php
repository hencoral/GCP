...
function consultar()
{
	...
	if(num >3)
	{
	var archivo = 'admin/pedidos/reporte.php?nombre='+nombre;
...
function consultar3()
{
	...
	var archivo = 'admin/pedidos/reporte.php?bodega='+bodega+'&articulo='+articulo+'&fecha='+fecha;
	cargaArchivo(archivo,'reporte2');
...
function consultar2()
{
	var archivo = 'admin/pedidos/reporte.php';
	cargaArchivo(archivo,'reporte2');
}
...
function llamaMenu(id)
{
	...
	var archivo = 'admin/pedidos/menu.php?id='+id;
...
function nuevoArt()
{
	...
	var archivo = 'admin/pedidos/formulario.php?fecha='+fecha+'&bodega='+bodega+'&tip_art='+tip_art;
	cargaArchivo(archivo,'reporte2');	
}
</script>
...
<table width="90%" border="0" class="punteado" cellpadding='3' cellspacing='0' align="center"> 
 ...
 <table width="90%" border="0" class="punteado" cellpadding='0' cellspacing='0' align="center">   
    <tr bgcolor="#F5F5F5">
        ...
        <td width='30%' align='left'>Fecha</td>
...
$sq3 ="DELETE FROM `farm_pedido` WHERE `estado` = ''; ";
