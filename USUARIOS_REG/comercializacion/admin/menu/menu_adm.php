...
<a class="menuItem" href="../terceros/terceros.php" target="_blank" >Proveedores</a>
<a class="menuItem" href="#" onclick="cargaMenu2(event,'admin/nuevo/formulario.php','columna2','fileMenu');">Nuevo producto</a>
<a class="menuItem" href="#" onclick="cargaMenu(event,'admin/inicial/inicio.php','columna1','fileMenu');">Inventario inicial</a>
...
<a class="menuItem" href="#" onclick="cargaMenu(event,'admin/kardex/inicio.php','columna1','editMenu');" >Inventario</a>
<a class="menuItem" href="#" onclick="cargaMenu(event,'user/proyectos/entidades.php','contenido','editMenu');">Salidas</a>

</div>

<div id="herrMenu" class="menu">
<a class="menuItem" href="#" onclick="cargaMenu('user/herramientas/fichas/buscar.php','contenido','herrMenu');">Evaluar proveedores</a>
