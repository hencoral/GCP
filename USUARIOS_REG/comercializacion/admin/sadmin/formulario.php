...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="100%"  >
    <tr valign="center" bgcolor="#F5F5F5" class="menu3 arred"  >
      <td width="100%"  >&nbsp;Datos generales de la entidad   
         </td>
...
<table  class="tr punteado ConcepForm menu4" border="0" cellspacing="10" width="100%" bgcolor="#ffffff" id="p_3" style="display:none">
   <tr>
    ...
    <tr valign="center">
      <td width="3%"> </td>
      <td width="26%"  align="left" >Pa&iacute;s:</td>
      <td width="71%" align="left">
     
          		<input type='text' name='tercero' class='Estilo4' id='tercero' size='30' /> 
                <input type='hidden' name='valtercero' id='valtercero' />
      
      
      <input type="text" name="cod_pais" id="menu1_cod_pais" size="20" value="<?php echo $rw['cod_pais']; ?>" alt="1" onkeydown='displaycode(event,id);'/></td>
    </tr>
    <tr valign="center">
      <td> </td>
      <td align="left" >Departamento:</td>
      <td align="left"><input type="text" name="cod_dpto" id="menu1_cod_dpto" size="20" value="<?php echo $rw['cod_dpto']; ?>" alt="1" onkeydown='displaycode(event,id);'/></td>
    </tr>
    <tr valign="center">
      <td> </td>
      <td align="left" >Municipio:</td>
      <td align="left"><input type="text" name="cod_mpio" id="menu1_cod_mpio" size="20" value="<?php echo $rw['cod_mpio']; ?>" alt="1" onkeydown='displaycode(event,id);'/></td>
    </tr>
</table>
