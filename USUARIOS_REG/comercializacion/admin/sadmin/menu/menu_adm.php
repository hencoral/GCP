...
<a class="menuButton" href="" onClick="return buttonClick(event, 'editMenu');" onMouseOver="buttonMouseover(event, 'editMenu');">Ver</a>
...
<a class="menuItem" href="#" onclick="cargaMenu(event,'admin/sadmin/inicio.php','contenido','editMenu');">Superadmin</a>
<a class="menuItem" href="#" onclick="cargaMenu(event,'admin/inicio.php','contenido','editMenu');">Administrador</a>
