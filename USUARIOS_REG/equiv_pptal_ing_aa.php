          ...
          <form name='a' method="post" action="equiv_pptal_ing.php" onsubmit="return confirm('Verifique si todos los datos estan correctos')">
              ...
              <tr>
                ...
                <td width="432" colspan="2">
                  <div style="padding-left:5px; padding-top:5px; padding-right:5px; padding-bottom:5px;">
                    <div align="left">
                      <SELECT name="cod_pptal" class="Estilo4" id="cod_pptal" onchange="mostrarDato();" style="width:420px">
                        <?php
                        include('config.php');
            ...
            <table width="750" border="1" align="center" class="bordepunteado1">
              ...
              <tr class="bordepunteado1">
                <td>
                  <div style="padding-left:5px; padding-top:15px; padding-right:5px; padding-bottom:15px;">
                    <div align="center"> <a href="sube_homo_ing/plantilla/plantilla_homologacion_ppto_ing.php"><strong>VER INFORME DE CUENTAS HOMOLOGADAS DEL PRESUPUESTO DE INGRESOS</strong></a> </div>
                  </div>

                  <div style="padding-left:5px; padding-top:15px; padding-right:5px; padding-bottom:15px;">
                    <div align="center"> <a href="sube_homo_ing/upload.php" target="_parent"><strong>CARGAR AL SISTEMA CUENTAS HOMOLOGADAS DEL <br />
                          PRESUPUESTO DE INGRESOS USANDO MS Excel &copy;
                          <br />
                        </strong>
                      </a><img src="Excel2007Logox50.jpg" width="50" height="50" /> </div>
                  </div>
                </td>
              </tr>
            </table>
